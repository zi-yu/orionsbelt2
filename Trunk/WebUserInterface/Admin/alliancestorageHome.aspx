...
<asp:Content ContentPlaceHolderID="content" runat="server">
	<h2>AllianceStorage Information</h2>
	<p>This Entity has <b><OrionsBelt:AllianceStorageCount runat="server" /></b> elements.</p>
	...
	<table class="table">
		...
		<tr>	
		<tr>
			<td><b>diplomacyA</b></td>
			<td>AllianceDiplomacy</td>
			<td>
				This field has no Regular expressions
			</td>
		<tr>	
		<tr>
			<td><b>diplomacyB</b></td>
			<td>AllianceDiplomacy</td>
			<td>
				This field has no Regular expressions
			</td>
	...
	<h2>Delete All</h2>
	<OrionsBelt:AllianceStorageDeleteAll runat="server" />
</asp:Content>