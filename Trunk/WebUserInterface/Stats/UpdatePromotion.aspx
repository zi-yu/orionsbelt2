<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePromotion.aspx.cs" Inherits="OrionsBelt.WebUserInterface.UpdatePromotion" MasterPageFile="~/Stats/Stats.Master" %>
...
<tr>
<th colspan='2'>
    <OrionsBelt:Label runat="server" Key="UpdatePromotion">
    </OrionsBelt:Label>
</th>
</tr>
    <tr>
    ...
    <tr>
        <td><OrionsBelt:Label  Key="Status" runat="server"/></td>
