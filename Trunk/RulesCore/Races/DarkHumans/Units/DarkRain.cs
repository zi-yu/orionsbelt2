...
namespace OrionsBelt.RulesCore.Races {
    ...
    [DesignPatterns.Attributes.FactoryKey("DarkRain")]
    public class DarkRain : BaseUnit {
        ...
        protected override void BuildDependecyRules()
        {
            ...
            Dependency.Add(this, 1, typeof(DominationYard), 1);
        }
        ...
        protected override void BuildCostRules()
        {
            ...
            Cost.Add(this, typeof(Titanium), 700);
        }
        ...
        public static IUnitInfo Resource {
            get { return (IUnitInfo)RulesUtils.GetResource(typeof(DarkRain)); }
        }
