...
<asp:Content ContentPlaceHolderID="content" runat="server">
	<h2>ArenaStorage Information</h2>
	<p>This Entity has <b><OrionsBelt:ArenaStorageCount runat="server" /></b> elements.</p>
	...
	<table class="table">
		...
		<tr>	
		<tr>
			<td><b>historical</b></td>
			<td>ArenaHistorical</td>
			<td>
				This field has no Regular expressions
			</td>
		<tr>	
	...
	<h2>Delete All</h2>
	<OrionsBelt:ArenaStorageDeleteAll runat="server" />
</asp:Content>