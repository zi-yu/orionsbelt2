...
namespace OrionsBelt.Core {
	//[Serializable()]
	public abstract partial class Campaign : OrionsBelt.Core.Entity, IDescriptable, IComparable  {
        ...
        /// </summary>
		[XmlIgnore()]
		public abstract System.Collections.Generic.IList<CampaignStatus> Participants {get;set; }

		/// <summary>
        /// Gets the Campaign's Levels
        /// </summary>
		[XmlIgnore()]
		public abstract System.Collections.Generic.IList<CampaignLevel> Levels {get;set; }
		...
		{
			Campaign other = obj as Campaign;
			if( other == null ) {
