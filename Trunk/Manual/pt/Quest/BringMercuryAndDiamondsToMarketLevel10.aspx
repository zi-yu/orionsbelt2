...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Trás Mercúrio e Diamantes a a uma Academia nível 10
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Trás Mercúrio e Diamantes a a uma Academia nível 10" runat="server" /></h1>
	
	<div class="description">
		Transportar Mercúrio e Diamantes numa só armada para um Mercado de nível 10
	</div>
