...
<asp:Content ContentPlaceHolderID="content" runat="server">
  ...
  <a href="../Facility/Extractor.aspx">Extractores</a>.
	...
	<h2>Recompensa</h2>
	<div class="description">
		<ul><li><a href='/pt/Commerce/Orions.aspx'>Orions</a> : +50</li><li>Pontuação : +80</li><li><a href='/pt/ColonizerQuests.aspx'>Colonizador</a> : +2</li><li><a class='rain' href='/pt/Unit/Rain.aspx'>Rain</a> : +3</li></ul>
	</div>
