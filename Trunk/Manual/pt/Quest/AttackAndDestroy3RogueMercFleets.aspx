...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Ataca e destroi 3 armadas de Rogue Mercs
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Ataca e destroi 3 armadas de Rogue Mercs" runat="server" /></h1>
	
	<div class="description">
		Armadas de Rogue Mercs foram localizadas na zona de nível 5. Encontra-as e destroi 3 armadas.
	</div>
