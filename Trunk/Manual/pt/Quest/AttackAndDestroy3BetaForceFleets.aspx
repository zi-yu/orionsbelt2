...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Ataca de destroi 3 armadas da Beta Force
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Ataca de destroi 3 armadas da Beta Force" runat="server" /></h1>
	
	<div class="description">
		Armadas da Beta Force foram localizadas na zona de nível 3. Encontra-as e destroi 3 armadas.
	</div>
