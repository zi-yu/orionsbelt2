...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Ataca e destroi 3 armadas de Mercs
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Ataca e destroi 3 armadas de Mercs" runat="server" /></h1>
	
	<div class="description">
		Armadas de Mercs foram localizadas na zona de nível 1. Encontra-as e destroi 3 armadas.
	</div>
