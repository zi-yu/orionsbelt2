...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Intercepteur" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/interceptor.png' alt='Intercepteur' />
		L'<a class='interceptor' href='/fr/Unit/Interceptor.aspx'>Intercepteur</a> est l'unité la plus particulière d'<a href='http://www.orionsbelt.eu'>Orion's Belt</a>. Elle possède de grandes habiletés, mais aussi plusieurs désavantages. Si un jouer ne fait pas attention, ses <a class='interceptor' href='/fr/Unit/Interceptor.aspx'>Intercepteur</a> peuvent devenir complètement inutiles sur le
  <a href='/fr/Battles/GameBoard.aspx'>Plateau de jeu</a>.
  <p />
  l'<a class='interceptor' href='/fr/Unit/Interceptor.aspx'>Intercepteur</a> est une unité <a href='/fr/Battles/Light.aspx'>Légère</a> ayant un grand pouvoir: <a href='/fr/Battles/ParalyseAttack.aspx'>Attaque paralysante</a>. Avec sa vitesse, il devient facle de paralyser des <a href='/fr/UnitIndex.aspx'>Unités de Combat</a> très puissantes. Par contre, avec sa <a href='/fr/Battles/Range.aspx'>Portée</a> de 1 et <a href='/fr/Battles/Movement.aspx#MovDiagonal'>Mouvement Diagonale</a> il est difficile de l'utiliser comme <a href='/fr/Battles/DispensableUnits.aspx'>Chair à canon</a>.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Catégorie</td>
			<td><a href='/fr/Battles/Light.aspx'>Légère</a></td>
		</tr>
		<tr>
			<td>Position</td>
			<td>Air</td>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubateur</a> Niveau 2</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Elk</a></li></ul></td><td class='duration'>10 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
