...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Veuve Noire" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/blackwidow.png' alt='Veuve Noire' />
		Il existe peu d'unités de combat <a href='/fr/Battles/Heavy.aspx'>Lourde</a> ayant <a href='/fr/Battles/Movement.aspx#MovAll'>Mobilité totale</a> dans ce jeu, mais la <a class='blackwidow' href='/fr/Unit/BlackWidow.aspx'>Veuve Noire</a> en fait partie.
  Avec un coût de mouvement de 3, la <a class='blackwidow' href='/fr/Unit/BlackWidow.aspx'>Veuve Noire</a> est très mobile, puissante, et possède deux aptitudes spéciales:
  <a href='/fr/Battles/InfestationAttack.aspx'>Attaque Vénéneuse</a> et <a href='/fr/Battles/ParalyseAttack.aspx'>Attaque paralysante</a>.
  <p />
  Possédant <a href='/fr/Battles/InfestationAttack.aspx'>Attaque Vénéneuse</a> et <a href='/fr/Battles/ParalyseAttack.aspx'>Attaque paralysante</a>, la <a class='blackwidow' href='/fr/Unit/BlackWidow.aspx'>Veuve Noire</a> devient mortel dans un combat 1 contre 1 si elle attaque en premier.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Mouvement</td>
			<td><a href='/fr/Battles/Movement.aspx#MovAll'>Mobilité totale</a></td>
		</tr>
	</table>
	
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/InfestationAttack.aspx'>Attaque Vénéneuse</a></li><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubateur</a> Niveau 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>1000 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>450 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>200 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>2 Heures </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
