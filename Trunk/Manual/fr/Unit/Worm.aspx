...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Vers" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/worm.png' alt='Vers' />
		Le <a class='worm' href='/fr/Unit/Worm.aspx'>Vers</a> est l'unité de base <a href='/fr/Battles/Medium.aspx'>Médium</a> des <a href='/fr/Race/Bugs.aspx'>Levyr</a>. Son attaque et sa défense sont équilibrés, mais sous la moyenne.Mais avec <a href='/fr/Battles/Movement.aspx#MovAll'>Mobilité totale</a> et un coût en mouvement de 2, sa mobilité est plus haute que la moyenne pour les unités <a href='/fr/Battles/Medium.aspx'>Médium</a>.
  <p />
  C'est une unité versatile qui peut être très importante sur une <a href='/fr/Universe/Fleet.aspx'>Escadrile</a> des <a href='/fr/Race/Bugs.aspx'>Levyr</a>, car elle peut aider à défendre, mais peut aussi causer des dégâts considérable à l'adversaire.
	</div>
	...
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubateur</a> Niveau 3</li></ul></td><td><ul><li>375 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>450 <a href='../Intrinsic/Protol.aspx'>Protol</a></li></ul></td><td class='duration'>30 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
