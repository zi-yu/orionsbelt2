...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Taureau" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/taurus.png' alt='Taureau' />
		This unit is a like a small fortress moving on the <a href='/fr/Battles/GameBoard.aspx'>Plateau de jeu</a>, virtually indestructible and with an immense attack power. <p />
   The weaknesses of <a class='taurus' href='/fr/Unit/Taurus.aspx'>Taureau</a> is the short-<a href='/fr/Battles/Range.aspx'>Portée</a> for an <a href='/fr/Battles/Heavy.aspx'>Lourde</a> unit and the fact that it only has <a href='/fr/Battles/Movement.aspx#MovFront'>Mobilité Frontale</a>. But, when
   placed in the center of a battle, it's an extremely useful unit. <p />
   Along with the enormous attack, it has two special powers that amplify its destructive power: the <a href='/fr/Battles/Rebound.aspx'>Rebond</a> and
   <a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a>. These two powers combined can cause the destruction of enemy <a href='/fr/UnitIndex.aspx'>Unités</a> in 4 different squares with only one shot.
	</div>
	...
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Hangar de construction</a> Niveau 10</li></ul></td><td><ul><li>500 <a href='../Intrinsic/Energy.aspx'>Énergie</a></li><li>625 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>750 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>450 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>225 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Heure 30 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
