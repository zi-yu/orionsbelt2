...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		This is perhaps one of the best <a href='/fr/Battles/Heavy.aspx'>Lourde</a> units in the game. It's <a href='/fr/Battles/Movement.aspx#MovCost'>Coût de mouvemment</a> of 3 allows the player to move it, attack
   and defend all in one turn.
   <p />
   It has <a href='/fr/Battles/Movement.aspx#MovNormal'>Mobilité normale</a> which is good for a <a href='/fr/Battles/Heavy.aspx'>Lourde</a> unit because it control more squares if it is correctly placed. Also the <a href='/fr/Battles/Rebound.aspx'>Rebond</a> attack makes
   this unit very strong because it virtually gains range of 5 (it can destroy the target unit and the unit behind it in the same turn). Its attack
   of 2500 also deals great damages to enemys units.
   <p />
   Although it an expensive unit and it's only available in avanced stages of the game (<a class='unityard' href='/fr/Facility/UnitYard.aspx'>Hangar de construction</a> level 9), this is definitely a <a href='/fr/Battles/Heavy.aspx'>Lourde</a> unit to always
   have in your army.
	</div>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/Rebound.aspx'>Rebond</a></li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Hangar de construction</a> Niveau 9</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Energy.aspx'>Énergie</a></li><li>500 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>600 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>400 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>200 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>1 Heure 40 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
