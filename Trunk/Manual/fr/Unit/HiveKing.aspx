...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Roi coloniale" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/hiveking.png' alt='Roi coloniale' />
		Le <a class='hiveking' href='/fr/Unit/HiveKing.aspx'>Roi coloniale</a> est une unité très importante de la race <a href='/fr/Race/Bugs.aspx'>Levyr</a>. Avec sa <a href='/fr/Battles/Range.aspx'>Portée</a> de 4 et un coût de mouvement de 3,
  le <a class='hiveking' href='/fr/Unit/HiveKing.aspx'>Roi coloniale</a> est l'une des unités <a href='/fr/Battles/Heavy.aspx'>Lourde</a> les plus mobiles. Ok, <a href='/fr/Battles/Movement.aspx#MovFront'>Mobilité Frontale</a> n'est pas le meilleur type de mouvement, mais il ne faut pas oublier que le <a class='hiveking' href='/fr/Unit/HiveKing.aspx'>Roi coloniale</a> a une attaque et défense très élevés, et 2 habiletés spéciales.
  <p />
  Le <a class='hiveking' href='/fr/Unit/HiveKing.aspx'>Roi coloniale</a> possède <a href='/fr/Battles/InfestationAttack.aspx'>Attaque Vénéneuse</a> et <a href='/fr/Battles/RemoveAbilityAttack.aspx'>Attaque annulant les habiletés</a>, pouvant être fatale pour l'adversaire.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Races</td>
			<td><a href='/fr/Race/Bugs.aspx'>Levyr</a></td>
		</tr>
		<tr>
			<td>Catégorie</td>
		...
		<tr>
			<td>Mouvement</td>
			<td><a href='/fr/Battles/Movement.aspx#MovNormal'>Mobilité normale</a></td>
		</tr>
	</table>
	
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/InfestationAttack.aspx'>Attaque Vénéneuse</a></li><li><a href='/fr/Battles/RemoveAbilityAttack.aspx'>Attaque annulant les habiletés</a></li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubateur</a> Niveau 9</li></ul></td><td><ul><li>800 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>650 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>200 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>1 Heure 50 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
