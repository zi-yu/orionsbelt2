...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Taureau Noir" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darktaurus.png' alt='Taureau Noir' />
		Cette unité est une forteresse ambulante sur le <a href='/fr/Battles/GameBoard.aspx'>Plateau de jeu</a>; virtuellement indestructible et ayant une force de frappe incroyable. <p />
  La faiblesse du <a class='darktaurus' href='/fr/Unit/DarkTaurus.aspx'>Taureau Noir</a> est sa courte <a href='/fr/Battles/Range.aspx'>Portée</a> pour une unité <a href='/fr/Battles/Heavy.aspx'>Lourde</a> ainsi que  <a href='/fr/Battles/Movement.aspx#MovFront'>Mobilité Frontale</a>. Mais, lorsque placé au milieu d'une bataille, c'est une unité très utile. <p />
   Outre sa force de frappe, cette unité possède 2 habiletés aidant à semer la destruction: <a href='/fr/Battles/Rebound.aspx'>Rebond</a> et
   <a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a>. Ces 2 pouvoir combinés peuvent détruirent les <a href='/fr/UnitIndex.aspx'>Unités</a> adverses sur 4 cases d'une seul coup.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Mouvement</td>
			<td><a href='/fr/Battles/Movement.aspx#MovFront'>Mobilité Frontale</a></td>
		</tr>
	</table>
	
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/Rebound.aspx'>Rebond</a></li><li><a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a></li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domination</a> Niveau 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Gold.aspx'>Or</a></li><li>700 <a href='../Intrinsic/Titanium.aspx'>Titane</a></li><li>1125 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>375 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>125 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>1 Heure 30 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
