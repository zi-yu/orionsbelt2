...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Le <a class='kamikaze' href='/fr/Unit/Kamikaze.aspx'>Kamikaze</a> est peut-être l'unité la plus traître du jeu. Son pouvoir d'ataque énorme et sa grande mobilité,
  en fait une menace potentiel pour toute les unités sur le <a href='/fr/Battles/GameBoard.aspx'>Plateau de jeu</a>. <p />
  Mais, comme son nom l'indique, les <a href='/fr/UnitIndex.aspx'>Unités</a> <a class='kamikaze' href='/fr/Unit/Kamikaze.aspx'>Kamikaze</a> servent è faire des attaques suicides car sa défense insignifiante permet à n'importe quel unité d'éliminer les <a class='kamikaze' href='/fr/Unit/Kamikaze.aspx'>Kamikaze</a> après une attaque.
  À cause de sa défense faible, le <a class='kamikaze' href='/fr/Unit/Kamikaze.aspx'>Kamikaze</a> doit être bien protégé car toutes attaques directes ou avec <a href='/fr/Battles/Rebound.aspx'>Rebond</a>, <a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a> peu détruire un grand nombre de <a class='kamikaze' href='/fr/Unit/Kamikaze.aspx'>Kamikaze</a>.
	</div>
	...
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domination</a> Niveau 5</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Gold.aspx'>Or</a></li><li>300 <a href='../Intrinsic/Titanium.aspx'>Titane</a></li><li>450 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>63 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Heure </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
