...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Anihilateur" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/doomer.png' alt='Anihilateur' />
		Le <a class='doomer' href='/fr/Unit/Doomer.aspx'>Anihilateur</a>  est une unité très intéressante à cause de sa force d'attaque énorme et ses aptitudes spéciales. Un bon joueur sur le <a href='/fr/Battles/GameBoard.aspx'>Plateau de jeu</a> sachant utiliser le <a class='doomer' href='/fr/Unit/Doomer.aspx'>Anihilateur</a> sera capable de détruire l'escadrille ennemi en peu d'attaques.  <p />
  L'attaque du <a class='doomer' href='/fr/Unit/Doomer.aspx'>Anihilateur</a> est très difficile à bloquerà cause de l'attaque <a href='/fr/Battles/Catapult.aspx'>Catapulte</a>. Sans compter que cette unité possède <a href='/fr/Battles/Rebound.aspx'>Rebond</a> et une énorme force de frappe qui rends cette unité dévastatrive. <p />
  Par contre, le<a class='doomer' href='/fr/Unit/Doomer.aspx'>Anihilateur</a> a 2 problèmes. La mobilité <a href='/fr/Battles/Movement.aspx#MovDiagonal'>Mouvement Diagonale</a> qui le rends diffile à bien positionner et sa défense pauvre qui le rends très fragile aux attaques. Il faut donc être un bon joueur pour prendre avantage de cette unité.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Races</td>
			<td><a href='/fr/Race/DarkHumans.aspx'>Renegades</a></td>
		</tr>
		<tr>
			<td>Catégorie</td>
			<td><a href='/fr/Battles/Heavy.aspx'>Lourde</a></td>
		</tr>
		<tr>
			<td>Position</td>
			<td>Air</td>
		...
		<tr>
			<td>Mouvement</td>
			<td><a href='/fr/Battles/Movement.aspx#MovDiagonal'>Mouvement Diagonale</a></td>
		</tr>
	</table>
	
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Mouvemebts d'attaques</td><td><a href='/fr/Battles/Catapult.aspx'>Catapulte</a></td></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/Rebound.aspx'>Rebond</a></li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domination</a> Niveau 8</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Gold.aspx'>Or</a></li><li>625 <a href='../Intrinsic/Titanium.aspx'>Titane</a></li><li>750 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>125 <a href='../Intrinsic/Argon.aspx'>Argon</a></li></ul></td><td class='duration'>1 Heure 10 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
