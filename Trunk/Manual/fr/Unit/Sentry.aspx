...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		La <a class='sentry' href='/fr/Unit/Sentry.aspx'>Sentry</a> est une unité <a href='/fr/Race/Mercs.aspx'>Mercs</a> <a href='/fr/Battles/Light.aspx'>Légère</a> unit. Elle est plus forte que la plupart des unités légères et possède une aptitude spéciale:
  <a href='/fr/Battles/RemoveAbilityAttack.aspx'>Attaque annulant les habiletés</a>. Grâce à cette habileté, une seule unité <a class='sentry' href='/fr/Unit/Sentry.aspx'>Sentry</a> peut affaiblir considérablement les unités les plus puissantes du jeu.
  <p />
  Et avec une mobilité totale, la <a class='sentry' href='/fr/Unit/Sentry.aspx'>Sentry</a> peut aussi servir de <a href='/fr/Battles/DispensableUnits.aspx'>Chair à canon</a>.
	</div>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/RemoveAbilityAttack.aspx'>Attaque annulant les habiletés</a></li></ul></td></tr></table>
