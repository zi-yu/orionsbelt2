...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Vecteur" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/vector.png' alt='Vecteur' />
		L'avantage principale du <a class='vector' href='/fr/Unit/Vector.aspx'>Vecteur</a> est sa portée plutôt grande <a href='/fr/Battles/Range.aspx'>Portée</a> (<a href='/fr/Battles/Range.aspx'>Portée</a> 4) associée à l'attaque spéciale <a href='/fr/Battles/Catapult.aspx'>Catapulte</a>.
 Cela signifie que n'importe quel unité situé à 4 cases en avant du <a class='vector' href='/fr/Unit/Vector.aspx'>Vecteur</a> n'est pas sous protection. <p />
  La faiblesse de cette unité se retrouve dans sont <a href='/fr/Battles/Movement.aspx#MovCost'>Coût de mouvemment</a> de 3 qui est plutôt élevé pour une unité <a href='/fr/Battles/Medium.aspx'>Médium</a>. Par ailleurs, son type de mouvement est <a href='/fr/Battles/Movement.aspx#MovNormal'>Mobilité normale</a>
  signifiant que cette unité n'est pas très difficile et il est pratiquement ipossible de surprendre l'adversaire.
	</div>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Mouvemebts d'attaques</td><td><a href='/fr/Battles/Catapult.aspx'>Catapulte</a></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domination</a> Niveau 6</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Gold.aspx'>Or</a></li><li>200 <a href='../Intrinsic/Titanium.aspx'>Titane</a></li><li>300 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>125 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>100 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Heure 20 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
