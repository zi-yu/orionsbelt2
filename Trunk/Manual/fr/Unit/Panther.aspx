...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Panthère" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/panther.png' alt='Panthère' />
		<a class='panther' href='/fr/Unit/Panther.aspx'>Panthère</a> est une unité dont la principale caractéristique est l'attaque <a href='/fr/Battles/Rebound.aspx'>Rebond</a>. Malgré que ce soit une unité faible, c'est une menace pour les unités ayant peu de défense comme les unités <a href='/fr/Battles/Light.aspx'>Légère</a> ou même les <a class='kamikaze' href='/fr/Unit/Kamikaze.aspx'>Kamikaze</a>. <p /> En quantité suffisante, cela devient une menace pour le <a class='flag' href='/fr/Unit/Flag.aspx'>Drapeau</a>. Donc oui c'est unité est faible mais peut faire des dégâts considérables à une <a href='/fr/Universe/Fleet.aspx'>Escadrile</a>.
	</div>
	...
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domination</a> Niveau 4</li></ul></td><td><ul><li>75 <a href='../Intrinsic/Gold.aspx'>Or</a></li><li>150 <a href='../Intrinsic/Titanium.aspx'>Titane</a></li><li>250 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>75 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>20 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
