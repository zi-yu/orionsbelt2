...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Walker" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/walker.png' alt='Walker' />
		Le <a class='walker' href='/fr/Unit/Walker.aspx'>Walker</a> est une unité <a href='/fr/Race/Mercs.aspx'>Mercs</a> <a href='/fr/Battles/Medium.aspx'>Médium</a> unit. Elle se déplace sur terre et, comme le <a class='hiveking' href='/fr/Unit/HiveKing.aspx'>Roi coloniale</a>, possède une attaquer empoisonné.
  <p />
  Elle a aussi une défense et attaque raisonnable, ainsi qu'un bon type de mobilité.
	</div>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/InfestationAttack.aspx'>Attaque Vénéneuse</a></li><li><a href='/fr/Battles/Replicator.aspx'>Réplicateur</a></li></ul></td></tr></table>
	<h3>Bonus d'unité</h3><table class='table'><tr><th>Cible</th><th>Attaque</th><th>Défense</th><th>Portée</th></tr><tr><td>Lourde</td><td>2000</td><td>0</td><td>0</td></tr></table>
