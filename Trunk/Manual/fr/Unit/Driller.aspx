...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Perçeur" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/driller.png' alt='Perçeur' />
		Par sa nature, cette unité peut-être très puissante ou tout à fait imutile sur le champ de bataille; tout dépends la façon qu'elle est joué.<p />
  La force du <a class='driller' href='/fr/Unit/Driller.aspx'>Perçeur</a> est l'<a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a>, ce qui est une excellent façpn de détruire les <a href='/fr/UnitIndex.aspx'>Unités</a> qui sont des <a href='/fr/Battles/DispensableUnits.aspx'>Chair à canon</a>.
  Cette attaque est aussi utile pour atteindre une unité qui semble hors de <a href='/fr/Battles/Range.aspx'>Portée</a>, car les unités adjacentes à la cible atatqués reçoivent aussi des dégats <p />
  Le problème du <a class='driller' href='/fr/Unit/Driller.aspx'>Perçeur</a> est que sont <a href='/fr/Battles/Movement.aspx#MovCost'>Coût de mouvemment</a> de 2 et sa <a href='/fr/Battles/Range.aspx'>Portée</a> de 1 le rendent inutiles si il n'est pas dans le feu de l'action.
	</div>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a></li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domination</a> Niveau 3</li></ul></td><td><ul><li>425 <a href='../Intrinsic/Gold.aspx'>Or</a></li><li>500 <a href='../Intrinsic/Titanium.aspx'>Titane</a></li></ul></td><td class='duration'>40 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
