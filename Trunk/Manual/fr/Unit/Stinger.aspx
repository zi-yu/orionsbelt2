...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Piqueur" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/stinger.png' alt='Piqueur' />
		Le <a class='stinger' href='/fr/Unit/Stinger.aspx'>Piqueur</a> est une unité très particulière. En tant qu'unité, ce n'est pas son attaque, sa défense ou sa mobilité qui la rend extraordianire, mais son aptitude spéciale: <a href='/fr/Battles/Replicator.aspx'>Réplicateur</a>. Avec cette aptitude, le <a class='stinger' href='/fr/Unit/Stinger.aspx'>Piqueur</a>
 peut augmenter en nombre en attaquant d'autres <a href='/fr/UnitIndex.aspx'>Unités de Combat</a>.
	</div>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/Replicator.aspx'>Réplicateur</a></li></ul></td></tr></table>
	<h3>Bonus d'unité</h3><table class='table'><tr><th>Cible</th><th>Attaque</th><th>Défense</th><th>Portée</th></tr><tr><td>Légère</td><td>1000</td><td>0</td><td>0</td></tr></table>
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubateur</a> Niveau 4</li></ul></td><td><ul><li>100 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>200 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>75 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>50 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
