...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Metallic Beard" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/metallicbeard.png' alt='Metallic Beard' />
		<a class='metallicbeard' href='/fr/Unit/MetallicBeard.aspx'>Metallic Beard</a> est le commandeur suprême de la faction <a href='/fr/Race/Mercs.aspx'>Mercs</a>. <a class='metallicbeard' href='/fr/Unit/MetallicBeard.aspx'>Metallic Beard</a>
  possède une longue <a href='/fr/Battles/Range.aspx'>Portée</a> et plusieurs habiletés dévastatrices: <a href='/fr/Battles/Catapult.aspx'>Catapulte</a>, <a href='/fr/Battles/Rebound.aspx'>Rebond</a> et <a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a>.
  <p />
  Cela fait de <a class='metallicbeard' href='/fr/Unit/MetallicBeard.aspx'>Metallic Beard</a> une menace sur le <a href='/fr/Battles/GameBoard.aspx'>Plateau de jeu</a>.
	</div>
