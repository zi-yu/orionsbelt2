...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Destructeur" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/destroyer.png' alt='Destructeur' />
		Le <a class='destroyer' href='/fr/Unit/Destroyer.aspx'>Destructeur</a> est une unité très puissante.Malgré son handicap causé par son coût en mouvement et sa <a href='/fr/Battles/Range.aspx'>Portée</a>,  cette unité possède une des habiletés les pluspuissantes du jeu: la <a href='/fr/Battles/BombAttack.aspx'>Attaque explosive</a>.
  <p />
  Avec la <a href='/fr/Battles/BombAttack.aspx'>Attaque explosive</a>, le <a class='destroyer' href='/fr/Unit/Destroyer.aspx'>Destructeur</a> endommage toutes les <a href='/fr/UnitIndex.aspx'>Unités de Combat</a> autour,à chaque attaque.
	</div>
	...
	<h3>Habiletés spéciales</h3><table class='table'><tr><th>Type</th><th>Habiletés spéciales</th></tr><tr><td>Après les mouvements d'attaques</td><td><ul><li><a href='/fr/Battles/BombAttack.aspx'>Attaque explosive</a></li></ul></td></tr></table>
	
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubateur</a> Niveau 6</li></ul></td><td><ul><li>200 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>250 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>100 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>70 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Heure 10 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
