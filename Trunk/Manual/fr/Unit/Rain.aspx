...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bruine" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/rain.png' alt='Bruine' />
		Small, fast and cheap, the <a class='rain' href='/fr/Unit/Rain.aspx'>Bruine</a> it's one of the most important units in the <a href='/fr/Race/LightHumans.aspx'>Utopians</a> Army. It's ideal to
  block other units attacks in order to protect a more important unit (see <a href='/fr/Battles/DispensableUnits.aspx'>Chair à canon</a>).
  <p />
  Also its bonus against <a href='/fr/Battles/Heavy.aspx'>Lourde</a> units makes it a perfect addiction to any fleet.
  <p />
  It's <a href='/fr/Battles/Movement.aspx#MovCost'>Coût de mouvemment</a> is 1, like most of the <a href='/fr/Battles/Light.aspx'>Légère</a> units, and has <a href='/fr/Battles/Movement.aspx#MovAll'>Mobilité totale</a>.
	</div>
	...
	<h3>Bonus d'unité</h3><table class='table'><tr><th>Cible</th><th>Attaque</th><th>Défense</th><th>Portée</th></tr><tr><td>Lourde</td><td>1200</td><td>0</td><td>0</td></tr></table>
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Hangar de construction</a> Niveau 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Energy.aspx'>Énergie</a></li><li>175 <a href='../Intrinsic/Serium.aspx'>Serium</a></li></ul></td><td class='duration'>10 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
