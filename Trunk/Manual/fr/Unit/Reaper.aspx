...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Reaper" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/reaper.png' alt='Reaper' />
		Le <a class='reaper' href='/fr/Unit/Reaper.aspx'>Reaper</a>est une unité <a href='/fr/Battles/Light.aspx'>Légère</a> <a href='/fr/Race/Mercs.aspx'>Mercs</a>. C'est l'une des unités <a href='/fr/Battles/Light.aspx'>Légère</a>les plus puissantes du jeu. Elle est forte et possède <a href='/fr/Battles/TripleAttack.aspx'>Attaque triple</a>, ce qui en fait une unité tueuse d'unité <a href='/fr/Battles/Light.aspx'>Légère</a>.
  <p />
  Son seul désavantage est son type de mouvement, le <a class='reaper' href='/fr/Unit/Reaper.aspx'>Reaper</a> n'est pas utile comme <a href='/fr/Battles/DispensableUnits.aspx'>Chair à canon</a>.
	</div>
