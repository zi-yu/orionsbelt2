...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Oeuf" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/egg.png' alt='Oeuf' />
		L'<a class='egg' href='/fr/Unit/Egg.aspx'>Oeuf</a> ne peut être construit avec l'<a class='incubator' href='/fr/Facility/Incubator.aspx'>Incubateur</a> comme les autres unités <a href='/fr/Race/Bugs.aspx'>Levyr</a>. L' <a class='egg' href='/fr/Unit/Egg.aspx'>Oeuf</a>
  est placé sur le <a href='/fr/Battles/GameBoard.aspx'>Plateau de jeu</a> par la <a class='queen' href='/fr/Unit/Queen.aspx'>Reine</a> et éclot en <a class='maggot' href='/fr/Unit/Maggot.aspx'>Asticot</a> après deux tours.
	</div>
