...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Croiseur" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/crusader.png' alt='Croiseur' />
		The most important feature of the <a class='crusader' href='/fr/Unit/Crusader.aspx'>Croiseur</a> is it's unique long <a href='/fr/Battles/Range.aspx'>Portée</a> (<a href='/fr/Battles/Range.aspx'>Portée</a> 6) that distinguishes from all other units. <p />
  It's the most basic <a href='/fr/Battles/Heavy.aspx'>Lourde</a> unit of the <a href='/fr/Race/LightHumans.aspx'>Utopians</a> and does not have any special power. The <a href='/fr/Battles/Movement.aspx#MovFront'>Mobilité Frontale</a> makes it a
  unit difficult to maneuver but it's long range compensates it.
	</div>
	...
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Hangar de construction</a> Niveau 7</li></ul></td><td><ul><li>675 <a href='../Intrinsic/Energy.aspx'>Énergie</a></li><li>750 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>825 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li></ul></td><td class='duration'>1 Heure 10 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
