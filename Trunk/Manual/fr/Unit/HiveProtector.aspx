...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="protecteur coloniale" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/hiveprotector.png' alt='protecteur coloniale' />
		Le <a class='hiveprotector' href='/fr/Unit/HiveProtector.aspx'>protecteur coloniale</a> est l'unité ayant la plus grande défense disponible pour les <a href='/fr/Race/Bugs.aspx'>Levyr</a>. Elle a quelques similarités avec le <a class='pretorian' href='/fr/Unit/Pretorian.aspx'>Prédateur</a> des <a href='/fr/Race/LightHumans.aspx'>Utopians</a>, car sa défense est grande, et sont attaque plutôt faible. Sa défense est plus faible que le <a class='pretorian' href='/fr/Unit/Pretorian.aspx'>Prédateur</a>, mais l'attaque du <a class='hiveprotector' href='/fr/Unit/HiveProtector.aspx'>protecteur coloniale</a> est plus grande ce qui en fait une unité plus versatile. De l'autre coté, <a href='/fr/Battles/Movement.aspx#MovNormal'>Mobilité normale</a> n'est pas efficace comme type de mouvement pour défendre d'autres <a href='/fr/UnitIndex.aspx'>Unités de Combat</a>.
  <p />
En résumé, le <a class='hiveprotector' href='/fr/Unit/HiveProtector.aspx'>protecteur coloniale</a> a une grande résistance et une attaque meilleure que son cousin; sans oublier qu'il possède l'aptitude <a href='/fr/Battles/StrikeBack.aspx'>Contre-attaque</a>.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Catégorie</td>
			<td><a href='/fr/Battles/Medium.aspx'>Médium</a></td>
		</tr>
		<tr>
			<td>Position</td>
			<td>Air</td>
	...
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubateur</a> Niveau 5</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>200 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>175 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>125 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>50 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
