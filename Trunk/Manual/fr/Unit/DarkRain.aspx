...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bruine Noire" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darkrain.png' alt='Bruine Noire' />
		Le <a class='darkrain' href='/fr/Unit/DarkRain.aspx'>Bruine Noire</a> est l'unité de base de tout les <a href='/fr/Race/DarkHumans.aspx'>Renegades</a> et la première disponible à construire grâce au <a class='dominationyard' href='/fr/Facility/DominationYard.aspx'>Hangar de Domination</a>
  au niveau 1. <p />
  Malgré sa faible défense, c'est une bonne unité servant de <a href='/fr/Battles/DispensableUnits.aspx'>Chair à canon</a> car elle possède <a href='/fr/Battles/Movement.aspx#MovAll'>Mobilité totale</a> et un <a href='/fr/Battles/Movement.aspx#MovCost'>Coût de mouvemment</a> de 1. C'est aussi une unité qui est peu coûteuse. <p />
  Son bonus contre les unités <a href='/fr/Battles/Heavy.aspx'>Lourde</a> est aussi très important, son attaquye devient l'équivalent d'une unité medium <a href='/fr/Battles/Medium.aspx'>Médium</a>
  lorsqu'elle attaque une unité <a href='/fr/Battles/Heavy.aspx'>Lourde</a>.
	</div>
	...
	<h3>Bonus d'unité</h3><table class='table'><tr><th>Cible</th><th>Attaque</th><th>Défense</th><th>Portée</th></tr><tr><td>Lourde</td><td>600</td><td>0</td><td>0</td></tr></table>
	
	<h2>Information de construction</h2>
	<table class='table'><tr><th>Dépendences</th><th>Coût</th><th>Durée</th><th>Lorsque complété</th><th>Déverouiller</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domination</a> Niveau 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Gold.aspx'>Or</a></li><li>175 <a href='../Intrinsic/Titanium.aspx'>Titane</a></li></ul></td><td class='duration'>10 Minutes </td><td><ul><li>Transférer les unités vers l'escadrille de défense</li></ul></td><td><ul></ul></td></tr></table>
