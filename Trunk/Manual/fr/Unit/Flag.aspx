...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Drapeau" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/flag.png' alt='Drapeau' />
		Le <a class='flag' href='/fr/Unit/Flag.aspx'>Drapeau</a> est une unité spéciale seulement utilisé dans les combats <a href='/fr/Battles/Regicide.aspx'>Régicide</a>. Durant ces combats, le premier joueur à détruire le <a class='flag' href='/fr/Unit/Flag.aspx'>Drapeau</a> ennemi gagne le match.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Catégorie</td>
			<td><a href='/fr/Battles/Special.aspx'>Spécial</a></td>
		</tr>
		<tr>
			<td>Position</td>
			<td>Air</td>
