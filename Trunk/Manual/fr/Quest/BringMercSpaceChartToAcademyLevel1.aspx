...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		Les Mercs on les meilleurs cartes de l'univers. J'ai besoin de ces plans de l'univers que possède les escadrilles Mercs. Si vous en avez une, apporter la à une académie niveau 1.
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +3500</li><li><a class='sentry' href='/fr/Unit/Sentry.aspx'>Sentry</a> : +50</li><li><a class='radon' href='/fr/Intrinsic/Radon.aspx'>Radon</a> : +2500</li></ul>
	</div>
