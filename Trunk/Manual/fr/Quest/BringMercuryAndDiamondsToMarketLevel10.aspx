...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Apporter une escadrille ayant du mercure et des diamants à un marché niveau 10
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Apporter une escadrille ayant du mercure et des diamants à un marché niveau 10" runat="server" /></h1>
	
	<div class="description">
		Diriger une escadrille ayant du mercure et des diamants à un marché niveau 10
	</div>
