...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez 8 planètes de niveau 7 sur la zone publique
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez 8 planètes de niveau 7 sur la zone publique" runat="server" /></h1>
	
	<div class="description">
		Possédez 8 planàtes de niveau 7 sur la zone publique
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +2280</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +65</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +900</li><li><a class='radon' href='/fr/Intrinsic/Radon.aspx'>Radon</a> : +600</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +1200</li><li><a class='argon' href='/fr/Intrinsic/Argon.aspx'>Argon</a> : +800</li></ul>
	</div>
