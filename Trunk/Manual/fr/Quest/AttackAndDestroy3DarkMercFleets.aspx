...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Attack end destroy 3 Dark Merc Fleets
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Attack end destroy 3 Dark Merc Fleets" runat="server" /></h1>
	
	<div class="description">
		Des escadrilles Darks Mercs ont été repérés dans la zone niveau 1. Trouvez les et détruisez 3 escadrilles.
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +25000</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +8000</li><li><a class='radon' href='/fr/Intrinsic/Radon.aspx'>Radon</a> : +8000</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +8000</li><li><a class='argon' href='/fr/Intrinsic/Argon.aspx'>Argon</a> : +8000</li><li><a class='cryptium' href='/fr/Intrinsic/Cryptium.aspx'>Cryptium</a> : +8000</li></ul>
	</div>
