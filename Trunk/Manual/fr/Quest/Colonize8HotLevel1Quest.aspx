...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez 8 planètes de niveau 1 sur la zone publique
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez 8 planètes de niveau 1 sur la zone publique" runat="server" /></h1>
	
	<div class="description">
		Possédez 8 planète de niveau 1 sur la zone publique
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +360</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +10</li><li><a class='radon' href='/fr/Intrinsic/Radon.aspx'>Radon</a> : +200</li></ul>
	</div>
