...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez 5 planètes de niveau 5 sur la zone publique
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez 5 planètes de niveau 5 sur la zone publique" runat="server" /></h1>
	...
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +1200</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +34</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +800</li><li><a class='radon' href='/fr/Intrinsic/Radon.aspx'>Radon</a> : +500</li><li><a class='cryptium' href='/fr/Intrinsic/Cryptium.aspx'>Cryptium</a> : +300</li></ul>
	</div>
