...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		J'ai un rapport comme quoi les mercs possèdes des composantes qui m'intéressent. Apporter ces composantes à une académie niveau 1.
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +1000</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +2500</li></ul>
	</div>
