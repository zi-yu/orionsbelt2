...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez 5 planètes de niveau 7 sur la zone publique
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez 5 planètes de niveau 7 sur la zone publique" runat="server" /></h1>
	
	<div class="description">
		Possédez 5 planàtes de niveau 7 sur la zone publique
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +2160</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +62</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +500</li><li><a class='argon' href='/fr/Intrinsic/Argon.aspx'>Argon</a> : +800</li><li><a class='cryptium' href='/fr/Intrinsic/Cryptium.aspx'>Cryptium</a> : +1000</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +700</li></ul>
	</div>
