...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Construire un Sancutaire de dévôts sur votre planète mère
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Construire un Sancutaire de dévôts sur votre planète mère" runat="server" /></h1>
	
	<div class="description">
		Build a Devotion Sanctuary on your Home Planet
	</div>
