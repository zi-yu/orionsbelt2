...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez un extracteur niveau 5 sur une planète publiques
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez un extracteur niveau 5 sur une planète publiques" runat="server" /></h1>
	
	<div class="description">
		Posséder un extracteur niveau 5 sur une planète de la zone publique
	</div>
