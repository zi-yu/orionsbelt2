...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Compléter une route commerciale
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Compléter une route commerciale" runat="server" /></h1>
	
	<div class="description">
		Terminer une route commerciale
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +500</li><li><a href='/fr/MerchantQuests.aspx'>Marchand</a> : +30</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +100</li><li><a class='radon' href='/fr/Intrinsic/Radon.aspx'>Radon</a> : +100</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +100</li><li><a class='argon' href='/fr/Intrinsic/Argon.aspx'>Argon</a> : +100</li><li><a class='cryptium' href='/fr/Intrinsic/Cryptium.aspx'>Cryptium</a> : +100</li></ul>
	</div>
