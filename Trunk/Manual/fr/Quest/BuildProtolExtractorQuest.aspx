...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Construire un extracteur de protol sur votre planète mère
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Construire un extracteur de protol sur votre planète mère" runat="server" /></h1>
	
	<div class="description">
		Build a Protol Extractor on your Home Planet
	</div>
