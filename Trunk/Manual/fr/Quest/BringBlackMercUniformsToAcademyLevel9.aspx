...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		J'ai besoin d'infiltrer les Mercs Noires, et il me fait 6 uniformes Black Mercs pour l'opération. Apportez les à une académie niveau 9.
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +14000</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +7000</li><li><a class='argon' href='/fr/Intrinsic/Argon.aspx'>Argon</a> : +7000</li><li><a class='cryptium' href='/fr/Intrinsic/Cryptium.aspx'>Cryptium</a> : +7000</li></ul>
	</div>
