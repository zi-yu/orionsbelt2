...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		Les puces électroniques primaire contiennet des informations à propos des intentions Mers. Apportez-moi 2 de ces puces à une Académie niveau 1.
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +1000</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +2500</li></ul>
	</div>
