...
<asp:Content ContentPlaceHolderID="content" runat="server">
  ...
  <a href="../Facility/Extractor.aspx">Extractors</a>.
	...
	<h2>Récompense</h2>
	<div class="description">
		<ul><li><a href='/fr/Commerce/Orions.aspx'>Orions</a> : +50</li><li>Score : +80</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +2</li><li><a class='seeker' href='/fr/Unit/Seeker.aspx'>Ouvrier</a> : +3</li></ul>
	</div>
