...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez 5 planètes de niveau 1 sur la zone publique
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez 5 planètes de niveau 1 sur la zone publique" runat="server" /></h1>
	...
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +240</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +6</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +100</li></ul>
	</div>
