...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Améliorer toutes les constructions principales au niveau 5 sur votre zone privée
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Améliorer toutes les constructions principales au niveau 5 sur votre zone privée" runat="server" /></h1>
	
	<div class="description">
		Améliorer toutes vos constructions principales sur vos planètes privée au niveau 5
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +5000</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +50</li></ul>
	</div>
