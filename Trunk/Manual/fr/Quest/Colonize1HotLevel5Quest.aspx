...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez 1 planète de niveau 5 sur la zone publique
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez 1 planète de niveau 5 sur la zone publique" runat="server" /></h1>
	...
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +1040</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +29</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +300</li><li><a class='argon' href='/fr/Intrinsic/Argon.aspx'>Argon</a> : +600</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +600</li></ul>
	</div>
