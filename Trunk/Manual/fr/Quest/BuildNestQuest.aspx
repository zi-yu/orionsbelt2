...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Améliorer le Nid sur votre planète mère
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Améliorer le Nid sur votre planète mère" runat="server" /></h1>
	
	<div class="description">
		Upgrade the Nest on your Home Planet
	</div>
