...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Construire l'incubateur sur votre planète mère, vous permettant de construire des unités de combat
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Construire l'incubateur sur votre planète mère, vous permettant de construire des unités de combat" runat="server" /></h1>
	
	<div class="description">
		Build the Incubator on your Home Planet, that will allow you to build combat units
	</div>
