...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		J'ai un rapport comme quoi les mercs possèdes des composantes qui m'intéressent. Apporter ces composantes à une académie niveau 5.
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +6500</li><li><a class='astatine' href='/fr/Intrinsic/Astatine.aspx'>Astatine</a> : +4500</li><li><a class='radon' href='/fr/Intrinsic/Radon.aspx'>Radon</a> : +4500</li></ul>
	</div>
