...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Améliorer le centre de commande sur votre planète mère
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Améliorer le centre de commande sur votre planète mère" runat="server" /></h1>
	
	<div class="description">
		Upgrade the Command Center on your Home Planet
	</div>
