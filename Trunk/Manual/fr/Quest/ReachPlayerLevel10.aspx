...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Améliorer toutes les constructions principales au niveau 10 sur votre zone privée
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Améliorer toutes les constructions principales au niveau 10 sur votre zone privée" runat="server" /></h1>
	...
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +10000</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +100</li></ul>
	</div>
