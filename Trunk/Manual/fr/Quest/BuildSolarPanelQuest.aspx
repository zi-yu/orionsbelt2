...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Construire un panneau solaire sur votre planète mère
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Construire un panneau solaire sur votre planète mère" runat="server" /></h1>
	
	<div class="description">
		Build a Solar Panel on your Home Planet
	</div>
