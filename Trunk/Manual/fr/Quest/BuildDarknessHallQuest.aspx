...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Améliorer la tour obscure sur votre planète mère
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Améliorer la tour obscure sur votre planète mère" runat="server" /></h1>
	
	<div class="description">
		Upgrade the Darkness Hall on your Home Planet
	</div>
