...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Possédez 1 planète de niveau 3 sur la zone publique
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Possédez 1 planète de niveau 3 sur la zone publique" runat="server" /></h1>
	...
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +400</li><li><a href='/fr/ColonizerQuests.aspx'>Coloniseur</a> : +11</li><li><a class='prismal' href='/fr/Intrinsic/Prismal.aspx'>Prismal</a> : +300</li><li><a class='cryptium' href='/fr/Intrinsic/Cryptium.aspx'>Cryptium</a> : +300</li></ul>
	</div>
