...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		Les escadrilles Mercs sont composés d'une élément facilement détruit, le silicium. Apportez moi 2 échantillons de l'élément à une académie niveau 1.
	</div>
	
	<h2>Récompense</h2>
	<div class="description">
		<ul><li>Score : +2500</li><li><a class='argon' href='/fr/Intrinsic/Argon.aspx'>Argon</a> : +2500</li></ul>
	</div>
