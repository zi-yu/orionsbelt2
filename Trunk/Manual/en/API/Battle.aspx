...
<asp:Content ContentPlaceHolderID="content" runat="server">
    ...
    intelligence bots or game clients that'll be able to battle with other players or bots on the <a href='/en/Battles/GameBoard.aspx'>Game Board</a>. Example of a battle:
    ...
    be able to create a <a href='/en/Battles/Friendly.aspx'>Friendly</a> with it and try your bot in action.

    <a name="AskBattles" id="AskBattles"></a><h2>Ask For Battles</h2>
    The first time you ask for battles, you won't get any. You'll have to create a <a href='/en/Battles/Friendly.aspx'>Friendly</a> with your bot, and only then you'll get some battles
    ...
    The first part of the battle is the <a href='/en/Battles/Deploy.aspx'>Deploy</a>. When you request battles using the previous URL you'll receive something like:
    <pre class="code">
  &lt;Battles&gt;
  ...
  &lt;/Battles&gt;
    ...
    This is a very simple battle between <u>Bot001</u> and <u>nunos</u>, and you'd have to deploy now. The combat <a href='/en/Universe/Fleet.aspx'>Fleet</a> only has the <a class='raptor' href='/en/Unit/Raptor.aspx'>Raptor</a>, no more <a href='/en/UnitIndex.aspx'>Combat Units</a>
    are present. You'd now have to make a request to <u>ResponseUrl</u> indicating how you'd like to <a href='/en/Battles/Deploy.aspx'>Deploy</a>:
  ...
  &lt;/Battles&gt;
    ...
    Note that the state changed from <u>deploy</u> to <u>battle</u>. Now you receive the current <a href='/en/Battles/GameBoard.aspx'>Game Board</a> disposition, each unit group, quantity, coordinate, etc.
    ...
    Then it's your opponents turn to play. When he's done, you'll receive the new <a href='/en/Battles/GameBoard.aspx'>Game Board</a> state and you have to make more moves. This continues until
    the battle isn't finished. Note that your movements can't spend more than 6 <a href='/en/Battles/Movement.aspx#MovPoints'>Movement Points</a>.
