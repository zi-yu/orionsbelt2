...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Own one planet level 7 on the hot zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Own one planet level 7 on the hot zone" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +2000</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +57</li><li><a class='astatine' href='/en/Intrinsic/Astatine.aspx'>Astatine</a> : +500</li><li><a class='radon' href='/en/Intrinsic/Radon.aspx'>Radon</a> : +400</li><li><a class='argon' href='/en/Intrinsic/Argon.aspx'>Argon</a> : +800</li><li><a class='prismal' href='/en/Intrinsic/Prismal.aspx'>Prismal</a> : +800</li></ul>
	</div>
