...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Build the Unit Yard on your Home Planet, that will allow you to build combat units
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Build the Unit Yard on your Home Planet, that will allow you to build combat units" runat="server" /></h1>
