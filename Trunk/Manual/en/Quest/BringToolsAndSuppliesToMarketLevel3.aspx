...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring a fleet with both Tools and Supplies to a level 3 or 5 Market
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring a fleet with both Tools and Supplies to a level 3 or 5 Market" runat="server" /></h1>
	
	<div class="description">
		Bring Tools and Supplies to a level 3 or 5 Market
	</div>
