...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Upgrade all the main facilities on your private planets to level 9
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Upgrade all the main facilities on your private planets to level 9" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +9000</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +90</li></ul>
	</div>
