...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Own an Extractor level 1 on a hot zone planet
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Own an Extractor level 1 on a hot zone planet" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +1000</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +10</li></ul>
	</div>
