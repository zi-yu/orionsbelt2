...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Own five planets level 5 on the hot zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Own five planets level 5 on the hot zone" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +1200</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +34</li><li><a class='prismal' href='/en/Intrinsic/Prismal.aspx'>Prismal</a> : +800</li><li><a class='radon' href='/en/Intrinsic/Radon.aspx'>Radon</a> : +500</li><li><a class='cryptium' href='/en/Intrinsic/Cryptium.aspx'>Cryptium</a> : +300</li></ul>
	</div>
