...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Own eight planets level 5 on the hot zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Own eight planets level 5 on the hot zone" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +1320</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +37</li><li><a class='astatine' href='/en/Intrinsic/Astatine.aspx'>Astatine</a> : +800</li><li><a class='radon' href='/en/Intrinsic/Radon.aspx'>Radon</a> : +400</li><li><a class='argon' href='/en/Intrinsic/Argon.aspx'>Argon</a> : +700</li></ul>
	</div>
