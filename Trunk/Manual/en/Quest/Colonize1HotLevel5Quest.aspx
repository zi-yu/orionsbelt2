...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Own one planet level 5 on the hot zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Own one planet level 5 on the hot zone" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +1040</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +29</li><li><a class='astatine' href='/en/Intrinsic/Astatine.aspx'>Astatine</a> : +300</li><li><a class='argon' href='/en/Intrinsic/Argon.aspx'>Argon</a> : +600</li><li><a class='prismal' href='/en/Intrinsic/Prismal.aspx'>Prismal</a> : +600</li></ul>
	</div>
