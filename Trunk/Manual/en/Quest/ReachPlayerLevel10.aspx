...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Upgrade all the main facilities on your private planets to level 10
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Upgrade all the main facilities on your private planets to level 10" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +10000</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +100</li></ul>
	</div>
