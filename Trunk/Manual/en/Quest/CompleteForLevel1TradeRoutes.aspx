...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Complete 4 trade routes using Tools or Supplies
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Complete 4 trade routes using Tools or Supplies" runat="server" /></h1>
	
	<div class="description">
		Complete four trade routes using Tools or Supplies
	</div>
	
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +2000</li><li><a href='/en/MerchantQuests.aspx'>Merchant</a> : +120</li><li><a class='astatine' href='/en/Intrinsic/Astatine.aspx'>Astatine</a> : +400</li><li><a class='radon' href='/en/Intrinsic/Radon.aspx'>Radon</a> : +400</li><li><a class='prismal' href='/en/Intrinsic/Prismal.aspx'>Prismal</a> : +400</li><li><a class='argon' href='/en/Intrinsic/Argon.aspx'>Argon</a> : +400</li><li><a class='cryptium' href='/en/Intrinsic/Cryptium.aspx'>Cryptium</a> : +400</li></ul>
	</div>
