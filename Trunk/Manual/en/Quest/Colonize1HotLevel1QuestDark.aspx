...
<asp:Content ContentPlaceHolderID="content" runat="server">
  ...
  <a href="../Facility/Extractor.aspx">Extractors</a>.
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li><a href='/en/Commerce/Orions.aspx'>Orions</a> : +50</li><li>Score : +80</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +2</li><li><a class='darkrain' href='/en/Unit/DarkRain.aspx'>Dark Rain</a> : +3</li></ul>
	</div>
