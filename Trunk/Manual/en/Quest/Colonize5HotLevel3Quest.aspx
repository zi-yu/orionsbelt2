...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Own five planets level 3 on the hot zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Own five planets level 3 on the hot zone" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +560</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +16</li><li><a class='argon' href='/en/Intrinsic/Argon.aspx'>Argon</a> : +400</li><li><a class='astatine' href='/en/Intrinsic/Astatine.aspx'>Astatine</a> : +200</li></ul>
	</div>
