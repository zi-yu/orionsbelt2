...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Own five planets level 7 on the hot zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Own five planets level 7 on the hot zone" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li>Score : +2160</li><li><a href='/en/ColonizerQuests.aspx'>Colonizer</a> : +62</li><li><a class='astatine' href='/en/Intrinsic/Astatine.aspx'>Astatine</a> : +500</li><li><a class='argon' href='/en/Intrinsic/Argon.aspx'>Argon</a> : +800</li><li><a class='cryptium' href='/en/Intrinsic/Cryptium.aspx'>Cryptium</a> : +1000</li><li><a class='prismal' href='/en/Intrinsic/Prismal.aspx'>Prismal</a> : +700</li></ul>
	</div>
