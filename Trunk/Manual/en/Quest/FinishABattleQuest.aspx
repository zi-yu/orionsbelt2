...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Finish a battle on the hot zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Finish a battle on the hot zone" runat="server" /></h1>
	...
	<h2>Reward</h2>
	<div class="description">
		<ul><li><a href='/en/Commerce/Orions.aspx'>Orions</a> : +150</li><li><a class='astatine' href='/en/Intrinsic/Astatine.aspx'>Astatine</a> : +200</li></ul>
	</div>
