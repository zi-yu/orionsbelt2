...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		The <a class='bozer' href='/en/Unit/Bozer.aspx'>Bozer</a> is a unit that has a huge attack bonus against Air units, so it is destructive for the most
  units that crosses on its way. <p />
  Like the <a class='darkcrusader' href='/en/Unit/DarkCrusader.aspx'>Dark Crusader</a>, it has just <a href='/en/Battles/Movement.aspx#MovFront'>Front Movement</a> which makes it difficult to maneuver and positioning for a more efficient attack. <p />
  Another feature to consider is the <a href='/en/Battles/StrikeBack.aspx'>Strike Back</a>, so who intends to attack the <a class='bozer' href='/en/Unit/Bozer.aspx'>Bozer</a> be sure that all of them will be destroyed or 
  the <a href='/en/Battles/StrikeBack.aspx'>Strike Back</a> will do a great damage.
	</div>
	...
	<h3>Unit Bonus</h3><table class='table'><tr><th>Target</th><th>Attack</th><th>Defense</th><th>Range</th></tr><tr><td>Air</td><td>4000</td><td>0</td><td>0</td></tr></table>
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 9</li></ul></td><td><ul><li>800 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>775 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li><li>875 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li></ul></td><td class='duration'>1 Hour 10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
