...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Destroyer" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/destroyer.png' alt='Destroyer' />
		The <a class='destroyer' href='/en/Unit/Destroyer.aspx'>Destroyer</a> is a very powerful unit. Althouth the heavy movement and <a href='/en/Battles/Range.aspx'>Range</a> restrictions, it has
  one of the most powerful attacks of the game: the <a href='/en/Battles/BombAttack.aspx'>Bomb Attack</a>.
  <p />
  With <a href='/en/Battles/BombAttack.aspx'>Bomb Attack</a>, the <a class='destroyer' href='/en/Unit/Destroyer.aspx'>Destroyer</a> damages all the <a href='/en/UnitIndex.aspx'>Combat Units</a> arount it, every time it attacks.
	</div>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/BombAttack.aspx'>Bomb Attack</a></li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 6</li></ul></td><td><ul><li>200 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>250 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>100 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>70 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Hour 10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
