...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Worm" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/worm.png' alt='Worm' />
		The <a class='worm' href='/en/Unit/Worm.aspx'>Worm</a> is the most basic <a href='/en/Battles/Medium.aspx'>Medium</a> unit of <a href='/en/Race/Bugs.aspx'>Levyr</a>. It has a balanced attack and defense, but bellow
  average. But with <a href='/en/Battles/Movement.aspx#MovAll'>Total Movement</a> and movement cost of 2, it has a movement capacity above average for <a href='/en/Battles/Medium.aspx'>Medium</a>
  units.
  <p />
  It's a very versatile unit that can be very importante on a <a href='/en/Universe/Fleet.aspx'>Fleet</a> of <a href='/en/Race/Bugs.aspx'>Levyr</a>, because it can help defending,
  and can also strike with consideral damage the opponent's <a href='/en/UnitIndex.aspx'>Combat Units</a>.
	</div>
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 3</li></ul></td><td><ul><li>375 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>450 <a href='../Intrinsic/Protol.aspx'>Protol</a></li></ul></td><td class='duration'>30 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
