...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Spider" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/spider.png' alt='Spider' />
		The <a class='spider' href='/en/Unit/Spider.aspx'>Spider</a> is the most balanced combat unit available to <a href='/en/Race/Bugs.aspx'>Levyr</a>. It has a great attack and defense,
  good movement, and two very important abilities: <a href='/en/Battles/ParalyseAttack.aspx'>Paralyse Attack</a> and <a href='/en/Battles/StrikeBack.aspx'>Strike Back</a>.
  Having these two abilities means that every unit that attacks the <a class='spider' href='/en/Unit/Spider.aspx'>Spider</a> head to head, will be Paralysed
  if there's even 1 <a class='spider' href='/en/Unit/Spider.aspx'>Spider</a> left.
	</div>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr><tr><td>After Defense Moves</td><td><ul><li><a href='/en/Battles/StrikeBack.aspx'>Strike Back</a></li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 7</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>225 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>125 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Hour 10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
