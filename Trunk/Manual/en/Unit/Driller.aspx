...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Driller" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/driller.png' alt='Driller' />
		This is a unit that by its very nature can become immensely useful or useless in the battle field, depending on
  the manner of how the fighting takes place. <p />
  The <a class='driller' href='/en/Unit/Driller.aspx'>Driller</a>'s main strength is the <a href='/en/Battles/TripleAttack.aspx'>Triple Attack</a>, which is an excellent way to destroy <a href='/en/UnitIndex.aspx'>Units</a> that are forming <a href='/en/Battles/DispensableUnits.aspx'>Cannon Fodder</a>.
  This attack is also useful when trying to reach units that are seemingly out of <a href='/en/Battles/Range.aspx'>Range</a>, because the units
  adjacent to the attacked group will also suffer damage. <p />
  The problem of <a class='driller' href='/en/Unit/Driller.aspx'>Driller</a> is when they are not in the center of the action because their <a href='/en/Battles/Movement.aspx#MovCost'>Movement Cost</a> is 2 and <a href='/en/Battles/Range.aspx'>Range</a> is only 1.
	</div>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/TripleAttack.aspx'>Triple Attack</a></li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 3</li></ul></td><td><ul><li>425 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>500 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li></ul></td><td class='duration'>40 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
