...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Black Widow" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/blackwidow.png' alt='Black Widow' />
		There aren't a lof of <a href='/en/Battles/Heavy.aspx'>Heavy</a> <a href='/en/UnitIndex.aspx'>Combat Units</a> with <a href='/en/Battles/Movement.aspx#MovAll'>Total Movement</a> on the game, but the <a class='blackwidow' href='/en/Unit/BlackWidow.aspx'>Black Widow</a> is one of them.
  With a movement cost of 3, the <a class='blackwidow' href='/en/Unit/BlackWidow.aspx'>Black Widow</a> is a very movable unit, very poweful, and with two abilities:
  <a href='/en/Battles/InfestationAttack.aspx'>Infestation Attack</a> and <a href='/en/Battles/ParalyseAttack.aspx'>Paralyse Attack</a>.
  <p />
  Having both <a href='/en/Battles/InfestationAttack.aspx'>Infestation Attack</a> and <a href='/en/Battles/ParalyseAttack.aspx'>Paralyse Attack</a>, means that it's almost impossible to beat the <a class='blackwidow' href='/en/Unit/BlackWidow.aspx'>Black Widow</a>
  1 on 1 if the <a class='blackwidow' href='/en/Unit/BlackWidow.aspx'>Black Widow</a> attacks first.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Races</td>
			<td><a href='/en/Race/Bugs.aspx'>Levyr</a></td>
		</tr>
		<tr>
			<td>Category</td>
		...
		<tr>
			<td>Movement</td>
			<td><a href='/en/Battles/Movement.aspx#MovAll'>Total Movement</a></td>
		</tr>
	</table>
	
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/InfestationAttack.aspx'>Infestation Attack</a></li><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>1000 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>450 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>200 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>2 Hours </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
