...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		This is perhaps one of the best <a href='/en/Battles/Heavy.aspx'>Heavy</a> units in the game. It's <a href='/en/Battles/Movement.aspx#MovCost'>Movement Cost</a> of 3 allows the player to move it, attack
   and defend all in one turn.
   <p />
   It has <a href='/en/Battles/Movement.aspx#MovNormal'>Normal Movement</a> which is good for a <a href='/en/Battles/Heavy.aspx'>Heavy</a> unit because it control more squares if it is correctly placed. Also the <a href='/en/Battles/Rebound.aspx'>Rebound</a> attack makes
   ...
   <p />
   Although it an expensive unit and it's only available in avanced stages of the game (<a class='unityard' href='/en/Facility/UnitYard.aspx'>Unit Yard</a> level 9), this is definitely a <a href='/en/Battles/Heavy.aspx'>Heavy</a> unit to always
   have in your army.
	</div>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/Rebound.aspx'>Rebound</a></li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Unit Yard</a> Level 9</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Energy.aspx'>Energy</a></li><li>500 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>600 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>400 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>200 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>1 Hour 40 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
