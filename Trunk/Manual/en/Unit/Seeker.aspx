...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Seeker" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/seeker.png' alt='Seeker' />
		The <a class='seeker' href='/en/Unit/Seeker.aspx'>Seeker</a> is a very multipurpose <a href='/en/Battles/Light.aspx'>Light</a> unit. It has all the espected benefits from a <a href='/en/Battles/Light.aspx'>Light</a> unit, like speed
  and liberty of movement. It only has <a href='/en/Battles/Range.aspx'>Range</a> of 1, but it has a great bonus against <a href='/en/Battles/Medium.aspx'>Medium</a>
  <a href='/en/UnitIndex.aspx'>Combat Units</a>.
  <p />
  On a <a href='/en/Race/Bugs.aspx'>Levyr</a>'s <a href='/en/Universe/Fleet.aspx'>Fleet</a>, the <a class='seeker' href='/en/Unit/Seeker.aspx'>Seeker</a> is a must. It's the only unit that can be easily used as <a href='/en/Battles/DispensableUnits.aspx'>Cannon Fodder</a>
  and its great bonus against <a href='/en/Battles/Medium.aspx'>Medium</a> <a href='/en/UnitIndex.aspx'>Combat Units</a> is always a threat to your opponent.
	</div>
	...
	<h3>Unit Bonus</h3><table class='table'><tr><th>Target</th><th>Attack</th><th>Defense</th><th>Range</th></tr><tr><td>Medium</td><td>500</td><td>0</td><td>0</td></tr></table>
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 1</li></ul></td><td><ul><li>50 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>35 <a href='../Intrinsic/Elk.aspx'>Elk</a></li></ul></td><td class='duration'>10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
