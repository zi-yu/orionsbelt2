...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Taurus" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/taurus.png' alt='Taurus' />
		This unit is a like a small fortress moving on the <a href='/en/Battles/GameBoard.aspx'>Game Board</a>, virtually indestructible and with an immense attack power. <p />
   The weaknesses of <a class='taurus' href='/en/Unit/Taurus.aspx'>Taurus</a> is the short-<a href='/en/Battles/Range.aspx'>Range</a> for an <a href='/en/Battles/Heavy.aspx'>Heavy</a> unit and the fact that it only has <a href='/en/Battles/Movement.aspx#MovFront'>Front Movement</a>. But, when
   placed in the center of a battle, it's an extremely useful unit. <p />
   Along with the enormous attack, it has two special powers that amplify its destructive power: the <a href='/en/Battles/Rebound.aspx'>Rebound</a> and
   <a href='/en/Battles/TripleAttack.aspx'>Triple Attack</a>. These two powers combined can cause the destruction of enemy <a href='/en/UnitIndex.aspx'>Units</a> in 4 different squares with only one shot.
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Unit Yard</a> Level 10</li></ul></td><td><ul><li>500 <a href='../Intrinsic/Energy.aspx'>Energy</a></li><li>625 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>750 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>450 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>225 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Hour 30 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
