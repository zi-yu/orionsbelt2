...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Scarab" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/scarab.png' alt='Scarab' />
		This unit is the <a href='/en/Battles/Medium.aspx'>Medium</a> closest to a <a href='/en/Battles/Heavy.aspx'>Heavy</a> unit because of its great power of attack and defense for a <a href='/en/Battles/Medium.aspx'>Medium</a>,
  and its limited <a href='/en/Battles/Movement.aspx'>Movement</a> that is of the type <a href='/en/Battles/Movement.aspx#MovFront'>Front Movement</a>. However the <a href='/en/Battles/Movement.aspx#MovCost'>Movement Cost</a> is only 1, as the majority of <a href='/en/Battles/Light.aspx'>Light</a> <a href='/en/UnitIndex.aspx'>Units</a>,
  and has a relatively short <a href='/en/Battles/Range.aspx'>Range</a> of only 2. <p />
  Basically the <a class='scarab' href='/en/Unit/Scarab.aspx'>Scarab</a> is a hard unit to destroy and with a good attack power, but it has limitations as the difficulty of
  positioning and short-<a href='/en/Battles/Range.aspx'>Range</a> which makes the attack complicated, and the fact of not having any kind of special attack.
	</div>
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 4</li></ul></td><td><ul><li>300 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>250 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li><li>100 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>45 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>40 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
