...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Eagle" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/eagle.png' alt='Eagle' />
		The <a class='eagle' href='/en/Unit/Eagle.aspx'>Eagle</a> is considered by many as the strongest unit in the game.
  Its strenght isn't on the attack vale, but it's on the good movement cost, allied with the
  <a href='/en/Battles/Catapult.aspx'>Catapult</a> attack, that allows the <a class='eagle' href='/en/Unit/Eagle.aspx'>Eagle</a> to easilly circumvent the opponent's defenses.
  <p />
  Like almost all <a href='/en/UnitIndex.aspx'>Combat Units</a> with movement cost of 2 and <a href='/en/Battles/Medium.aspx'>Medium</a> category, the <a class='eagle' href='/en/Unit/Eagle.aspx'>Eagle</a> has many
  advantages on one to one confrontation with <a href='/en/UnitIndex.aspx'>Combat Units</a> having movement cost bigger than 2. And
  it's <a href='/en/Battles/Catapult.aspx'>Catapult</a> attack gives it a great advantaged against units like the <a class='kamikaze' href='/en/Unit/Kamikaze.aspx'>Kamikaze</a> or <a class='rain' href='/en/Unit/Rain.aspx'>Rain</a>,
  that can be quite troublesome if not destroyed.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Category</td>
			<td><a href='/en/Battles/Medium.aspx'>Medium</a></td>
		</tr>
		<tr>
			<td>Displacement</td>
			<td>Air</td>
		...
		<tr>
			<td>Movement</td>
			<td><a href='/en/Battles/Movement.aspx#MovDiagonal'>Diagonal Movement</a></td>
		</tr>
	</table>
	
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>Attack Moves</td><td><a href='/en/Battles/Catapult.aspx'>Catapult</a></td></tr></table>
	<h3>Unit Bonus</h3><table class='table'><tr><th>Target</th><th>Attack</th><th>Defense</th><th>Range</th></tr><tr><td>Medium</td><td>400</td><td>0</td><td>0</td></tr><tr><td>Heavy</td><td>0</td><td>400</td><td>0</td></tr></table>
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Unit Yard</a> Level 6</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Energy.aspx'>Energy</a></li><li>200 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>450 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>150 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>125 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>1 Hour 10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
