...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Hive Protector" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/hiveprotector.png' alt='Hive Protector' />
		The <a class='hiveprotector' href='/en/Unit/HiveProtector.aspx'>Hive Protector</a> is the most defensive unit available to <a href='/en/Race/Bugs.aspx'>Levyr</a>. It has some resemblances with the
  <a href='/en/Race/LightHumans.aspx'>Utopians</a> <a class='pretorian' href='/en/Unit/Pretorian.aspx'>Praetorian</a>, because it has a lot of defense, and a weak attack. In spite of not having
  so much defense as a <a class='pretorian' href='/en/Unit/Pretorian.aspx'>Praetorian</a>, it has a lot more attack, making the <a class='hiveprotector' href='/en/Unit/HiveProtector.aspx'>Hive Protector</a> more versatile. On
  the other hand, <a href='/en/Battles/Movement.aspx#MovNormal'>Normal Movement</a> isn't so good to defend other <a href='/en/UnitIndex.aspx'>Combat Units</a>.
  <p />
  Overall, the <a class='hiveprotector' href='/en/Unit/HiveProtector.aspx'>Hive Protector</a> is a unit with high resistance and good attack. And don't forget its ability
  to <a href='/en/Battles/StrikeBack.aspx'>Strike Back</a>.
	</div>
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 5</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>200 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>175 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>125 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>50 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
