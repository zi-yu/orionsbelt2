...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Small, fast and cheap, the <a class='rain' href='/en/Unit/Rain.aspx'>Rain</a> it's one of the most important units in the <a href='/en/Race/LightHumans.aspx'>Utopians</a> Army. It's ideal to
  block other units attacks in order to protect a more important unit (see <a href='/en/Battles/DispensableUnits.aspx'>Cannon Fodder</a>).
  <p />
  Also its bonus against <a href='/en/Battles/Heavy.aspx'>Heavy</a> units makes it a perfect addiction to any fleet.
  <p />
  It's <a href='/en/Battles/Movement.aspx#MovCost'>Movement Cost</a> is 1, like most of the <a href='/en/Battles/Light.aspx'>Light</a> units, and has <a href='/en/Battles/Movement.aspx#MovAll'>Total Movement</a>.
	</div>
	...
	<h3>Unit Bonus</h3><table class='table'><tr><th>Target</th><th>Attack</th><th>Defense</th><th>Range</th></tr><tr><td>Heavy</td><td>1200</td><td>0</td><td>0</td></tr></table>
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Unit Yard</a> Level 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Energy.aspx'>Energy</a></li><li>175 <a href='../Intrinsic/Serium.aspx'>Serium</a></li></ul></td><td class='duration'>10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
