...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Egg" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/egg.png' alt='Egg' />
		The <a class='egg' href='/en/Unit/Egg.aspx'>Egg</a> can't be built on the <a class='incubator' href='/en/Facility/Incubator.aspx'>Incubator</a> like the rest of the <a href='/en/Race/Bugs.aspx'>Levyr</a> units. The <a class='egg' href='/en/Unit/Egg.aspx'>Egg</a>
  is placed on the <a href='/en/Battles/GameBoard.aspx'>Game Board</a> by a <a class='queen' href='/en/Unit/Queen.aspx'>Queen</a> and hatches a <a class='maggot' href='/en/Unit/Maggot.aspx'>Maggot</a> in two turns.
	</div>
