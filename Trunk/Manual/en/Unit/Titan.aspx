...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Very powerfull <a href='/en/Battles/Heavy.aspx'>Heavy</a> from <a href='/en/Race/Mercs.aspx'>Mercs</a> unit with long <a href='/en/Battles/Range.aspx'>Range</a>. The <a class='titan' href='/en/Unit/Titan.aspx'>Titan</a> is also very resistant, and has <a href='/en/Battles/StrikeBack.aspx'>Strike Back</a> that makes it very good
    also on defense.
    <p />
    And with a <a href='/en/Battles/Range.aspx'>Range</a> of 5, it's perfect for a <a href='/en/Battles/FiringSquad.aspx'>Firing Squad</a>.
	</div>
