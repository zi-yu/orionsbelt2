...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Dark Crusader" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darkcrusader.png' alt='Dark Crusader' />
		The most important feature of <a class='darkcrusader' href='/en/Unit/DarkCrusader.aspx'>Dark Crusader</a> is the long <a href='/en/Battles/Range.aspx'>Range</a> (<a href='/en/Battles/Range.aspx'>Range</a> 6) that distinguishes from other units. <p />
  This is the <a href='/en/Battles/Heavy.aspx'>Heavy</a> unit most basic for the <a href='/en/Race/DarkHumans.aspx'>Renegades</a>, does not have any special power and has <a href='/en/Battles/Movement.aspx#MovFront'>Front Movement</a> which makes it a
  unit difficult to maneuver.
	</div>
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 7</li></ul></td><td><ul><li>675 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>750 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li><li>825 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li></ul></td><td class='duration'>1 Hour </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
