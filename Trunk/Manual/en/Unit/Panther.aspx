...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Panther" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/panther.png' alt='Panther' />
		<a class='panther' href='/en/Unit/Panther.aspx'>Panther</a> is a unit that has as its main feature the <a href='/en/Battles/Rebound.aspx'>Rebound</a> attack. Despite being weak units, they may be a
  threat to units with little life like any <a href='/en/Battles/Light.aspx'>Light</a> unit or even <a class='kamikaze' href='/en/Unit/Kamikaze.aspx'>Kamikaze</a>. <p />In sufficient quantity can even
  pouse as a threat to a <a class='flag' href='/en/Unit/Flag.aspx'>Flag</a>. So, when playing against these units remember that they are weak, but in
  sufficient quantities can cause considerable damage in our <a href='/en/Universe/Fleet.aspx'>Fleet</a>.
	</div>
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 4</li></ul></td><td><ul><li>75 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>150 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li><li>250 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>75 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>20 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
