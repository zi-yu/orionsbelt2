...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		The <a class='sentry' href='/en/Unit/Sentry.aspx'>Sentry</a> is a <a href='/en/Race/Mercs.aspx'>Mercs</a> <a href='/en/Battles/Light.aspx'>Light</a> unit. It's stronger than most light units and it has a very special power: 
  <a href='/en/Battles/RemoveAbilityAttack.aspx'>Remove Ability Attack</a>. With this power, a single <a class='sentry' href='/en/Unit/Sentry.aspx'>Sentry</a> unit may make useless every powerful unit on the game.
  <p />
  And with total movement type, the <a class='sentry' href='/en/Unit/Sentry.aspx'>Sentry</a> can also be used as <a href='/en/Battles/DispensableUnits.aspx'>Cannon Fodder</a>.
	</div>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/RemoveAbilityAttack.aspx'>Remove Ability Attack</a></li></ul></td></tr></table>
