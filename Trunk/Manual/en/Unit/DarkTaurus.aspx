...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Dark Taurus" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darktaurus.png' alt='Dark Taurus' />
		This unit is a like a small fortress moving on the <a href='/en/Battles/GameBoard.aspx'>Game Board</a>, virtually almost indestructible and with an immense attack power. <p />
   The weaknesses of <a class='darktaurus' href='/en/Unit/DarkTaurus.aspx'>Dark Taurus</a> is the short-<a href='/en/Battles/Range.aspx'>Range</a> for an <a href='/en/Battles/Heavy.aspx'>Heavy</a> unit and the fact that it only has <a href='/en/Battles/Movement.aspx#MovFront'>Front Movement</a>. But, when
   placed in the center of a battle, it's an extremely useful unit. <p />
   Along with the enormous power, it has two special powers that amplify its destructive power: the <a href='/en/Battles/Rebound.aspx'>Rebound</a> and
   <a href='/en/Battles/TripleAttack.aspx'>Triple Attack</a>. These two powers combined can cause the destruction of enemy <a href='/en/UnitIndex.aspx'>Units</a> in 4 different squares with only one shot.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Movement</td>
			<td><a href='/en/Battles/Movement.aspx#MovFront'>Front Movement</a></td>
		</tr>
	</table>
	
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/Rebound.aspx'>Rebound</a></li><li><a href='/en/Battles/TripleAttack.aspx'>Triple Attack</a></li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>700 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li><li>1125 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>375 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>125 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>1 Hour 30 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
