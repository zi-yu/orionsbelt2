...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Queen" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/queen.png' alt='Queen' />
		The <a class='queen' href='/en/Unit/Queen.aspx'>Queen</a> is the <a href='/en/Battles/Ultimate.aspx'>Ultimate</a> <a href='/en/Race/Bugs.aspx'>Levyr</a> unit. She's placed outside the <a href='/en/Battles/GameBoard.aspx'>Game Board</a> during battle, but can attack
  and take damage. The main power of the <a class='queen' href='/en/Unit/Queen.aspx'>Queen</a> is the ability to lay an <a class='egg' href='/en/Unit/Egg.aspx'>Egg</a> during battle on the <a href='/en/Battles/GameBoard.aspx'>Game Board</a>.
  From those eggs comes the <a class='maggot' href='/en/Unit/Maggot.aspx'>Maggot</a>.
  <p />
  The quantity of <a class='maggot' href='/en/Unit/Maggot.aspx'>Maggot</a> generated depends on the current number of <a href='/en/UnitIndex.aspx'>Combat Units</a> on the <a href='/en/Universe/Fleet.aspx'>Fleet</a>. After
  the battle all those <a class='maggot' href='/en/Unit/Maggot.aspx'>Maggot</a> will be destroyed.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Movement</td>
			<td><a href='/en/Battles/Movement.aspx#MovDrop'>Drop Movement</a></td>
		</tr>
	</table>
