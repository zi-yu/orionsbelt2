...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Heavy Seeker" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/heavyseeker.png' alt='Heavy Seeker' />
		The <a class='heavyseeker' href='/en/Unit/HeavySeeker.aspx'>Heavy Seeker</a> is the only long <a href='/en/Battles/Range.aspx'>Range</a> combat unit available to <a href='/en/Race/Bugs.aspx'>Levyr</a>. They have a heavy movement cost,
  a <a href='/en/Battles/Range.aspx'>Range</a> of 5, and good defense/attack. <a href='/en/Race/Bugs.aspx'>Levyr</a> are known by the easiness of movement
  of their <a href='/en/UnitIndex.aspx'>Combat Units</a>, and the <a class='heavyseeker' href='/en/Unit/HeavySeeker.aspx'>Heavy Seeker</a> isn't an exception. With <a href='/en/Battles/Movement.aspx#MovDiagonal'>Diagonal Movement</a> this unit can
  have a combined <a href='/en/Battles/Range.aspx'>Range</a> of 6!
	</div>
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 8</li></ul></td><td><ul><li>300 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>400 <a href='../Intrinsic/Elk.aspx'>Elk</a></li></ul></td><td class='duration'>1 Hour 30 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
