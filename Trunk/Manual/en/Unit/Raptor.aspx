...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		<a class='raptor' href='/en/Unit/Raptor.aspx'>Raptor</a> is the unit with most bonus against <a href='/en/Battles/Light.aspx'>Light</a> units. Has 1 of <a href='/en/Battles/Movement.aspx#MovCost'>Movement Cost</a> and 2 of <a href='/en/Battles/Range.aspx'>Range</a> which makes it
  perfect for breaking enemies defenses and destroy big groups of <a href='/en/Battles/Light.aspx'>Light</a> units.
  <p />
  It's available in the early stages of the game (when you build <a class='unityard' href='/en/Facility/UnitYard.aspx'>Unit Yard</a> level 2) which is a great advantage in comparison to
  the other races because in such a early stages only <a href='/en/Battles/Light.aspx'>Light</a> units are available.
	</div>
	...
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Unit Yard</a> Level 2</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Energy.aspx'>Energy</a></li><li>300 <a href='../Intrinsic/Serium.aspx'>Serium</a></li></ul></td><td class='duration'>20 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
