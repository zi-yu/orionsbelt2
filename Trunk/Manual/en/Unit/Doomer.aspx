...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		The <a class='doomer' href='/en/Unit/Doomer.aspx'>Doomer</a> is an unit extremely interesting because of its enormous attack power and their special powers, a good player
  on the <a href='/en/Battles/GameBoard.aspx'>Game Board</a> who knows well how to use the <a class='doomer' href='/en/Unit/Doomer.aspx'>Doomer</a> will be able to annihilate the enemy 's<a href='/en/Universe/Fleet.aspx'>Fleet</a> in a few attacks. <p />
  The <a class='doomer' href='/en/Unit/Doomer.aspx'>Doomer</a>'s attack is very hard to block its <a href='/en/Battles/Catapult.aspx'>Catapult</a> attack. And on top of that it still has <a href='/en/Battles/Rebound.aspx'>Rebound</a> and a huge attack 
  power which makes it a devastating unit. <p />
  However the <a class='doomer' href='/en/Unit/Doomer.aspx'>Doomer</a> has 2 problems, the <a href='/en/Battles/Movement.aspx#MovDiagonal'>Diagonal Movement</a> which makes it difficult to position and the poor defense, which makes it fragile
  even for the weaker <a href='/en/UnitIndex.aspx'>Units</a>, so you must be a good player to be able to take full advantage of this unit.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Races</td>
			<td><a href='/en/Race/DarkHumans.aspx'>Renegades</a></td>
		</tr>
		<tr>
			<td>Category</td>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>Attack Moves</td><td><a href='/en/Battles/Catapult.aspx'>Catapult</a></td></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/Rebound.aspx'>Rebound</a></li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 8</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>625 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li><li>750 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>125 <a href='../Intrinsic/Argon.aspx'>Argon</a></li></ul></td><td class='duration'>1 Hour 10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
