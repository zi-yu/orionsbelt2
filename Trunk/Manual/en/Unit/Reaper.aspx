...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		The <a class='reaper' href='/en/Unit/Reaper.aspx'>Reaper</a> is a <a href='/en/Race/Mercs.aspx'>Mercs</a> <a href='/en/Battles/Light.aspx'>Light</a> unit. It's one of the most powerful <a href='/en/Battles/Light.aspx'>Light</a> units on the game. It's strong and it 
  has <a href='/en/Battles/TripleAttack.aspx'>Triple Attack</a>, making it deadly against other <a href='/en/Battles/Light.aspx'>Light</a> units.
  <p />
  The only disadvantage is the movement type, that makes the <a class='reaper' href='/en/Unit/Reaper.aspx'>Reaper</a> not very useful as <a href='/en/Battles/DispensableUnits.aspx'>Cannon Fodder</a>.
	</div>
