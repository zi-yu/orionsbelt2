...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		The <a class='kamikaze' href='/en/Unit/Kamikaze.aspx'>Kamikaze</a> is probably the most treacherous unit of the game. Its enormous power of attack and its quick and versatile mobility,
  makes this unit a potential threat to any other unit on the <a href='/en/Battles/GameBoard.aspx'>Game Board</a>. <p />
  But as its name indicates, the <a class='kamikaze' href='/en/Unit/Kamikaze.aspx'>Kamikaze</a> are <a href='/en/UnitIndex.aspx'>Units</a> for suicide attacks since they become unprotected against any attack,
  because their defense is so insignificant that any type of unit easily destroys a large amount of <a class='kamikaze' href='/en/Unit/Kamikaze.aspx'>Kamikaze</a>.
  Also due to its poor defense, the <a class='kamikaze' href='/en/Unit/Kamikaze.aspx'>Kamikaze</a> has to be very well protected by other units because any attack even not direct
  (eg: <a href='/en/Battles/Rebound.aspx'>Rebound</a>, <a href='/en/Battles/TripleAttack.aspx'>Triple Attack</a>), can destroys a large number of <a class='kamikaze' href='/en/Unit/Kamikaze.aspx'>Kamikaze</a>.
	</div>
