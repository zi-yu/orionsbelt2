...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Interceptor" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/interceptor.png' alt='Interceptor' />
		The <a class='interceptor' href='/en/Unit/Interceptor.aspx'>Interceptor</a> is one the the most peculiar <a href='/en/UnitIndex.aspx'>Combat Units</a> on <a href='http://www.orionsbelt.eu'>Orion's Belt</a>. It has very good abilities but also strong
  disadvantages. If you're no careful enough, you'll see your <a class='interceptor' href='/en/Unit/Interceptor.aspx'>Interceptor</a> units unable to be useful on the
  <a href='/en/Battles/GameBoard.aspx'>Game Board</a>.
  <p />
  The <a class='interceptor' href='/en/Unit/Interceptor.aspx'>Interceptor</a> is a <a href='/en/Battles/Light.aspx'>Light</a> unit with a great power: <a href='/en/Battles/ParalyseAttack.aspx'>Paralyse Attack</a>. With its speed it can easily paralyse
  powerful <a href='/en/UnitIndex.aspx'>Combat Units</a>. However, it only has <a href='/en/Battles/Range.aspx'>Range</a> of 1 and <a href='/en/Battles/Movement.aspx#MovDiagonal'>Diagonal Movement</a>. This means that it can't be
  easily used for <a href='/en/Battles/DispensableUnits.aspx'>Cannon Fodder</a>.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Category</td>
			<td><a href='/en/Battles/Light.aspx'>Light</a></td>
		</tr>
		<tr>
			<td>Displacement</td>
			<td>Air</td>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 2</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Elk</a></li></ul></td><td class='duration'>10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
