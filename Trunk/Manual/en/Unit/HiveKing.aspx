...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Hive King" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/hiveking.png' alt='Hive King' />
		The <a class='hiveking' href='/en/Unit/HiveKing.aspx'>Hive King</a> is a very imponent unit from the <a href='/en/Race/Bugs.aspx'>Levyr</a> race. With a <a href='/en/Battles/Range.aspx'>Range</a> of 4 a movement cost of 3,
  the <a class='hiveking' href='/en/Unit/HiveKing.aspx'>Hive King</a> is one of the most movable <a href='/en/Battles/Heavy.aspx'>Heavy</a> units. Ok, <a href='/en/Battles/Movement.aspx#MovFront'>Front Movement</a> isn't the best movement type, but
  we can't forget that the <a class='hiveking' href='/en/Unit/HiveKing.aspx'>Hive King</a> has both very high attack and defense, and two special abilities.
  <p />
  The <a class='hiveking' href='/en/Unit/HiveKing.aspx'>Hive King</a> has <a href='/en/Battles/InfestationAttack.aspx'>Infestation Attack</a> and <a href='/en/Battles/RemoveAbilityAttack.aspx'>Remove Ability Attack</a>, that can be quite troublesome for
  the opponent.
	</div>
	...
	<h3>Special Abilities</h3><table class='table'><tr><th>Type</th><th>Special Abilities</th></tr><tr><td>After Attack Moves</td><td><ul><li><a href='/en/Battles/InfestationAttack.aspx'>Infestation Attack</a></li><li><a href='/en/Battles/RemoveAbilityAttack.aspx'>Remove Ability Attack</a></li></ul></td></tr></table>
	
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Incubator</a> Level 9</li></ul></td><td><ul><li>800 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>650 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>200 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>1 Hour 50 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
