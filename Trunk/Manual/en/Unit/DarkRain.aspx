...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Dark Rain" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darkrain.png' alt='Dark Rain' />
		The <a class='darkrain' href='/en/Unit/DarkRain.aspx'>Dark Rain</a> is the basic unit of <a href='/en/Race/DarkHumans.aspx'>Renegades</a> and the first unit to become available for construction when <a class='dominationyard' href='/en/Facility/DominationYard.aspx'>Domination Yard</a>
  is still at level 1. <p />
  Despite being a unit with little defense is a good <a href='/en/Battles/DispensableUnits.aspx'>Cannon Fodder</a> unit, because it have a <a href='/en/Battles/Movement.aspx#MovAll'>Total Movement</a> with <a href='/en/Battles/Movement.aspx#MovCost'>Movement Cost</a> 1. Also
  is a cheap unit with rapid construction. <p />
  It's also important the bonus of attack that it has against <a href='/en/Battles/Heavy.aspx'>Heavy</a> units, which makes it a unit at the level of a <a href='/en/Battles/Medium.aspx'>Medium</a>
  when it attacks the <a href='/en/Battles/Heavy.aspx'>Heavy</a> units.
	</div>
	...
	<h3>Unit Bonus</h3><table class='table'><tr><th>Target</th><th>Attack</th><th>Defense</th><th>Range</th></tr><tr><td>Heavy</td><td>600</td><td>0</td><td>0</td></tr></table>
	
	<h2>Build Information</h2>
	<table class='table'><tr><th>Dependencies</th><th>Cost</th><th>Duration</th><th>On Complete</th><th>Unlocks</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Domination Yard</a> Level 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>175 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li></ul></td><td class='duration'>10 Minutes </td><td><ul><li>Move Units To Defense Fleet</li></ul></td><td><ul></ul></td></tr></table>
