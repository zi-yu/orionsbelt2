...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Flag" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/flag.png' alt='Flag' />
		The <a class='flag' href='/en/Unit/Flag.aspx'>Flag</a> is a special unit that's only used on <a href='/en/Battles/Regicide.aspx'>Regicide</a> battles. On these battles, the first player
  that destroyes the opponent's <a class='flag' href='/en/Unit/Flag.aspx'>Flag</a>, wins the match.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Category</td>
			<td><a href='/en/Battles/Special.aspx'>Special</a></td>
		</tr>
		<tr>
			<td>Displacement</td>
			<td>Air</td>
