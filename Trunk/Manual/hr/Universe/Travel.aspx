...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1>Putovanje</h1>
	<div class="content">
Ako želite <a href='/hr/Universe/Travel.aspx'>Putovanje</a> u svemiru trebate samo jednu stvar: <a href='/hr/Universe/Fleet.aspx'>Flota</a> sa jedinicama.
<p />
Sljedeća slika je početno stanje vaše <a href='/hr/Universe/PrivateZone.aspx'>Privatna Zona</a> gdje <a href='/hr/Universe/Fleet.aspx'>Flota</a> sa spososbnosti pokreta je spremna na micanje.
<p /><img src="/Resources/Images/PrivateZoneInitialState.png" alt="Početno stanje vaše Privatne Zone" /><p />
Da biste pokrenuli flotu jednstavno kliknite na nju i onda kliknite na otkriveno područje. Tada  izaberite mogućnost "Pokreni Flotu". Sljedeći video će vam pokazati kako:
<p /></div>
</asp:Content>