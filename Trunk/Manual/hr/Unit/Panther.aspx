...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		<a class='panther' href='/hr/Unit/Panther.aspx'>Pantera</a> je jedinica čija je glavna značajka <a href='/hr/Battles/Rebound.aspx'>Povratni</a> napad. Iako su slabe jedinice, mogu biti prijetnja jedinicama sa malo života kao što su bilo koja <a href='/hr/Battles/Light.aspx'>Lagani</a> ili čak <a class='kamikaze' href='/hr/Unit/Kamikaze.aspx'>Kamikaza</a>.<p />
U dovoljnoj količini mogu čak predstavljati prijetnju <a class='flag' href='/hr/Unit/Flag.aspx'>Zastava</a>. Zato, kada igrate protiv ovih jedinca zapamtite da su one slabe, ali u dovoljnoj količini mogu uzrokovati značajnu štetu u našoj <a href='/hr/Universe/Fleet.aspx'>Flota</a>.
	</div>
