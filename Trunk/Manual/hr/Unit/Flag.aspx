...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Zastava" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/flag.png' alt='Zastava' />
		<a class='flag' href='/hr/Unit/Flag.aspx'>Zastava</a> je specijalna jedinica koja se samo koriststi u <a href='/hr/Battles/Regicide.aspx'>Regicid</a> bitkama. U ovim bitkama prvi igrač koji uništi protivnikov <a class='flag' href='/hr/Unit/Flag.aspx'>Zastava</a>, dobija meč.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Kategorija</td>
			<td><a href='/hr/Battles/Special.aspx'>Izvanredni</a></td>
		</tr>
		<tr>
			<td>Pomak</td>
			<td>Zrak</td>
