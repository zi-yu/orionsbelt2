...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Kamikaza" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/kamikaze.png' alt='Kamikaza' />
		<a class='kamikaze' href='/hr/Unit/Kamikaze.aspx'>Kamikaza</a> su vjeorojatno najizdajnička od svih jednica u igri. Njihova ogromna moć napada i njihova brza i svestrana mobilnost, čine od ove jednice potencijalnu prijetnju svim drugim jednicama na <a href='/hr/Battles/GameBoard.aspx'>Tabla Igre</a>. <p />
Ali kako ime indicira, <a class='kamikaze' href='/hr/Unit/Kamikaze.aspx'>Kamikaza</a> su <a href='/hr/UnitIndex.aspx'>Jedinice</a> za samoubilačke napade jer postaju jako nezaštićene protiv bilo kojega napada jer je njihova obrana beznačajna da bilo koji tip jednice može lako uništiti veliku količinu <a class='kamikaze' href='/hr/Unit/Kamikaze.aspx'>Kamikaza</a>.
I zbog svoje slabe obrane, <a class='kamikaze' href='/hr/Unit/Kamikaze.aspx'>Kamikaza</a> moraju biti jako zaštićene od strane drugih jedninca jer bilo koji napad, čak i onaj koji nije direktan  (npr: <a href='/hr/Battles/Rebound.aspx'>Povratni</a>, <a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a>), može uništiti velik broj <a class='kamikaze' href='/hr/Unit/Kamikaze.aspx'>Kamikaza</a>.
	</div>
	...
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Brodogradilište Dominacije</a> Nivo 5</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Gold.aspx'>Zlato</a></li><li>300 <a href='../Intrinsic/Titanium.aspx'>Titan</a></li><li>450 <a href='../Intrinsic/Uranium.aspx'>Uran</a></li><li>63 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Sat </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
