...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Crna Kiša" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darkrain.png' alt='Crna Kiša' />
		<a class='darkrain' href='/hr/Unit/DarkRain.aspx'>Crna Kiša</a> je osnovna jedinica <a href='/hr/Race/DarkHumans.aspx'>Renegades</a> i prva koja postaje dostupna za gradnju dok je <a class='dominationyard' href='/hr/Facility/DominationYard.aspx'>Brodogradilište Dominacije</a> još na nivou 1. <p />
Iako je jedinica sa malom obranom jako je dobra <a href='/hr/Battles/DispensableUnits.aspx'>Hrana za Topove</a> jedinica jer ima <a href='/hr/Battles/Movement.aspx#MovAll'>Totalni Pokret</a> sa <a href='/hr/Battles/Movement.aspx#MovCost'>Cijena Pokreta</a> 1. Također to je jeftina jedinica sa rapidnom konstrukcijom. <p />
Također je važan bonus napad kojega ima protiv <a href='/hr/Battles/Heavy.aspx'>Teški</a> jedinica, koji čini jedinicu ovoga nivoa <a href='/hr/Battles/Medium.aspx'>Srednji</a> kada napada <a href='/hr/Battles/Heavy.aspx'>Teški</a> jedinice.
	</div>
	...
	<h3>Bonus Jedinice</h3><table class='table'><tr><th>Meta</th><th>Napad</th><th>Obrana</th><th>Domet</th></tr><tr><td>Teški</td><td>600</td><td>0</td><td>0</td></tr></table>
	
	<h2>Informacije o Gradnji</h2>
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Brodogradilište Dominacije</a> Nivo 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Gold.aspx'>Zlato</a></li><li>175 <a href='../Intrinsic/Titanium.aspx'>Titan</a></li></ul></td><td class='duration'>10 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
