...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Tražilac" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/seeker.png' alt='Tražilac' />
		<a class='seeker' href='/hr/Unit/Seeker.aspx'>Tražilac</a> je višenamjernska <a href='/hr/Battles/Light.aspx'>Lagani</a> jedinica. Ima sve koristi koje očekujemo od <a href='/hr/Battles/Light.aspx'>Lagani</a> jedinice,  kao što su brzina i sloboda pokreta. Ima samo <a href='/hr/Battles/Range.aspx'>Domet</a> od 1, ali ima velik bonus protiv <a href='/hr/Battles/Medium.aspx'>Srednji</a> <a href='/hr/UnitIndex.aspx'>Borbene Jedinice</a>.
 <p />
U <a href='/hr/Race/Bugs.aspx'>Levyr</a> <a href='/hr/Universe/Fleet.aspx'>Flota</a>, <a class='seeker' href='/hr/Unit/Seeker.aspx'>Tražilac</a> je nešto što se mora imati. To je jedina jedinica koja se lako rabi kao <a href='/hr/Battles/DispensableUnits.aspx'>Hrana za Topove</a> i njezin veliki bonus protiv <a href='/hr/Battles/Medium.aspx'>Srednji</a> <a href='/hr/UnitIndex.aspx'>Borbene Jedinice</a> je uvijek prijetnja vašim protivnicima.
	</div>
	...
	<h3>Bonus Jedinice</h3><table class='table'><tr><th>Meta</th><th>Napad</th><th>Obrana</th><th>Domet</th></tr><tr><td>Srednji</td><td>500</td><td>0</td><td>0</td></tr></table>
	
	<h2>Informacije o Gradnji</h2>
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Nivo 1</li></ul></td><td><ul><li>50 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>35 <a href='../Intrinsic/Elk.aspx'>Elk</a></li></ul></td><td class='duration'>10 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
