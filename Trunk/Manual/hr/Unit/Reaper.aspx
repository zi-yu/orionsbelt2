...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Žetalica" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/reaper.png' alt='Žetalica' />
		<a class='reaper' href='/hr/Unit/Reaper.aspx'>Žetalica</a> je <a href='/hr/Race/Mercs.aspx'>Mercs</a> <a href='/hr/Battles/Light.aspx'>Lagani</a> jedinica. To je jedna od najmoćnijh <a href='/hr/Battles/Light.aspx'>Lagani</a> jedinica igre. Jaka je i ima <a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a> što je čini smrtonosnom protiv ostalih <a href='/hr/Battles/Light.aspx'>Lagani</a> jedinica.
<p />
Jedina prepreka joj je tip pokreta, koji od <a class='reaper' href='/hr/Unit/Reaper.aspx'>Žetalica</a> ne čini vrlo korisnu <a href='/hr/Battles/DispensableUnits.aspx'>Hrana za Topove</a>.
	</div>
