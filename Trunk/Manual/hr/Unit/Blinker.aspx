...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bljeskalica" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/blinker.png' alt='Bljeskalica' />
		Ovo je <a href='/hr/Race/LightHumans.aspx'>Utopians</a> <a href='/hr/Battles/Ultimate.aspx'>Ultimativni</a> jedinica. Ne može napadati ali može odgovoriti na neprijateljske napada zbog svoje <a href='/hr/Battles/StrikeBack.aspx'>Protunapad</a> sposobnosti.
<p />
Njegova glavna moć je da blika (ili teleportira) bilo koju jedinicu (koju posjeduje igrač ili neprijatelj) na bilo koji kvadrat na <a href='/hr/Battles/GameBoard.aspx'>Tabla Igre</a> (ograničeno na 4 kvadrata udaljenosti od <a class='blinker' href='/hr/Unit/Blinker.aspx'>Bljeskalica</a>). Kada upotrijebite ovu moć, <a class='blinker' href='/hr/Unit/Blinker.aspx'>Bljeskalica</a> ulazi u hlađenje da se napuni i stoji u njemu tokokm 8 turnova bitke. Tokom tog vremena moć se ne može rabiti i <a href='/hr/Battles/StrikeBack.aspx'>Protunapad</a> neće raditi.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Kategorija</td>
			<td><a href='/hr/Battles/Ultimate.aspx'>Ultimativni</a></td>
		</tr>
		<tr>
			<td>Pomak</td>
			<td>Zrak</td>
		...
		<tr>
			<td>Pokret</td>
			<td><a href='/hr/Battles/Movement.aspx#MovNone'>Bez Pokreta</a></td>
		</tr>
	</table>
	
	<h3>Specijalne Sposobnosti</h3><table class='table'><tr><th>Tip</th><th>Specijalne Sposobnosti</th></tr><tr><td>Nakon Obranbenih Pokreta</td><td><ul><li><a href='/hr/Battles/StrikeBack.aspx'>Protunapad</a></li></ul></td></tr></table>
	
	
	<h2>Informacije o Gradnji</h2>
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/BlinkerAssembler.aspx'>Tvornica Bljeskalica</a> Nivo 1</li></ul></td><td><ul><li>21750 <a href='../Intrinsic/Energy.aspx'>Energija</a></li><li>22250 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>25250 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>8625 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>6875 <a href='../Intrinsic/Radon.aspx'>Radon</a></li><li>7250 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>6125 <a href='../Intrinsic/Astatine.aspx'>Astatin</a></li><li>2250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>Ne možete imati više ultimativnih jednica nego postrojenja za gradnju ultimativnih jedinica.</li></ul></td><td class='duration'>16 Sati 40 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
