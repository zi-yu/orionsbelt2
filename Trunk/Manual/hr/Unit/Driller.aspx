...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bušitelj" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/driller.png' alt='Bušitelj' />
		Ovo je jedinica koja po svojoj prirodi može postatati nebjerojatno korisna ili beskorisna na bojnome polju, ovisno o načinu na koji se borba odvija. <p />
<a class='driller' href='/hr/Unit/Driller.aspx'>Bušitelj</a> glavna snaga je <a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a>, koji je odličan način da se unište jedinice koje formiraju <a href='/hr/Battles/DispensableUnits.aspx'>Hrana za Topove</a>.
Ovaj napad je također jako koristan kada pokušavamo dosegnuti jednice koje se čine van <a href='/hr/Battles/Range.aspx'>Domet</a>, jer jednice do napadnute grupe će također dobiti štetu.<p />
Problem <a class='driller' href='/hr/Unit/Driller.aspx'>Bušitelj</a> je kada nisu u centru akcije zbog njihovog <a href='/hr/Battles/Movement.aspx#MovCost'>Cijena Pokreta</a> od 2 i <a href='/hr/Battles/Range.aspx'>Domet</a> koji je samo 1.
	</div>
	...
	<h3>Specijalne Sposobnosti</h3><table class='table'><tr><th>Tip</th><th>Specijalne Sposobnosti</th></tr><tr><td>Nakon Napadačkih Poteza</td><td><ul><li><a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a></li></ul></td></tr></table>
	
	
	<h2>Informacije o Gradnji</h2>
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Brodogradilište Dominacije</a> Nivo 3</li></ul></td><td><ul><li>425 <a href='../Intrinsic/Gold.aspx'>Zlato</a></li><li>500 <a href='../Intrinsic/Titanium.aspx'>Titan</a></li></ul></td><td class='duration'>40 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
