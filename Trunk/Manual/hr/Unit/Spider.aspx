...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Pauk" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/spider.png' alt='Pauk' />
		<a class='spider' href='/hr/Unit/Spider.aspx'>Pauk</a> je najbalansiranija borbena jedinica dostupna <a href='/hr/Race/Bugs.aspx'>Levyr</a>. Ima odličan napad i obranu, dobar pokret, i dvije jeko važne sposobnosti: <a href='/hr/Battles/ParalyseAttack.aspx'>Napad Paralize</a> and <a href='/hr/Battles/StrikeBack.aspx'>Protunapad</a>.
Imati ove dvije sposobnosti znači da svaka jednica koja napadne <a class='spider' href='/hr/Unit/Spider.aspx'>Pauk</a> izravno, biti će Paralizirana ako ostane samo 1 <a class='spider' href='/hr/Unit/Spider.aspx'>Pauk</a>.
	</div>
	...
	<h3>Specijalne Sposobnosti</h3><table class='table'><tr><th>Tip</th><th>Specijalne Sposobnosti</th></tr><tr><td>Nakon Napadačkih Poteza</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr><tr><td>Nakon Obranbenih Pokreta</td><td><ul><li><a href='/hr/Battles/StrikeBack.aspx'>Protunapad</a></li></ul></td></tr></table>
	
	
	<h2>Informacije o Gradnji</h2>
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Nivo 7</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>225 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>125 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Sat 10 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
