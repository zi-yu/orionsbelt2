...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Glista" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/worm.png' alt='Glista' />
		<a class='worm' href='/hr/Unit/Worm.aspx'>Glista</a> je najosnovnija <a href='/hr/Battles/Medium.aspx'>Srednji</a> jedinica <a href='/hr/Race/Bugs.aspx'>Levyr</a>. Ima balansirani napad i obranu, ali ispod prosjeka. Ali sa <a href='/hr/Battles/Movement.aspx#MovAll'>Totalni Pokret</a> i cijenom pokreta od 2, ima natprsječni kapacitet pokreta za <a href='/hr/Battles/Medium.aspx'>Srednji</a> jedinice.
<p />
Jako je svestrana jedinica koja je jako važna u <a href='/hr/Universe/Fleet.aspx'>Flota</a> od <a href='/hr/Race/Bugs.aspx'>Levyr</a>, jer može pomoći braniti, i također može udariti na protivnikove <a href='/hr/UnitIndex.aspx'>Borbene Jedinice</a>. sa značajnom štetom
	</div>
	...
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Nivo 3</li></ul></td><td><ul><li>375 <a href='../Intrinsic/Elk.aspx'>Elk</a></li><li>450 <a href='../Intrinsic/Protol.aspx'>Protol</a></li></ul></td><td class='duration'>30 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
