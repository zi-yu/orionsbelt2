...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Stražar" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/sentry.png' alt='Stražar' />
		<a class='sentry' href='/hr/Unit/Sentry.aspx'>Stražar</a> je <a href='/hr/Race/Mercs.aspx'>Mercs</a> <a href='/hr/Battles/Light.aspx'>Lagani</a> jedinica. Jača je od većine laganih jednica i ima jako speciijalniu moć:
<a href='/hr/Battles/RemoveAbilityAttack.aspx'>Makni Sposobnost Napad</a>. Sa ovom moći, jedan <a class='sentry' href='/hr/Unit/Sentry.aspx'>Stražar</a> može učiniti beskorisnim svaku jaku jedincu u igri:
 <p />
I sa tipom totalnog pokreta, <a class='sentry' href='/hr/Unit/Sentry.aspx'>Stražar</a> također može biti korišten kao <a href='/hr/Battles/DispensableUnits.aspx'>Hrana za Topove</a>.
	</div>
