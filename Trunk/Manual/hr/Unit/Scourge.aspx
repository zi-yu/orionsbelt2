...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bič" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/scourge.png' alt='Bič' />
		<a class='scourge' href='/hr/Unit/Scourge.aspx'>Bič</a> je <a href='/hr/Race/Mercs.aspx'>Mercs</a> <a href='/hr/Battles/Medium.aspx'>Srednji</a> jedinica. To je tipična srednja jedinica sa <a href='/hr/Battles/Movement.aspx#MovCost'>Cijena Pokreta</a> od 2 i <a href='/hr/Battles/Range.aspx'>Domet</a> od 3. Ali također ima <a href='/hr/Battles/Rebound.aspx'>Povratni</a>, što znači da  <a class='scourge' href='/hr/Unit/Scourge.aspx'>Bič</a> može dobiti  <a href='/hr/Battles/Range.aspx'>Domet</a> od 4.
<p />
Također ima dobru obranu i napad, jedina loša stvar je da ima dijagonalni pokret.
	</div>
