...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Tamni Bik" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darktaurus.png' alt='Tamni Bik' />
		Ova jedinica je kao mala tvrđava koja se miče <a href='/hr/Battles/GameBoard.aspx'>Tabla Igre</a>, skoro neuništiva i sa nevjerojatnom snagom napada.<p />
Slabost <a class='darktaurus' href='/hr/Unit/DarkTaurus.aspx'>Tamni Bik</a>  je kratki <a href='/hr/Battles/Range.aspx'>Domet</a> za <a href='/hr/Battles/Heavy.aspx'>Teški</a> i činjenica da ima samo <a href='/hr/Battles/Movement.aspx#MovFront'>Frontalni Pokret</a>. Ali kada je postavljen u centar bitke, to je jako korisna jednica. <p />
Zajedno sa nevjerojatnom snagom, ima dvije specijalne moći koje povećavaju njegovu destruktivnu moć: <a href='/hr/Battles/Rebound.aspx'>Povratni</a> i<a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a>. Ove dvije moći kombinirane mogu uzrokovati uništenje neprijteljskih <a href='/hr/UnitIndex.aspx'>Jedinice</a> i 4 različita kvadrata sa samo pogotkom.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Pokret</td>
			<td><a href='/hr/Battles/Movement.aspx#MovFront'>Frontalni Pokret</a></td>
		</tr>
	</table>
	
	<h3>Specijalne Sposobnosti</h3><table class='table'><tr><th>Tip</th><th>Specijalne Sposobnosti</th></tr><tr><td>Nakon Napadačkih Poteza</td><td><ul><li><a href='/hr/Battles/Rebound.aspx'>Povratni</a></li><li><a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a></li></ul></td></tr></table>
	
	
	<h2>Informacije o Gradnji</h2>
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Brodogradilište Dominacije</a> Nivo 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Gold.aspx'>Zlato</a></li><li>700 <a href='../Intrinsic/Titanium.aspx'>Titan</a></li><li>1125 <a href='../Intrinsic/Uranium.aspx'>Uran</a></li><li>375 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>125 <a href='../Intrinsic/Astatine.aspx'>Astatin</a></li></ul></td><td class='duration'>1 Sat 30 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
