...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Presretač" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/interceptor.png' alt='Presretač' />
		<a class='interceptor' href='/hr/Unit/Interceptor.aspx'>Presretač</a> je jedna od neobičnijih <a href='/hr/UnitIndex.aspx'>Borbene Jedinice</a> u <a href='http://www.orionsbelt.eu'>Orioniv Pojas</a>. Ima jako dobre sposobnosti ali također i jake nedostatke. Ako niste dovoljno oprezni, vidjeti ćete vaše <a class='interceptor' href='/hr/Unit/Interceptor.aspx'>Presretač</a> jedinice kako ne mogu biti korisne na <a href='/hr/Battles/GameBoard.aspx'>Tabla Igre</a>.
<p />
<a class='interceptor' href='/hr/Unit/Interceptor.aspx'>Presretač</a> je <a href='/hr/Battles/Light.aspx'>Lagani</a> jedinica sa velikom moći: <a href='/hr/Battles/ParalyseAttack.aspx'>Napad Paralize</a>. Sa svojom brzinom lako može paralizirati moćne <a href='/hr/UnitIndex.aspx'>Borbene Jedinice</a>. Ali, ima samo <a href='/hr/Battles/Range.aspx'>Domet</a> od 1 i <a href='/hr/Battles/Movement.aspx#MovDiagonal'>Dijagonalni Pokret</a>. To znači da ne može biti lako upotrijebljen za <a href='/hr/Battles/DispensableUnits.aspx'>Hrana za Topove</a>.
	</div>
	...
	<h3>Specijalne Sposobnosti</h3><table class='table'><tr><th>Tip</th><th>Specijalne Sposobnosti</th></tr><tr><td>Nakon Napadačkih Poteza</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Informacije o Gradnji</h2>
	<table class='table'><tr><th>Ovisnosti</th><th>Cijena</th><th>Trajanje</th><th>Po Završetku</th><th>Otključava</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Nivo 2</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Elk</a></li></ul></td><td class='duration'>10 Minute </td><td><ul><li>Pomakni Jedinice U Obranbenu Flotu</li></ul></td><td><ul></ul></td></tr></table>
