...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Srebrena Brada" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/silverbeard.png' alt='Srebrena Brada' />
		<a class='silverbeard' href='/hr/Unit/SilverBeard.aspx'>Srebrena Brada</a> je drugi u zapovjedništvu <a href='/hr/Race/Mercs.aspx'>Mercs</a> fakcije. Moć ove jednice je jednino može komparirati još moćnija <a class='metallicbeard' href='/hr/Unit/MetallicBeard.aspx'>Metalna Brada</a>. <a class='silverbeard' href='/hr/Unit/SilverBeard.aspx'>Srebrena Brada</a> ima dugi <a href='/hr/Battles/Range.aspx'>Domet</a> i set jako snažnih i razarajućiih sposobnosti: <a href='/hr/Battles/Catapult.aspx'>Katapult</a>, <a href='/hr/Battles/Rebound.aspx'>Povratni</a> and <a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a>. 
<p />
Ovo čini <a class='silverbeard' href='/hr/Unit/SilverBeard.aspx'>Srebrena Brada</a> prijetnjom na <a href='/hr/Battles/GameBoard.aspx'>Tabla Igre</a>.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Rase</td>
			<td><a href='/hr/Race/Mercs.aspx'>Mercs</a></td>
		</tr>
		<tr>
			<td>Kategorija</td>
	...
	<h3>Specijalne Sposobnosti</h3><table class='table'><tr><th>Tip</th><th>Specijalne Sposobnosti</th></tr><tr><td>Napadački Pokereti</td><td><a href='/hr/Battles/Catapult.aspx'>Katapult</a></td></tr><tr><td>Nakon Napadačkih Poteza</td><td><ul><li><a href='/hr/Battles/Rebound.aspx'>Povratni</a></li><li><a href='/hr/Battles/TripleAttack.aspx'>Trostruki Napad</a></li></ul></td></tr></table>
