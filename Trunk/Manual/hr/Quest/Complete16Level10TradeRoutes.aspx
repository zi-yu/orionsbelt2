...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Završi 16 trgovačkih ruta sa Životinjama ili Kozmičkom Prašinom
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Završi 16 trgovačkih ruta sa Životinjama ili Kozmičkom Prašinom" runat="server" /></h1>
	
	<div class="description">
		Završite dvanaest trgovačkih ruta koristeći se Životinjama ili Kozmičkom Prašinom
	</div>
