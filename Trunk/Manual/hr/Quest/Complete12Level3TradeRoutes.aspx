...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Završi 12 trgovačkih ruta sa Alkoholom ili Lijekovima unutar 24 sata
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Završi 12 trgovačkih ruta sa Alkoholom ili Lijekovima unutar 24 sata" runat="server" /></h1>
	
	<div class="description">
		Završite dvanaest trgovačkih ruta koristeći se Alkoholom ili Lijekovima unutar 24 sata
	</div>
