...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		<a class='krill' href='/de/Unit/Krill.aspx'>Krill</a> ist die geläufigste <a href='/de/Battles/Medium.aspx'>Medium</a> Einheit der <a href='/de/Race/LightHumans.aspx'>Utopians</a> Armee. Es ist die erste <a href='/de/Battles/Medium.aspx'>Medium</a> Einheit die zur Verfügung steht und die Ressourcen die benötigt werden um es zu bauen sind leicht zu erbeuten (ist nur abhängig von gebräuchlichen Ressourcen).
   <p>
 Es hat durchschnittlichen Angriff und Verteidigung, exzellente Bewegung (<a href='/de/Battles/Movement.aspx#MovAll'>Totale Beweglichkeit</a>) und die spezielle Fähigkeit von <a href='/de/Battles/StrikeBack.aspx'>Gegenangriff</a> die sehr nützlich sein kann gegen feindliche Einheiten (mit der Ausnahme der Einheiten mit<a href='/de/Battles/ParalyseAttack.aspx'>Paralisier-Attacke</a>).</p>
	</div>
	...
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Weltraumhafen</a> Level 3</li></ul></td><td><ul><li>375 <a href='../Intrinsic/Energy.aspx'>Energie</a></li><li>450 <a href='../Intrinsic/Serium.aspx'>Serium</a></li></ul></td><td class='duration'>30 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
