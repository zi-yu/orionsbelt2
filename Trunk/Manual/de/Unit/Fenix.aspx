...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Fenix" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/fenix.png' alt='Fenix' />
		Diese ist wahrscheinlich einee der besten <a href='/de/Battles/Heavy.aspx'>Schwer</a> Einheiten im Spiel. Ihre <a href='/de/Battles/Movement.aspx#MovCost'>Bewegungs-Kost</a> von 3 erlaubt dem Spieler sie zu bewegen, anzugreifen
   und zu verteidigen, alles in einer einzigen Runde.
   <p>
   Sie hat <a href='/de/Battles/Movement.aspx#MovNormal'>Normale Bewegung</a> was gut ist für eine <a href='/de/Battles/Heavy.aspx'>Schwer</a> Einheit und weil sie mehrere Vierecke kontrollieren 
   kann wenn sie korrekt platziert wird. Auch der <a href='/de/Battles/Rebound.aspx'>Rückprall</a> Angriff macht diese Einheit sehr stark 
   weil sie praktisch eine Range von 5 dazu gewinnt (es kann die Ziel-Einheit zerstören und die Einheit 
   dahinter in der gleichen Runde). Ihr Angriff von 2500 kann feindlichen Einheiten grossen Schaden 
   zufügen.
   </p><p>
   Obwohl es eine kostenspielige Einheit und nur in den fortgeschrittenen Etappen des Spiels verfügbar 
   ist (<a class='unityard' href='/de/Facility/UnitYard.aspx'>Weltraumhafen</a> Level 9), ist dies die <a href='/de/Battles/Heavy.aspx'>Schwer</a> Einheit die man immer in seiner Armee haben muss.</p>
	</div>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li><a href='/de/Battles/Rebound.aspx'>Rückprall</a></li></ul></td></tr></table>
	
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Weltraumhafen</a> Level 9</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Energy.aspx'>Energie</a></li><li>500 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>600 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>400 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>200 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>1 Stunde 40 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
