...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		<a class='panther' href='/de/Unit/Panther.aspx'>Panther</a> ist eine Einheit deren Hauptstärke die <a href='/de/Battles/Rebound.aspx'>Rückprall</a> Attacke ist. Obwohl sie schwache Einheiten 
 sind, können sie eine Bedrohung darstellen für Einheiten mit wenig Lebensenergie wie jede <a href='/de/Battles/Light.aspx'>Licht</a> Einheit oder sogar <a class='kamikaze' href='/de/Unit/Kamikaze.aspx'>Kamikaze</a>. <p>In genügender Anzahl können sie sogar für eine <a class='flag' href='/de/Unit/Flag.aspx'>Flagge</a> zur Bedrohung werden. Also, wenn gegen diese Einheiten gespielt wird, erinnere dich dass sie zwar schwach sind, aber in genügender Anzahl können sie der <a href='/de/Universe/Fleet.aspx'>Flotte</a> erheblichen Schaden zufügen.</p>
	</div>
