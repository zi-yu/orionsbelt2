...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Abfangjäger" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/interceptor.png' alt='Abfangjäger' />
		Der <a class='interceptor' href='/de/Unit/Interceptor.aspx'>Abfangjäger</a> ist einer der eigenartigsten <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> auf <a href='http://www.orionsbelt.eu'>Orion's Belt</a>. Es hat sehr gute Fähigkeiten aber auch starke Nachteile. Wenn du nicht vorsichtig genug bist, werden deine <a class='interceptor' href='/de/Unit/Interceptor.aspx'>Abfangjäger</a> Einheiten unnützlich sein auf dem <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a>.
  <p>
  Der <a class='interceptor' href='/de/Unit/Interceptor.aspx'>Abfangjäger</a> ist eine <a href='/de/Battles/Light.aspx'>Licht</a> Einheit mit einer mächtigen Fähigkeit: <a href='/de/Battles/ParalyseAttack.aspx'>Paralisier-Attacke</a>. Mit ihrer Geschwindigkeit kann es mächtige <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> paralisieren. Trotz allem, hat es nur eine <a href='/de/Battles/Range.aspx'>Reichweite</a> von 1 und <a href='/de/Battles/Movement.aspx#MovDiagonal'>Diagonale Bewegung</a>. 
  Das bedeutet dass die Nutzung als <a href='/de/Battles/DispensableUnits.aspx'>Kanonenfutter</a> nicht einfach ist .</p>
	</div>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Level 2</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Nahrung</a></li></ul></td><td class='duration'>10 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
