...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bohrer" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/driller.png' alt='Bohrer' />
		Dies ist eine Einheit die aufgrund ihrer Natur immens nützlich oder unnützlich auf dem Schlachtfeld sein kann, abhängig von der Art und Weise wie der Kampf stattfindet. <p>
  Die Hauptstärke des <a class='driller' href='/de/Unit/Driller.aspx'>Bohrer</a> ist der <a href='/de/Battles/TripleAttack.aspx'>Dreifach-Attacke</a>, was eine exzellente Weise <a href='/de/UnitIndex.aspx'>Einheiten</a> zu zerstören die gerade <a href='/de/Battles/DispensableUnits.aspx'>Kanonenfutter</a> formieren.
  Dieser Angriff ist auch nützlich wenn versucht wird Einheiten zu erreichen die scheinbar ausserhalb der <a href='/de/Battles/Range.aspx'>Reichweite</a> sind, weil angrenzende Einheiten der attackierten Gruppe auch Schaden erhalten. </p><p>
  Das Problem des <a class='driller' href='/de/Unit/Driller.aspx'>Bohrer</a> ist dass wenn sie nicht im Zentrum der Action sind, denn sie haben nur eine <a href='/de/Battles/Movement.aspx#MovCost'>Bewegungs-Kost</a> von 2 und eine <a href='/de/Battles/Range.aspx'>Reichweite</a>.</p>
	</div>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li><a href='/de/Battles/TripleAttack.aspx'>Dreifach-Attacke</a></li></ul></td></tr></table>
	
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Herrschafts Hangar</a> Level 3</li></ul></td><td><ul><li>425 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>500 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li></ul></td><td class='duration'>40 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
