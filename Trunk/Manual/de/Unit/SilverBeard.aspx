...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Silberbart" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/silverbeard.png' alt='Silberbart' />
		<a class='silverbeard' href='/de/Unit/SilverBeard.aspx'>Silberbart</a> ist der zweite im Kommando der <a href='/de/Race/Mercs.aspx'>Mercs</a> Faktion. Nur der mächtige <a class='metallicbeard' href='/de/Unit/MetallicBeard.aspx'>Metallischer Bart</a> ist der Kraft dieser Einheit überlegen . <a class='silverbeard' href='/de/Unit/SilverBeard.aspx'>Silberbart</a> hat eine lange <a href='/de/Battles/Range.aspx'>Reichweite</a> und eine Reihe von sehr mächtigen Zerstörerungs-Fähigkeiten: <a href='/de/Battles/Catapult.aspx'>Katapult</a>, <a href='/de/Battles/Rebound.aspx'>Rückprall</a> and <a href='/de/Battles/TripleAttack.aspx'>Dreifach-Attacke</a>. 
  <p>
  Dies macht <a class='silverbeard' href='/de/Unit/SilverBeard.aspx'>Silberbart</a> eine Bedrohung für das <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a>.</p>
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Rassen</td>
			<td><a href='/de/Race/Mercs.aspx'>Mercs</a></td>
		</tr>
		<tr>
			<td>Kategorie</td>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Angriffsfähigkeiten</td><td><a href='/de/Battles/Catapult.aspx'>Katapult</a></td></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li><a href='/de/Battles/Rebound.aspx'>Rückprall</a></li><li><a href='/de/Battles/TripleAttack.aspx'>Dreifach-Attacke</a></li></ul></td></tr></table>
