...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Metallischer Bart" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/metallicbeard.png' alt='Metallischer Bart' />
		<a class='metallicbeard' href='/de/Unit/MetallicBeard.aspx'>Metallischer Bart</a> oberste Kommander der <a href='/de/Race/Mercs.aspx'>Mercs</a> Fraktion. <a class='metallicbeard' href='/de/Unit/MetallicBeard.aspx'>Metallischer Bart</a>
  hat eine lange <a href='/de/Battles/Range.aspx'>Reichweite</a> und eine Gruppe von zerstörerischen Fähigkeiten: <a href='/de/Battles/Catapult.aspx'>Katapult</a>, <a href='/de/Battles/Rebound.aspx'>Rückprall</a> and <a href='/de/Battles/TripleAttack.aspx'>Dreifach-Attacke</a>.
  <p>
  Dies macht <a class='metallicbeard' href='/de/Unit/MetallicBeard.aspx'>Metallischer Bart</a> zu einer Bedrohung auf dem <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a>.</p>
	</div>
