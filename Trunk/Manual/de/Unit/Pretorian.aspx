...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Praetorian" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/pretorian.png' alt='Praetorian' />
		Es ist die zweitdefensivste Einheit des Spiels. Sie hat enorme Verteidigungs-Stärke, was diese Einheit perfekt macht um andere Einheiten zu beschützen.
    <p>
    Der <a href='/de/Battles/StrikeBack.aspx'>Gegenangriff</a> gibt dieser Einheit einigen Schutz gegen feindliche Einheiten, aber die niedrige 
    Angriffs-Stärke fügt nicht sehr viel Schaden zu (Der Angriff ist der niedrigste unter <a href='/de/Battles/Medium.aspx'>Medium</a> 
    Einheiten).</p>
	</div>
	...
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Weltraumhafen</a> Level 4</li></ul></td><td><ul><li>350 <a href='../Intrinsic/Energy.aspx'>Energie</a></li><li>250 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>175 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>100 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>50 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
