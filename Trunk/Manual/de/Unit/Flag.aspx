...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Flagge" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/flag.png' alt='Flagge' />
		Die <a class='flag' href='/de/Unit/Flag.aspx'>Flagge</a> ist eine spezieller Einheit die nur in <a href='/de/Battles/Regicide.aspx'>Königsmord</a> Schlachten benutzt werden kann. Auf diesen Schlachten, gewinnt der Spieler der die <a class='flag' href='/de/Unit/Flag.aspx'>Flagge</a> des Gegners zuerst zerstört.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Kategorie</td>
			<td><a href='/de/Battles/Special.aspx'>Spezial</a></td>
		</tr>
		<tr>
			<td>Position</td>
			<td>Luft</td>
