...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		<a class='nova' href='/de/Unit/Nova.aspx'>Nova</a> ist DIE <a href='/de/Battles/Heavy.aspx'>Schwer</a> gegen Einheiten des Typs <a href='/de/Battles/Organic.aspx'>Organisch</a> . Es hat einen Angriff von 2700 der um 4000 erhöht wird wenn es <a href='/de/Battles/Organic.aspx'>Organisch</a> Einheiten angreift (Gesamt von 6700 Angriffs-Kraft).
   <p>
   Es hat <a href='/de/Battles/Movement.aspx#MovNormal'>Normale Bewegung</a> und eine <a href='/de/Battles/Range.aspx'>Reichweite</a> von 5 was dieser Einheit grosse Kontrolle über das <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a> 
   gibt, weil, in den meisten Fällen, aus einer Distanz angreifen kann wo feindliche Einheiten es nicht 
   leicht erreichen können.
   </p><p>
   Die Kosten sind angenehm denn sie sind nur von gebräuchlichen Ressourcen abhängig. Eine Einheit die 
   ein Muss ist um gegen Rassen kämpfen, die Einheiten des Typs <a href='/de/Battles/Organic.aspx'>Organisch</a> besitzen (wie die <a href='/de/Race/Bugs.aspx'>Levyr</a>).</p>
	</div>
	...
	<h3>Einheiten Bonus</h3><table class='table'><tr><th>Ziel</th><th>Angriff</th><th>Verteidigung</th><th>Reichweite</th></tr><tr><td>Organisch</td><td>4000</td><td>0</td><td>0</td></tr></table>
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Weltraumhafen</a> Level 8</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Energy.aspx'>Energie</a></li><li>375 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>500 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>175 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>50 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Stunde 10 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
