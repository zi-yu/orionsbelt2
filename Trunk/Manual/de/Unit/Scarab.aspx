...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Skarabäus" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/scarab.png' alt='Skarabäus' />
		Diese ist die <a href='/de/Battles/Medium.aspx'>Medium</a> Einheit die der <a href='/de/Battles/Heavy.aspx'>Schwer</a> Einheit am nächsten steht, wegen ihrer grossen Angriffsstärke und Verteidigung für eine <a href='/de/Battles/Medium.aspx'>Medium</a>,
  und ihre limitierte <a href='/de/Battles/Movement.aspx'>Beweglichkeit</a> Stärke die Typ <a href='/de/Battles/Movement.aspx#MovFront'>Frontal-Bewegung</a> ist. Auch wenn die <a href='/de/Battles/Movement.aspx#MovCost'>Bewegungs-Kost</a> nur 1 ist, wie die Mehrheit der <a href='/de/Battles/Light.aspx'>Licht</a> <a href='/de/UnitIndex.aspx'>Einheiten</a>,
  hat es eine relativ kurze <a href='/de/Battles/Range.aspx'>Reichweite</a> von nur 2. <p>
  Im Prinzip ist die <a class='scarab' href='/de/Unit/Scarab.aspx'>Skarabäus</a> eine harte Einheit zu zerstören und hat eine gute Angriffsstärke, aber sie hat Limitationen wie die Schwierigkeit sie zu positionieren und eine kurze <a href='/de/Battles/Range.aspx'>Reichweite</a> die den Angriff schwierig macht, und die Tatsache dass sie keine spezielle Attacke hat.</p>
	</div>
