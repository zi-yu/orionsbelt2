...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Der <a class='sentry' href='/de/Unit/Sentry.aspx'>Sentry</a> ist eine <a href='/de/Race/Mercs.aspx'>Mercs</a> <a href='/de/Battles/Light.aspx'>Licht</a> unit. Es ist stärker als die meisten light Einheiten und es hat eine sehr spezielle Fähigkeit : 
  <a href='/de/Battles/RemoveAbilityAttack.aspx'>Fähigkeiten entfernen</a>. Mit dieser Fähigkeit, kann ein einzige <a class='sentry' href='/de/Unit/Sentry.aspx'>Sentry</a> Einheit jede mächtige Einheit 
  im Spiel unnützlich machen.
  <p>
  Und mit totaler Bewegungsfreiheit, kann der <a class='sentry' href='/de/Unit/Sentry.aspx'>Sentry</a> auch als <a href='/de/Battles/DispensableUnits.aspx'>Kanonenfutter</a> genutzt werden.</p>
	</div>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li><a href='/de/Battles/RemoveAbilityAttack.aspx'>Fähigkeiten entfernen</a></li></ul></td></tr></table>
