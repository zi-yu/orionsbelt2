...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Zerstörer" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/destroyer.png' alt='Zerstörer' />
		Die <a class='destroyer' href='/de/Unit/Destroyer.aspx'>Zerstörer</a> ist eine sehr mächtige Einheit. Obwohl Bewegung und <a href='/de/Battles/Range.aspx'>Reichweite</a> beschränkt sind, has es eine der mächtigsten Attacken im Spiel: Der <a href='/de/Battles/BombAttack.aspx'>Bombenattacke</a>.
  <p>
  Jedesmal wenn die <a class='destroyer' href='/de/Unit/Destroyer.aspx'>Zerstörer</a> Einheit mit <a href='/de/Battles/BombAttack.aspx'>Bombenattacke</a> angreift, fügt sie allen <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> 
  drumherum Schaden zu.
  </p>
	</div>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li><a href='/de/Battles/BombAttack.aspx'>Bombenattacke</a></li></ul></td></tr></table>
	
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Level 6</li></ul></td><td><ul><li>200 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>250 <a href='../Intrinsic/Elk.aspx'>Nahrung</a></li><li>100 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>70 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Stunde 10 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
