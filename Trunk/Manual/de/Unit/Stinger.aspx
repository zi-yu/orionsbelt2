...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Stachel" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/stinger.png' alt='Stachel' />
		Der <a class='stinger' href='/de/Unit/Stinger.aspx'>Stachel</a> ist eine sehr besondere Einheit. Als Einheit, hat es keinen besonderen Angriff, Verteidigung oder Bewegungsmodus, aber es hat eine einzigartige Fähigkeit: <a href='/de/Battles/Replicator.aspx'>Replikator</a>. Mit dieser Fähigkeit, erhöht der <a class='stinger' href='/de/Unit/Stinger.aspx'>Stachel</a> seine Anzahl während es andere <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> attackiert.
	</div>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li><a href='/de/Battles/Replicator.aspx'>Replikator</a></li></ul></td></tr></table>
	...
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Level 4</li></ul></td><td><ul><li>100 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>200 <a href='../Intrinsic/Elk.aspx'>Nahrung</a></li><li>75 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>50 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
