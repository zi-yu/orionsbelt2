...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Sucher" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/seeker.png' alt='Sucher' />
		Der <a class='seeker' href='/de/Unit/Seeker.aspx'>Sucher</a> ist eine Mehrzweck <a href='/de/Battles/Light.aspx'>Licht</a> Einheit. es hat all die erwarteten Vorteile einer <a href='/de/Battles/Light.aspx'>Licht</a> Einheit, wie Geschwindigkeit und Bewegungsfreiheit. Es hat nur eine <a href='/de/Battles/Range.aspx'>Reichweite</a> von 1, aber es hat einen grossen Bonus gegen <a href='/de/Battles/Medium.aspx'>Medium</a> <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a>.
  <p>
  Auf einer <a href='/de/Race/Bugs.aspx'>Levyr</a>'s <a href='/de/Universe/Fleet.aspx'>Flotte</a>, ist der <a class='seeker' href='/de/Unit/Seeker.aspx'>Sucher</a> ein Muss. Es ist die einzige Einheit die mit Leichtigkeit als <a href='/de/Battles/DispensableUnits.aspx'>Kanonenfutter</a> genutzt werden kann
  und ihr grosser Bonus gegen <a href='/de/Battles/Medium.aspx'>Medium</a> <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> ist immer eine Bedrohung für den Gegner.</p>
	</div>
	...
	<h3>Einheiten Bonus</h3><table class='table'><tr><th>Ziel</th><th>Angriff</th><th>Verteidigung</th><th>Reichweite</th></tr><tr><td>Medium</td><td>500</td><td>0</td><td>0</td></tr></table>
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Level 1</li></ul></td><td><ul><li>50 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>35 <a href='../Intrinsic/Elk.aspx'>Nahrung</a></li></ul></td><td class='duration'>10 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
