...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Schwarze Witwe" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/blackwidow.png' alt='Schwarze Witwe' />
		Es gibt nicht viele <a href='/de/Battles/Heavy.aspx'>Schwer</a> <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> mit <a href='/de/Battles/Movement.aspx#MovAll'>Totale Beweglichkeit</a> im Spiel, aber die <a class='blackwidow' href='/de/Unit/BlackWidow.aspx'>Schwarze Witwe</a> ist eine davon.
Mit einer Bewegungskost von 3, ist dir <a class='blackwidow' href='/de/Unit/BlackWidow.aspx'>Schwarze Witwe</a> eine sehr beweglich Einheit, sehr mächtig, und mit zwei Fähigkeiten ausgestattet:
  <a href='/de/Battles/InfestationAttack.aspx'>Gift-Attacke</a> und <a href='/de/Battles/ParalyseAttack.aspx'>Paralisier-Attacke</a>.
  <p>
 Dadurch dass sie <a href='/de/Battles/InfestationAttack.aspx'>Gift-Attacke</a> und <a href='/de/Battles/ParalyseAttack.aspx'>Paralisier-Attacke</a> hat, ist die <a class='blackwidow' href='/de/Unit/BlackWidow.aspx'>Schwarze Witwe</a> fast unmöglich zu 
  schlagen wenn sie zuerst zuschlägt.
  </p>
	</div>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Fähigkeiten nach dem Angriff</td><td><ul><li><a href='/de/Battles/InfestationAttack.aspx'>Gift-Attacke</a></li><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Level 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>1000 <a href='../Intrinsic/Elk.aspx'>Nahrung</a></li><li>450 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>200 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>2 Stunden </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
