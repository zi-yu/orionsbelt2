...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Adler" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/eagle.png' alt='Adler' />
		Die <a class='eagle' href='/de/Unit/Eagle.aspx'>Adler</a> wird von vielen als die stärkste Einheit im Spiel bezeichnet.
  Die <a class='eagle' href='/de/Unit/Eagle.aspx'>Adler</a> ist stark bewegich und hat einen <a href='/de/Battles/Catapult.aspx'>Katapult</a> Angriff, der es ihr erlaubt
   die Verteidigungen des Gegners leicht zu durchbrechen.
  <p>
  Wie die meisten <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> mit einer Bewegungskost von 2 und <a href='/de/Battles/Medium.aspx'>Medium</a> Kategorie, hat die <a class='eagle' href='/de/Unit/Eagle.aspx'>Adler</a> viele Vorteile in einem 1 gegen 1 Kampf gegen <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> die eine Bewegungskost von mehr als 2 haben. Und ihr <a href='/de/Battles/Catapult.aspx'>Katapult</a> Angriff gibt ihr einen grossen Vorteil gegen Einheiten wie die <a class='kamikaze' href='/de/Unit/Kamikaze.aspx'>Kamikaze</a> oder <a class='rain' href='/de/Unit/Rain.aspx'>Regen</a>,
die sehr lästig sein können wenn sie nicht zerstört werden.</p>
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Kategorie</td>
			<td><a href='/de/Battles/Medium.aspx'>Medium</a></td>
		</tr>
		<tr>
			<td>Position</td>
			<td>Luft</td>
	...
	<h3>Spezielle Fähigkeiten</h3><table class='table'><tr><th>Typ</th><th>Spezielle Fähigkeiten</th></tr><tr><td>Angriffsfähigkeiten</td><td><a href='/de/Battles/Catapult.aspx'>Katapult</a></td></tr></table>
	<h3>Einheiten Bonus</h3><table class='table'><tr><th>Ziel</th><th>Angriff</th><th>Verteidigung</th><th>Reichweite</th></tr><tr><td>Medium</td><td>400</td><td>0</td><td>0</td></tr><tr><td>Schwer</td><td>0</td><td>400</td><td>0</td></tr></table>
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Weltraumhafen</a> Level 6</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Energy.aspx'>Energie</a></li><li>200 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>450 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>150 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>125 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>1 Stunde 10 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
