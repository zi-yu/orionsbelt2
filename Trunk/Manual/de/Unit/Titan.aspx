...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Titan" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/titan.png' alt='Titan' />
		Sehr mächtige <a href='/de/Battles/Heavy.aspx'>Schwer</a> der <a href='/de/Race/Mercs.aspx'>Mercs</a> Einheit mit langer <a href='/de/Battles/Range.aspx'>Reichweite</a>. Der <a class='titan' href='/de/Unit/Titan.aspx'>Titan</a> ist auch sehr resistent, und hat <a href='/de/Battles/StrikeBack.aspx'>Gegenangriff</a> der es auch sehr gut in der Verteidigung macht.
    <p>
   Und mit einer <a href='/de/Battles/Range.aspx'>Reichweite</a> von 5, ist es perfekt für die <a href='/de/Battles/FiringSquad.aspx'>Erschiessungskommando</a>.</p>
	</div>
