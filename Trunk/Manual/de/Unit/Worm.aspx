...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Wurm" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/worm.png' alt='Wurm' />
		Die <a class='worm' href='/de/Unit/Worm.aspx'>Wurm</a> ist die einfachste <a href='/de/Battles/Medium.aspx'>Medium</a> Einheit der <a href='/de/Race/Bugs.aspx'>Levyr</a>. Es hat ausgeglichene Verteidigung und Attack, aber unter dem Durchschnitt. Mit <a href='/de/Battles/Movement.aspx#MovAll'>Totale Beweglichkeit</a> und einer Bewegungskost von 2, hat es Bewegungs-Kapazität die über den Durchschnitt liegt für <a href='/de/Battles/Medium.aspx'>Medium</a> Einheiten.
  <p>
  Ist eine sehr vielseitige Einheit die sehr wichtig sein kann für eine <a href='/de/Universe/Fleet.aspx'>Flotte</a> der <a href='/de/Race/Bugs.aspx'>Levyr</a>, weil es bei 
  der Verteidigung helfen kann, und es kann der <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a> des Gegners beachtlichen Schaden 
  zufügen.</p>
	</div>
	...
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Level 3</li></ul></td><td><ul><li>375 <a href='../Intrinsic/Elk.aspx'>Nahrung</a></li><li>450 <a href='../Intrinsic/Protol.aspx'>Protol</a></li></ul></td><td class='duration'>30 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
