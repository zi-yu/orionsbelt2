...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Ei" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/egg.png' alt='Ei' />
		Das <a class='egg' href='/de/Unit/Egg.aspx'>Ei</a> kann nicht auf dem <a class='incubator' href='/de/Facility/Incubator.aspx'>Inkubator</a> gebaut werden wie der Rest <a href='/de/Race/Bugs.aspx'>Levyr</a> Einheiten. Das <a class='egg' href='/de/Unit/Egg.aspx'>Ei</a>
  wird auf dem <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a> platziert durch eine <a class='queen' href='/de/Unit/Queen.aspx'>Königin</a> und brütet eine <a class='maggot' href='/de/Unit/Maggot.aspx'>Made</a> in zwei Runden aus.
	</div>
