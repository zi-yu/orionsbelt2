...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Made" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/maggot.png' alt='Made' />
		Die <a class='maggot' href='/de/Unit/Maggot.aspx'>Made</a> kann nicht auf dem <a class='incubator' href='/de/Facility/Incubator.aspx'>Inkubator</a> gebaut werden, wie der Rest der <a href='/de/Race/Bugs.aspx'>Levyr</a> Einheiten. The <a class='maggot' href='/de/Unit/Maggot.aspx'>Made</a> wird auf dem <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a> geboren wenn eine <a class='queen' href='/de/Unit/Queen.aspx'>Königin</a> ein <a class='egg' href='/de/Unit/Egg.aspx'>Ei</a> ablegt. Als Einheit, ist es eine sehr interessante Einheit, die dir dabei helfen kann dein Gegner zu besiegen. Dennoch, solltest du nicht vergessen dass die <a class='maggot' href='/de/Unit/Maggot.aspx'>Made</a> am Ende der Schlacht zerstört wird.
	</div>
