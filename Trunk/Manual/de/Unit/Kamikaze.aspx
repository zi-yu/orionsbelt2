...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Kamikaze" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/kamikaze.png' alt='Kamikaze' />
		Die <a class='kamikaze' href='/de/Unit/Kamikaze.aspx'>Kamikaze</a> is wahrscheinlich die heimtückischste Einheit im Spiel. Ihre enorme Angriffsstärke und 
ihre schnell- und vielseitige Beweglichkeit, macht diese Einheit zu einer potentiellen Gefahr für jede  
andere Einheit auf dem <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a>. <p>
  Aber wie der Name schon sagt, sind die <a class='kamikaze' href='/de/Unit/Kamikaze.aspx'>Kamikaze</a> <a href='/de/UnitIndex.aspx'>Einheiten</a> für Suizid-Attacken. Da sie nach dem Angreifen ungeschützt sind und ihre Verteidigung unbedeutend ist, kann jede Art von Einheit eine grosse Menge von <a class='kamikaze' href='/de/Unit/Kamikaze.aspx'>Kamikaze</a> Einheiten zerstören.
  Aufgrund ihrer schwachen Verteidigung, müssen die <a class='kamikaze' href='/de/Unit/Kamikaze.aspx'>Kamikaze</a> sehr gut durch andere Einheiten beschützt werden weil jede Attacke wenn auch indirekt
  (z.B: <a href='/de/Battles/Rebound.aspx'>Rückprall</a>, <a href='/de/Battles/TripleAttack.aspx'>Dreifach-Attacke</a>), eine grosse Anzahl von <a class='kamikaze' href='/de/Unit/Kamikaze.aspx'>Kamikaze</a> zerstören kann.</p>
	</div>
	...
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Herrschafts Hangar</a> Level 5</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>300 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li><li>450 <a href='../Intrinsic/Uranium.aspx'>Uranium</a></li><li>63 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Stunde </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
