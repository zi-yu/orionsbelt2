...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Dunkler Regen" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darkrain.png' alt='Dunkler Regen' />
		Die <a class='darkrain' href='/de/Unit/DarkRain.aspx'>Dunkler Regen</a> is die Basiseinheit der <a href='/de/Race/DarkHumans.aspx'>Renegades</a> und die erste Einheit die für die Konstruktion zur Verfügung steht, wenn der <a class='dominationyard' href='/de/Facility/DominationYard.aspx'>Herrschafts Hangar</a> noch auf Level 1 ist. <p>
  Diese Einheit hat zwar eine kleine Vertedigungsstärke ist aber eine gute <a href='/de/Battles/DispensableUnits.aspx'>Kanonenfutter</a> Einheit, weil sie <a href='/de/Battles/Movement.aspx#MovAll'>Totale Beweglichkeit</a> mit <a href='/de/Battles/Movement.aspx#MovCost'>Bewegungs-Kost</a> 1 hat. Sie ist auch günstig und schnell in der Konstruktion. </p><p>
  Der Angriffsbonus gegen <a href='/de/Battles/Heavy.aspx'>Schwer</a> Einheiten ist auch sehr wichtig, und stellt sie auf dem Level einer <a href='/de/Battles/Medium.aspx'>Medium</a> wenn sie die <a href='/de/Battles/Heavy.aspx'>Schwer</a> Einheiten attackiert.</p>
	</div>
	...
	<h3>Einheiten Bonus</h3><table class='table'><tr><th>Ziel</th><th>Angriff</th><th>Verteidigung</th><th>Reichweite</th></tr><tr><td>Schwer</td><td>600</td><td>0</td><td>0</td></tr></table>
	
	<h2>Information über die Konstruktion</h2>
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Herrschafts Hangar</a> Level 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Gold.aspx'>Gold</a></li><li>175 <a href='../Intrinsic/Titanium.aspx'>Titanium</a></li></ul></td><td class='duration'>10 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
