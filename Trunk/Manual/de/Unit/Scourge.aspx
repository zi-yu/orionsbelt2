...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Scourge" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/scourge.png' alt='Scourge' />
		Der <a class='scourge' href='/de/Unit/Scourge.aspx'>Scourge</a> ist eine <a href='/de/Race/Mercs.aspx'>Mercs</a> <a href='/de/Battles/Medium.aspx'>Medium</a> Einheit. Es ist die typische medium Einheit mit <a href='/de/Battles/Movement.aspx#MovCost'>Bewegungs-Kost</a> von 2 und einer <a href='/de/Battles/Range.aspx'>Reichweite</a> von 3. Aber es hat auch einen
  <a href='/de/Battles/Rebound.aspx'>Rückprall</a>, das bedeut dass der <a class='scourge' href='/de/Unit/Scourge.aspx'>Scourge</a> eine <a href='/de/Battles/Range.aspx'>Reichweite</a> von bis zu 4 erlangen kann.
  <p>
  Und es hat auch eine gute Verteidigung und Angriff, der einzige Nachteil ist die diagonale 
  Bewegung.</p>
	</div>
