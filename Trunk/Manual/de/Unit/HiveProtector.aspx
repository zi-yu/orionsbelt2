...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bienenstock Beschützer Einheit
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bienenstock Beschützer" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/hiveprotector.png' alt='Bienenstock Beschützer' />
		Der <a class='hiveprotector' href='/de/Unit/HiveProtector.aspx'>Bienenstock Beschützer</a> is die meistdefensive Einheit die den <a href='/de/Race/Bugs.aspx'>Levyr</a> zur Verfügung steht. Es hat einige Ähnlichkeiten mit
  <a href='/de/Race/LightHumans.aspx'>Utopians</a> <a class='pretorian' href='/de/Unit/Pretorian.aspx'>Praetorian</a>, weil es sehr starke Verteidigung hat, und eine schwache Attacke. Auch wenn 
  es nicht soviel Verteidigung hat wie ein <a class='pretorian' href='/de/Unit/Pretorian.aspx'>Praetorian</a>, hat es eine Menge mehr Angriff, und macht den <a class='hiveprotector' href='/de/Unit/HiveProtector.aspx'>Bienenstock Beschützer</a> vielseitiger. Auf der anderen Seite, <a href='/de/Battles/Movement.aspx#MovNormal'>Normale Bewegung</a> is nicht so gut in der Verteidigung wie andere <a href='/de/UnitIndex.aspx'>Kampf-Einheiten</a>.
  <p>
  Im Grossen und Ganzen, ist der <a class='hiveprotector' href='/de/Unit/HiveProtector.aspx'>Bienenstock Beschützer</a> eine Einheit mit hoher Resistenz und guter Attacke. Und vergiss nicht die Fähigkeit des <a href='/de/Battles/StrikeBack.aspx'>Gegenangriff</a>.</p>
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Bewegung</td>
			<td><a href='/de/Battles/Movement.aspx#MovNormal'>Normale Bewegung</a></td>
		</tr>
	</table>
	...
	<table class='table'><tr><th>Abhängigkeiten</th><th>Kosten</th><th>Dauer</th><th>Wenn es fertig ist</th><th>Freigeben</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Inkubator</a> Level 5</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>200 <a href='../Intrinsic/Elk.aspx'>Nahrung</a></li><li>175 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>125 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>50 Minuten </td><td><ul><li>Einheiten bewegen zur Verteidigungsflotte</li></ul></td><td><ul></ul></td></tr></table>
