...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze fünf Planeten Level 1 in der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze fünf Planeten Level 1 in der öffentlichen Zone" runat="server" /></h1>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +240</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +6</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +100</li></ul>
	</div>
