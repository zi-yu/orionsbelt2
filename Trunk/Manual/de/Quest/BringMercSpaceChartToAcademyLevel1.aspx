...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring eine Merc Weltraumkarte zu einer Level 1 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring eine Merc Weltraumkarte zu einer Level 1 Akademie" runat="server" /></h1>
	
	<div class="description">
		Mercs haben die besten Weltraum-Karten im Universum. Wir möchten dass du eine von diesen Karten von einer Merc Flotte erwirbst. Wenn du eine erworben hast, bringe sie zu einer Level 1 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +3500</li><li><a class='sentry' href='/de/Unit/Sentry.aspx'>Sentry</a> : +50</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +2500</li></ul>
	</div>
