...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Sentry Merc Wracks zu einer Level 3 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Sentry Merc Wracks zu einer Level 3 Akademie" runat="server" /></h1>
	
	<div class="description">
		Sentry Merc Flotten besitzen gewisse Komponenten die nützlich sind. Bring diese Komponenten zu einer Level 3 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +1000</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +3500</li></ul>
	</div>
