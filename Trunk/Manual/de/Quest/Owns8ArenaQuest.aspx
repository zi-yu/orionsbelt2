...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Werde zum Champion von 8 Arenen zur gleichen Zeit
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Werde zum Champion von 8 Arenen zur gleichen Zeit" runat="server" /></h1>
	
	<div class="description">
		Erforsche das <a href='/de/Universe/Default.aspx'>Universum</a>, finde <a href='/de/Universe/Arenas.aspx'>Arenen</a> und werde zum unumstrittenen Champion in mindestens 8 Arenen.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li><a href='/de/GladiatorQuests.aspx'>Gladiator</a> : +80</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +8000</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +8000</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +8000</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +8000</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +8000</li></ul>
	</div>
