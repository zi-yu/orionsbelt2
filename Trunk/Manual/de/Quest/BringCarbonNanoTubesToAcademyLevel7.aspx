...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Karbon Nanorohre zu einer Level 7 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Karbon Nanorohre zu einer Level 7 Akademie" runat="server" /></h1>
	
	<div class="description">
		Tech Mercs benutzen ein neues Material um die Aussehülle ihrer Einheiten zu verstärken. Bring 3 Proben von Carbon Nano-Röhren zu einer Level 7 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +10500</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +5500</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +5500</li></ul>
	</div>
