...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bezitze fünf Planeten Level 7 in der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bezitze fünf Planeten Level 7 in der öffentlichen Zone" runat="server" /></h1>
	
	<div class="description">
		Besitze fünf Planeten Level 7 in der öffentlichen Zone
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +2160</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +62</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +500</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +800</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +1000</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +700</li></ul>
	</div>
