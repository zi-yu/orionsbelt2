...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Rüste all die Hauptgebäude auf, auf deinen privaten Planeten Level 7
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Rüste all die Hauptgebäude auf, auf deinen privaten Planeten Level 7" runat="server" /></h1>
	
	<div class="description">
		Rüste deine Hauptgebäude auf, auf deinen privaten Planeten Level 7
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +7000</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +70</li></ul>
	</div>
