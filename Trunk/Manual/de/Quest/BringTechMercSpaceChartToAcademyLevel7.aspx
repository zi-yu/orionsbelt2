...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring zu einer Level 7 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring zu einer Level 7 Akademie" runat="server" /></h1>
	
	<div class="description">
		Mercs haben eine der besten Weltraum-Karten im Universum.Ich muss eine dieser Karten von einer Tech Mercs Flotte erwerben. Wenn du eine erworben hast, bringe sie zu einer Level 7 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +11500</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +5500</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +5500</li></ul>
	</div>
