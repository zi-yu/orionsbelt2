...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze ein Extraktor Level 5 auf einem Planeten der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze ein Extraktor Level 5 auf einem Planeten der öffentlichen Zone" runat="server" /></h1>
	
	<div class="description">
		Besitze ein Extractor Level 5  auf einen Planeten der öffentlichen Zone
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +5000</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +50</li></ul>
	</div>
