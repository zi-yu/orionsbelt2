...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring die Liste der Kriminellen Alpha zu der Bucht der Piraten Level 1
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring die Liste der Kriminellen Alpha zu der Bucht der Piraten Level 1" runat="server" /></h1>
	
	<div class="description">
		Die Alpha Force hat eine Liste der meistgesuchten Kriminellen in der Level 1 Zone. Wir wollen dass du diese Liste findest und zu einer Bucht der Piraten Level 1 bringst.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +2500</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +2500</li></ul>
	</div>
