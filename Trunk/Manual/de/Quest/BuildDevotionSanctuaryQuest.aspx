...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Baue eine Zufluchtsstätte der Hingabe auf deinem Heimatplaneten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Baue eine Zufluchtsstätte der Hingabe auf deinem Heimatplaneten" runat="server" /></h1>
	
	<div class="description">
		Baue eine Devotion Sanctuary auf deinen Heimatplaneten
	</div>
