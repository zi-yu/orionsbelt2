...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Primär-Tafeln zu einer Level 1 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Primär-Tafeln zu einer Level 1 Akademie" runat="server" /></h1>
	
	<div class="description">
		Primäre Tafeln beinhalten detaillierte Information über die Merc Operationen. Ich möchte dass du mir 2 Primäre Tafel bringst zu einer Level 1 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +1000</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +2500</li></ul>
	</div>
