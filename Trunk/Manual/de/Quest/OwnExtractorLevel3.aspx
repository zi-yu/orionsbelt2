...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze ein Level 3 Extraktor auf einem Planeten der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze ein Level 3 Extraktor auf einem Planeten der öffentlichen Zone" runat="server" /></h1>
	
	<div class="description">
		Besitze einen Extraktor Level 3 in der öffentlichen Zone
	</div>
