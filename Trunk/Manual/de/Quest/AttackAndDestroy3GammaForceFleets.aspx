...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Attackiere und zerstöre 3 Gamma Force Flotten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Attackiere und zerstöre 3 Gamma Force Flotten" runat="server" /></h1>
	
	<div class="description">
		Gamma Force Flotten sind gesichtet worden in der Level 5 Zone. Finde sie und zerstöre 3 Flotten.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +9000</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +3000</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +3000</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +3000</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +3000</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +3000</li></ul>
	</div>
