...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Sub-Licht Motoren zur Bucht der Piraten Level 5
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Sub-Licht Motoren zur Bucht der Piraten Level 5" runat="server" /></h1>
	
	<div class="description">
		Space Force entwickelt gerade eine neue Technologie die wir haben müssen. Diese Technologie ist in jeder Gamma Force Flotte integriert. Bring 5 Sub-Licht Motoren zu einer Bucht der Piraten Level 5.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +7000</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +4500</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +4500</li></ul>
	</div>
