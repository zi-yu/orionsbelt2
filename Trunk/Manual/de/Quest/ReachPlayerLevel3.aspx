...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Rüste all die Hauptgebäude auf, auf deinen privaten Planeten Level 3
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Rüste all die Hauptgebäude auf, auf deinen privaten Planeten Level 3" runat="server" /></h1>
	
	<div class="description">
		Rüste alle Hauptgebäude auf deinen privaten Planeten auf Level 3 hoch
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +3000</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +30</li></ul>
	</div>
