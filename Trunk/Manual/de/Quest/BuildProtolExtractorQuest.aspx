...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Baue einen Protol Extraktor auf deinem Heimatplaneten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Baue einen Protol Extraktor auf deinem Heimatplaneten" runat="server" /></h1>
	
	<div class="description">
		Baue einen Protol Extraktor auf deinen Heimatplaneten
	</div>
