...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Quecksilber und Diamanten zu einem Level 10 Markt
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Quecksilber und Diamanten zu einem Level 10 Markt" runat="server" /></h1>
	
	<div class="description">
		Bring eine Flotte sowohl mit Quecksilber als auch and Diamanten zu einem Level 10 Markt
	</div>
