...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze ein Planet Level 7 in der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze ein Planet Level 7 in der öffentlichen Zone" runat="server" /></h1>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +2000</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +57</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +500</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +400</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +800</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +800</li></ul>
	</div>
