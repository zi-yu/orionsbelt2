...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Tech Mercs Wracks zu einer Level 7 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Tech Mercs Wracks zu einer Level 7 Akademie" runat="server" /></h1>
	
	<div class="description">
		Teck Merc Flotten haben technologisch fortgeschrittene Einheiten. Ich brauch einige Komponenten aus diesen Einheiten. Bring diese Komponeneten zu einer Level 7 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +9500</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +5500</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +5500</li></ul>
	</div>
