...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Attackiere und zerstöre 3 Black Merc Flotten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Attackiere und zerstöre 3 Black Merc Flotten" runat="server" /></h1>
	
	<div class="description">
		Black Mercs Flotten sind gesichtet worden in der Level 9 Zone. Finde sie und zerstöre 3 Flotten.
	</div>
