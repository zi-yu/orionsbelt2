...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring die Liste der Kriminellen Gamma zur Bucht der Piraten Level 5
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring die Liste der Kriminellen Gamma zur Bucht der Piraten Level 5" runat="server" /></h1>
	
	<div class="description">
		Die Gamma Force hat eine Liste der meistgesuchten Kriminellen in der Level 5 Zone. Wir wollen dass du diese Liste findest und zu einer Bucht der Piraten Level 5 bringst.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +8500</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +4500</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +4500</li></ul>
	</div>
