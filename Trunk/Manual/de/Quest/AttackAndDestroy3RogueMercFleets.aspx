...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Attackiere und zerstöre 3 Rogue Merc Flotten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Attackiere und zerstöre 3 Rogue Merc Flotten" runat="server" /></h1>
	
	<div class="description">
		Rogue Mercs Flotten sind gesichtet worden in der Level 5 Zone. Finde sie und zerstöre 3 Flotten.
	</div>
