...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring ein Kommunikationsfeld zur Bucht der Piraten Level 5
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring ein Kommunikationsfeld zur Bucht der Piraten Level 5" runat="server" /></h1>
	
	<div class="description">
		Space Force wird immer stärker im Universum und wir müssen ihre Kommunikationen abhören. Bring zu irgendeiner Bucht der Piraten Level 5 ein Kommunikations-Array. Du kannst diese in jeder Gamma Force Flotte finden.
	</div>
