...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze acht Planeten Level 5 in der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze acht Planeten Level 5 in der öffentlichen Zone" runat="server" /></h1>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +1320</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +37</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +800</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +400</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +700</li></ul>
	</div>
