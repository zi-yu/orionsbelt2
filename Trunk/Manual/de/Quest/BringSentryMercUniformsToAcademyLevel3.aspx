...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Sentry Merc Uniformen zu einer Level 3 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Sentry Merc Uniformen zu einer Level 3 Akademie" runat="server" /></h1>
	
	<div class="description">
		Ich muss eine Sentry Mercs Flotte infiltrieren und dafür brauche ich gewisse Sachen. 10 Sentry Mercs Uniforme um genau zu sein. Bringe sie zu einer Level 3 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +3500</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +3500</li></ul>
	</div>
