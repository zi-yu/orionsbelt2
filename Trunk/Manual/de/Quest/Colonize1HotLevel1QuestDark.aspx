...
<asp:Content ContentPlaceHolderID="content" runat="server">
  ...
  <a href="../Facility/Extractor.aspx">Extractors</a>.</p>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li><a href='/de/Commerce/Orions.aspx'>Orions</a> : +50</li><li>Spielstand : +80</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +2</li><li><a class='darkrain' href='/de/Unit/DarkRain.aspx'>Dunkler Regen</a> : +3</li></ul>
	</div>
