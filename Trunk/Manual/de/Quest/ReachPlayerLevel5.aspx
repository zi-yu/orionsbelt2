...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Rüste all deine Hauptgebäude auf, auf deinen privaten Planeten Level 5
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Rüste all deine Hauptgebäude auf, auf deinen privaten Planeten Level 5" runat="server" /></h1>
	
	<div class="description">
		Rüste alle Hauptgebäude auf deinen privaten Planeten auf Level 5 hoch
	</div>
