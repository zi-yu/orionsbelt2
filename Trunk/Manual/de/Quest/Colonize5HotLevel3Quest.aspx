...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze fünf Planeten Level 3 in der öffentlichen Zone.
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze fünf Planeten Level 3 in der öffentlichen Zone." runat="server" /></h1>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +560</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +16</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +400</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +200</li></ul>
	</div>
