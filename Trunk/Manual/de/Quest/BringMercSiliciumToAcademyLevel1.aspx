...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Silicium zu einer Level 1 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Silicium zu einer Level 1 Akademie" runat="server" /></h1>
	
	<div class="description">
		Merc Flotten transportieren normalerweise ein Element das leicht zerstörbar ist, das Silicium. Bring 2 Proben von diesem Element zu einer Level 1 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +2500</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +2500</li></ul>
	</div>
