...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Attackiere und zerstöre 3 Sentry Merc Flotten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Attackiere und zerstöre 3 Sentry Merc Flotten" runat="server" /></h1>
	
	<div class="description">
		Sentry Merc Flotten sind gesichtet worden in der Level 3 Zone. Finde sie und zerstöre 3 Flotten.
	</div>
