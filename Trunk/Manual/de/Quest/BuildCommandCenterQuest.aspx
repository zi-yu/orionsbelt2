...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Rüste die Kommando-Zentral auf, auf deinem Heimatplaneten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Rüste die Kommando-Zentral auf, auf deinem Heimatplaneten" runat="server" /></h1>
	
	<div class="description">
		Rüste die Kommando-Zentrale auf deinen Heimatplaneten auf
	</div>
