...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Motoren der Lichtgeschwindigkeit zur Bucht der Piraten Level 10
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Motoren der Lichtgeschwindigkeit zur Bucht der Piraten Level 10" runat="server" /></h1>
	
	<div class="description">
		Die Motoren der Lichtgeschwindigkeit erlauben der Space Force Flotten to travel fast unverzüglich durch das Universum zu reisen. Wir müssen diese Motoren haben. Plündere Omega Force Flotten und bring 3 Lichtgeschwindigskeiten-Motoren zu einer Bucht der Piraten Level 10.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +16000</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +8000</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +8000</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +8000</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +8000</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +8000</li></ul>
	</div>
