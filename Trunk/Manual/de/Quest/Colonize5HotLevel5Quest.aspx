...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze fünf Planeten Level 5 in der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze fünf Planeten Level 5 in der öffentlichen Zone" runat="server" /></h1>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +1200</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +34</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +800</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +500</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +300</li></ul>
	</div>
