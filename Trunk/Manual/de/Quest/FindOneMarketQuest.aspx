...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Finde einen Markt in der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Finde einen Markt in der öffentlichen Zone" runat="server" /></h1>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li><a href='/de/Commerce/Orions.aspx'>Orions</a> : +50</li><li>Spielstand : +1000</li><li><a href='/de/MerchantQuests.aspx'>Händler</a> : +10</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +200</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +200</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +200</li></ul>
	</div>
