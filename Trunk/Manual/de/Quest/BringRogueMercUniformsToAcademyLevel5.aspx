...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Rogue Merc Uniformen zu einer Level 5 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Rogue Merc Uniformen zu einer Level 5 Akademie" runat="server" /></h1>
	
	<div class="description">
		Ich muss eine Rogue Mercs Flotte infiltrieren und dafür brauche ich gewisse Sachen. 10 Rogue Mercs Uniforme um genau zu sein. Bringe sie zu einer Level 5 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +8000</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +4500</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +4500</li></ul>
	</div>
