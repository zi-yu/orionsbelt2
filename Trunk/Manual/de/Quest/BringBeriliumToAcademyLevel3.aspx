...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Berilium zu einer Level 3 Akademie
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Berilium zu einer Level 3 Akademie" runat="server" /></h1>
	
	<div class="description">
		Sentry Merc Flotten benutzen ein sehr seltenes Element das ihre Einheiten stärkt, das Berilium. Bringe 3 Proben von diesem Element zu einer Level 3 Akademie.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +2500</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +3500</li></ul>
	</div>
