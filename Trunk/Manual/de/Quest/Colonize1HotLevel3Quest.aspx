...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Besitze ein Planet Level 3 in der öffentlichen Zone
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Besitze ein Planet Level 3 in der öffentlichen Zone" runat="server" /></h1>
	...
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +400</li><li><a href='/de/ColonizerQuests.aspx'>Siedler</a> : +11</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +300</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +300</li></ul>
	</div>
