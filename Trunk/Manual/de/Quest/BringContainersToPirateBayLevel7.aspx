...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Bring Container zur Bucht der Piraten Level 7
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bring Container zur Bucht der Piraten Level 7" runat="server" /></h1>
	
	<div class="description">
		Delta Force haben spezielle Positronen- undd Antimaterie-Containerdie wir haben müssen. Bring 5 Positronen- und 4 Antimaterie-Container zu einer Bucht der Piraten Level 7 und du wirst eine gute Belohnung erhalten.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +10000</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +5500</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +5500</li></ul>
	</div>
