...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Attackiere und zerstöre 3 Delta Force Flotten
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Attackiere und zerstöre 3 Delta Force Flotten" runat="server" /></h1>
	
	<div class="description">
		Delta Force Flotten sind gesichtet worden in der Level 7 Zone. Finde sie und zerstöre 3 Flotten.
	</div>
	
	<h2>Belohnung</h2>
	<div class="description">
		<ul><li>Spielstand : +12000</li><li><a class='astatine' href='/de/Intrinsic/Astatine.aspx'>Astatine</a> : +4000</li><li><a class='radon' href='/de/Intrinsic/Radon.aspx'>Radon</a> : +4000</li><li><a class='prismal' href='/de/Intrinsic/Prismal.aspx'>Prismal</a> : +4000</li><li><a class='argon' href='/de/Intrinsic/Argon.aspx'>Argon</a> : +4000</li><li><a class='cryptium' href='/de/Intrinsic/Cryptium.aspx'>Cryptium</a> : +4000</li></ul>
	</div>
