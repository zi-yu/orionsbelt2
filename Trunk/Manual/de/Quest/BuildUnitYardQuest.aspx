...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Baue eine Einheiten-Fabrik auf deinem Heimatplaneten, die es dir erlauben wird Kampfeinheiten zu bilden.
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Baue eine Einheiten-Fabrik auf deinem Heimatplaneten, die es dir erlauben wird Kampfeinheiten zu bilden." runat="server" /></h1>
	
	<div class="description">
		Baue einen Unit Yard auf deinen Heimatplaneten, der dir erlaubt Kampfeinheiten zu bauen
	</div>
