...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1>Königsmord</h1>
	<div class="content">
    <a href='/de/Battles/Regicide.aspx'>Königsmord</a> ist ein Schlachten-Typ auf dem <a href='/de/Battles/GameBoard.aspx'>Spielbrett</a> dessen Ziel ist die Zerstörung der <a class='flag' href='/de/Unit/Flag.aspx'>Flagge</a> 
    des Feindes zu zerstören. Es ist ähnlich wie Schach, die <a class='flag' href='/de/Unit/Flag.aspx'>Flagge</a> ist wie der König.
  </div>
