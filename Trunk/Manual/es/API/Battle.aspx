...
<asp:Content ContentPlaceHolderID="conceptMenu" runat="server">
	<h2>API and Utilities</h2><ul><li><a href='/es/API/Battle.aspx'>Battle API</a></li><li><a href='/es/API/UniverseXML.aspx'>Universe XML</a></li><li><a href='/es/API/UnitsJSON.aspx'>Units Specification</a></li><li><a href='/es/API/Utilities.aspx'>Utilities from the Orion's Belt Community</a></li></ul>
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1>Battle API</h1>
	<div class="content">
    The <b>Battle API</b> allows third party applications to play battles on <a href='http://www.orionsbelt.eu'>Orion's Belt</a> as a <i>bot</i>. You may use this API to create artificial
    intelligence bots or game clients that'll be able to battle with other players or bots on the <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a>. Example of a battle:
    ...
    The Battle API is very simple to use. You may create an application that will comunicate with <a href='http://www.orionsbelt.eu'>Orion's Belt</a> and send/receive moves and battle states.
    ...
    be able to create a <a href='/es/Battles/Friendly.aspx'>Amistoso</a> with it and try your bot in action.

    <a name="AskBattles" id="AskBattles"></a><h2>Ask For Battles</h2>
    The first time you ask for battles, you won't get any. You'll have to create a <a href='/es/Battles/Friendly.aspx'>Amistoso</a> with your bot, and only then you'll get some battles
    ...
    The first part of the battle is the <a href='/es/Battles/Deploy.aspx'>Posicionar</a>. When you request battles using the previous URL you'll receive something like:
    <pre class="code">
  &lt;Battles&gt;
  ...
  &lt;/Battles&gt;
    ...
    This is a very simple battle between <u>Bot001</u> and <u>nunos</u>, and you'd have to deploy now. The combat <a href='/es/Universe/Fleet.aspx'>Flota</a> only has the <a class='raptor' href='/es/Unit/Raptor.aspx'>Raptor</a>, no more <a href='/es/UnitIndex.aspx'>Unidades de Combate</a>
    are present. You'd now have to make a request to <u>ResponseUrl</u> indicating how you'd like to <a href='/es/Battles/Deploy.aspx'>Posicionar</a>:
  ...
  &lt;/Battles&gt;
    ...
    Note that the state changed from <u>deploy</u> to <u>battle</u>. Now you receive the current <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a> disposition, each unit group, quantity, coordinate, etc.
    ...
    Then it's your opponents turn to play. When he's done, you'll receive the new <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a> state and you have to make more moves. This continues until
    the battle isn't finished. Note that your movements can't spend more than 6 <a href='/es/Battles/Movement.aspx#MovPoints'>Puntos de Movimiento</a>.
