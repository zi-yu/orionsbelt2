...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Perforador" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/driller.png' alt='Perforador' />
		Esta es una unidad que debido a sus características se puede transformar en imensamente útil o inútil en el campo de  batalla, dependiendo
  de la forma de como se desarrolla el combate.<p />
  La principal fuerza del <a class='driller' href='/es/Unit/Driller.aspx'>Perforador</a> es el <a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a> que es una  excelente forma  de destruir <a href='/es/UnitIndex.aspx'>Unidades</a> que esten sirviendo de <a href='/es/Battles/DispensableUnits.aspx'>Carne de Cañon</a>.
  Este ataque también es útil cuando se pretende alcanzar <a href='/es/UnitIndex.aspx'>Unidades</a> que esten aparentemente fuera de <a href='/es/Battles/Range.aspx'>Alcance</a>, pués atacando una unidad
  las unidades que estén a su lado también van a sufrir daño.<p />
  El problema de los <a class='driller' href='/es/Unit/Driller.aspx'>Perforador</a> es cuando no están en el centro de la acción, pués tienen <a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> de 2 y <a href='/es/Battles/Range.aspx'>Alcance</a> de solo 1.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li><a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a></li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 3</li></ul></td><td><ul><li>425 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>500 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li></ul></td><td class='duration'>40 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
