...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		El <a class='interceptor' href='/es/Unit/Interceptor.aspx'>Interceptador</a> es de las <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> mas peculiares, en la medida en que sus habilidades pueden ser muy efectivas 
  en el <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a>, como pueden  pasar completamente desapercibidas en una batalla. Se hace necesario planear bien el uso de <a class='interceptor' href='/es/Unit/Interceptor.aspx'>Interceptador</a>
  para tirar el mejor  partido de él.
  <p />
  El <a class='interceptor' href='/es/Unit/Interceptor.aspx'>Interceptador</a> es una unidad de <a href='/es/Battles/Light.aspx'>Pequeño Porte</a> con un gran poder: <a href='/es/Battles/ParalyseAttack.aspx'>Ataque Paralizador</a>. Con su rapidez logra fácilmente
  paralizar <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> mas poderosas. Sin embargo tiene una gran desvantaja: Más alla de tener solamente solamente 1 de <a href='/es/Battles/Range.aspx'>Alcance</a>,
  tener <a href='/es/Battles/Movement.aspx#MovDiagonal'>Movimiento Diagonal</a> limita seriamente una unidad de <a href='/es/Battles/Light.aspx'>Pequeño Porte</a> en la medida en que ya no puede ser usada fácilmente como <a href='/es/Battles/DispensableUnits.aspx'>Carne de Cañon</a>.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 2</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Comida</a></li></ul></td><td class='duration'>10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
