...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Es probablemente una de las mejores unidades de <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> del juego. El <a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> de 3 permite al jugador moverse, atacar y defender, todo esto
   en un mismo turno.
   <p />
   Posee <a href='/es/Battles/Movement.aspx#MovNormal'>Movimiento Normal</a> que es muy bueno para una unidad <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> ya que controla mas cuadriculas si estuviera correctamente colocada. Su ataque especial de 
   <a href='/es/Battles/Rebound.aspx'>Rebote</a> transforma esta unidad en una unidad muy fuerte ya que virtualmente gana 5 de alcance (puede destruir la unidad blanco y las unidad
   que está atrás de esta en un mismo turno). 
   Su ataque de 2500 es suficiente para dañar mucho a las unidades enemigas.
   <p />
   A pesar de ser una unidad que sólo está disponible en una faze avanzada del juego (<a class='unityard' href='/es/Facility/UnitYard.aspx'>Puerto Espacial</a> nivel 9), es una unidad  <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> que todos los jugadores deberían tener en sus 
   flotas.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Movimiento</td>
			<td><a href='/es/Battles/Movement.aspx#MovNormal'>Movimiento Normal</a></td>
		</tr>
	</table>
	
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li><a href='/es/Battles/Rebound.aspx'>Rebote</a></li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Puerto Espacial</a> Nivel 9</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Energy.aspx'>Energía</a></li><li>500 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>600 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>400 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>200 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>1 Hora 40 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
