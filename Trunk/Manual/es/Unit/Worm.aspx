...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Gusano" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/worm.png' alt='Gusano' />
		El <a class='worm' href='/es/Unit/Worm.aspx'>Gusano</a> es la unidad de <a href='/es/Battles/Medium.aspx'>Médio Porte</a> mas simple de los <a href='/es/Race/Bugs.aspx'>Levyr</a>. Tiene un ataque y una defenza equilibrada, pero
  bajo de la media . Pero con <a href='/es/Battles/Movement.aspx#MovAll'>Movimiento Total</a> y  costo de movimiento 2, tiene  una capacidad de movimiento encima de la
  para unidades de <a href='/es/Battles/Medium.aspx'>Médio Porte</a>.
  <p />
  Es una unidad versátil que puede ser muy importante en una <a href='/es/Universe/Fleet.aspx'>Flota</a> de <a href='/es/Race/Bugs.aspx'>Levyr</a>, pués puede tanto ayudar a defender
  como dar un buen daño en la <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> adversárias.
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 3</li></ul></td><td><ul><li>375 <a href='../Intrinsic/Elk.aspx'>Comida</a></li><li>450 <a href='../Intrinsic/Protol.aspx'>Protol</a></li></ul></td><td class='duration'>30 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
