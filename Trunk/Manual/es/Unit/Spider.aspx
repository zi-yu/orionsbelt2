...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Araña" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/spider.png' alt='Araña' />
		El <a class='spider' href='/es/Unit/Spider.aspx'>Araña</a> es la unidad de combate mas equilibrada de los <a href='/es/Race/Bugs.aspx'>Levyr</a>. Tiene muy buen ataque y defenza, además de buen movimiento,
  y doss habilidades muy importantes:
  <a href='/es/Battles/ParalyseAttack.aspx'>Ataque Paralizador</a> y <a href='/es/Battles/StrikeBack.aspx'>Contraataque</a>. El conjunto de estas dos habilidades hace  que cualquier unidad que ataque una    <a class='spider' href='/es/Unit/Spider.aspx'>Araña</a> de frente, si no la destruye,
  quede paralizada.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li>[ParalyseAttack]</li></ul></td></tr><tr><td>Habilidades Post-Defensa</td><td><ul><li><a href='/es/Battles/StrikeBack.aspx'>Contraataque</a></li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 7</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>300 <a href='../Intrinsic/Elk.aspx'>Comida</a></li><li>225 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>125 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Hora 10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
