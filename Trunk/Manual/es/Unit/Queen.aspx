...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Reina" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/queen.png' alt='Reina' />
		La <a class='queen' href='/es/Unit/Queen.aspx'>Reina</a> es la unidad <a href='/es/Battles/Ultimate.aspx'>Suprema</a> de los <a href='/es/Race/Bugs.aspx'>Levyr</a>. Es una unidad diferente de las outras en la medida en que queda
  fuera del  <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a> durante la batalla. Aún así es  capaz de atacar y ser  atacada. Sin embargo su principal
  característica es colocar un <a class='egg' href='/es/Unit/Egg.aspx'>Huevo</a> en el <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a> durante la batalla, de donde sale la <a class='maggot' href='/es/Unit/Maggot.aspx'>Larva</a>.
  <p />
  La cantidad de <a class='maggot' href='/es/Unit/Maggot.aspx'>Larva</a> que es generada varía conforme al número de <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> presentes en aquel momento
  en la <a href='/es/Universe/Fleet.aspx'>Flota</a>. Nota también que en el final de la batalla las unidadades <a class='maggot' href='/es/Unit/Maggot.aspx'>Larva</a> son destruídas.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Razas</td>
			<td><a href='/es/Race/Bugs.aspx'>Levyr</a></td>
		</tr>
		<tr>
			<td>Categoría</td>
			<td><a href='/es/Battles/Ultimate.aspx'>Suprema</a></td>
		</tr>
		<tr>
			<td>Posición</td>
			<td>Aire</td>
		...
		<tr>
			<td>Movimiento</td>
			<td><a href='/es/Battles/Movement.aspx#MovDrop'>Movimento Paracaidas</a></td>
		</tr>
	</table>
	
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Defensa</td><td><ul><li><a href='/es/Battles/StrikeBack.aspx'>Contraataque</a></li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/QueenHatchery.aspx'>Encubadora de Reinas</a> Nivel 1</li></ul></td><td><ul><li>21750 <a href='../Intrinsic/Elk.aspx'>Comida</a></li><li>22250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>2250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>6875 <a href='../Intrinsic/Radon.aspx'>Radon</a></li><li>7250 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>6125 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li><li>8625 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>No puedes tener mas unidades supremas que edificios constructores de unidades supremas</li></ul></td><td class='duration'>16 Horas 40 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
