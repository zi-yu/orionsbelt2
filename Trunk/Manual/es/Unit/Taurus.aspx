...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Toro" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/taurus.png' alt='Toro' />
		Esta unidad es una pequeña fortaleza a moviendose por el <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a>, casi indestructible y con un  inmenso poder de ataque.<p />
   Los puntos débiles del <a class='taurus' href='/es/Unit/Taurus.aspx'>Toro</a> son un <a href='/es/Battles/Range.aspx'>Alcance</a> corto para una unidade de <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> y el echo de tener solo <a href='/es/Battles/Movement.aspx#MovFront'>Movimiento Frontal</a>, pero cuando son
   colocadas en el centro de la batalla es una unidad extremadamente útil.<p />
   Mas alla del enorme poder, el <a class='taurus' href='/es/Unit/Taurus.aspx'>Toro</a> aún  tiene dos poderes especiales que amplifican su poder destructivo, el <a href='/es/Battles/Rebound.aspx'>Rebote</a> y el
   <a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a>, que en el extremo podem provocar la destruicción de <a href='/es/UnitIndex.aspx'>Unidades</a> enemigas en 4 posiciones diferentes sólo con un disparo.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li><a href='/es/Battles/Rebound.aspx'>Rebote</a></li><li><a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a></li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Puerto Espacial</a> Nivel 10</li></ul></td><td><ul><li>500 <a href='../Intrinsic/Energy.aspx'>Energía</a></li><li>625 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>750 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>450 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>225 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Hora 30 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
