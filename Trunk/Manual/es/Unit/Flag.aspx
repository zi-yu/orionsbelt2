...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Bandera" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/flag.png' alt='Bandera' />
		La <a class='flag' href='/es/Unit/Flag.aspx'>Bandera</a> es una unidad <a href='/es/Battles/Special.aspx'>Especial</a> que sólo es usada en los torneos de <a href='/es/Battles/Regicide.aspx'>Regicidio</a>. En estas batallas, el primer jugador
  en destruir la <a class='flag' href='/es/Unit/Flag.aspx'>Bandera</a> adversária, gana el jogo.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Categoría</td>
			<td><a href='/es/Battles/Special.aspx'>Especial</a></td>
		</tr>
		<tr>
			<td>Posición</td>
			<td>Aire</td>
