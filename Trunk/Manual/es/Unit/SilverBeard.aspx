...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		<a class='silverbeard' href='/es/Unit/SilverBeard.aspx'>Silver Beard</a> is the second in command on the <a href='/es/Race/Mercs.aspx'>Mercs</a> faction. This unit's power is only matched by the mighty <a class='metallicbeard' href='/es/Unit/MetallicBeard.aspx'>Barba de Metal</a>. <a class='silverbeard' href='/es/Unit/SilverBeard.aspx'>Silver Beard</a>
  has a long <a href='/es/Battles/Range.aspx'>Alcance</a> and a set of very powerful devastating abilities: <a href='/es/Battles/Catapult.aspx'>Catapulta</a>, <a href='/es/Battles/Rebound.aspx'>Rebote</a> and <a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a>. 
  <p />
  This makes the <a class='silverbeard' href='/es/Unit/SilverBeard.aspx'>Silver Beard</a> a menace on the <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a>.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades de Ataque</td><td><a href='/es/Battles/Catapult.aspx'>Catapulta</a></td></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li><a href='/es/Battles/Rebound.aspx'>Rebote</a></li><li><a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a></li></ul></td></tr></table>
