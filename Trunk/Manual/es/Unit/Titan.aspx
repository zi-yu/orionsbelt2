...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Very powerfull <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> from <a href='/es/Race/Mercs.aspx'>Mercs</a> unit with long <a href='/es/Battles/Range.aspx'>Alcance</a>. The <a class='titan' href='/es/Unit/Titan.aspx'>Titan</a> is also very resistant, and has <a href='/es/Battles/StrikeBack.aspx'>Contraataque</a> that makes it very good
    also on defense.
    <p />
    And with a <a href='/es/Battles/Range.aspx'>Alcance</a> of 5, it's perfect for a <a href='/es/Battles/FiringSquad.aspx'>Pelotón de Fusilamiento</a>.
	</div>
