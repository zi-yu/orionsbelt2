...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Destructor" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/destroyer.png' alt='Destructor' />
		El <a class='destroyer' href='/es/Unit/Destroyer.aspx'>Destructor</a> es una unidad muy poderosa. A pesar de tener limitaciones de movimiento y <a href='/es/Battles/Range.aspx'>Alcance</a>, tiene  uno de los ataques
  mas poderosos del juego: el <a href='/es/Battles/BombAttack.aspx'>Ataque Bomba</a>.
  <p />
  Con el <a href='/es/Battles/BombAttack.aspx'>Ataque Bomba</a>, el <a class='destroyer' href='/es/Unit/Destroyer.aspx'>Destructor</a> hace daño a todas las <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> que estén cerca de su ataque.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li><a href='/es/Battles/BombAttack.aspx'>Ataque Bomba</a></li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 6</li></ul></td><td><ul><li>200 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>250 <a href='../Intrinsic/Elk.aspx'>Comida</a></li><li>100 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>70 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Hora 10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
