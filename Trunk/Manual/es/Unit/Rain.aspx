...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Lluvia" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/rain.png' alt='Lluvia' />
		Pequeña, rápida y barata, la <a class='rain' href='/es/Unit/Rain.aspx'>Lluvia</a> es una de las unidades mas importantes  del ejército de los <a href='/es/Race/LightHumans.aspx'>Utopianos</a>. Es ideal para
  bloquear otras <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> a  modo  de proteger unidades mas importantes (ver <a href='/es/Battles/DispensableUnits.aspx'>Carne de Cañon</a>).
  <p />
  Su bonus contra unidades  <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> hace de esta unidad una integrante perfecta para cualquier flota.
  <p />
  Su <a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> es 1, tal como la maioria de las unidades de <a href='/es/Battles/Light.aspx'>Pequeño Porte</a>.
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Gran Porte</td><td>1200</td><td>0</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Puerto Espacial</a> Nivel 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Energy.aspx'>Energía</a></li><li>175 <a href='../Intrinsic/Serium.aspx'>Serium</a></li></ul></td><td class='duration'>10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
