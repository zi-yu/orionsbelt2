...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Aguila" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/eagle.png' alt='Aguila' />
		La <a class='eagle' href='/es/Unit/Eagle.aspx'>Aguila</a> es considerada por muchos jugadores como la unidad mas poderosa del juego.
  Esto porque la <a class='eagle' href='/es/Unit/Eagle.aspx'>Aguila</a> tiene un movimiento muy fuerte y ataque <a href='/es/Battles/Catapult.aspx'>Catapulta</a>, que le permite fácilmente
  romper las defensas adversárias.<p />

  Como todas las <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> con movimiento 2 y categoría <a href='/es/Battles/Medium.aspx'>Médio Porte</a>, la <a class='eagle' href='/es/Unit/Eagle.aspx'>Aguila</a> tiene grandes vantajas en el enferentamiento
  directo con todas las <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> con costo de movimento mayor que 2. Y su ataque catapulta la dá una gran
  vantaja contra <a class='kamikaze' href='/es/Unit/Kamikaze.aspx'>Suicida</a> o los <a class='rain' href='/es/Unit/Rain.aspx'>Lluvia</a>, que si no fueran destruídas a tiempo pueden causar grandes problemas.
	</div>
	...
	<table class='table'>
		...
		<tr>
			<td>Categoría</td>
			<td><a href='/es/Battles/Medium.aspx'>Médio Porte</a></td>
		</tr>
		<tr>
			<td>Posición</td>
			<td>Aire</td>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades de Ataque</td><td><a href='/es/Battles/Catapult.aspx'>Catapulta</a></td></tr></table>
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Médio Porte</td><td>400</td><td>0</td><td>0</td></tr><tr><td>Gran Porte</td><td>0</td><td>400</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Puerto Espacial</a> Nivel 6</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Energy.aspx'>Energía</a></li><li>200 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>450 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>150 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>125 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>1 Hora 10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
