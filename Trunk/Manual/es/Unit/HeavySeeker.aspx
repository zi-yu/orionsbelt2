...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Mega Buscador" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/heavyseeker.png' alt='Mega Buscador' />
		El <a class='heavyseeker' href='/es/Unit/HeavySeeker.aspx'>Mega Buscador</a> es la única unidad de combate de alto <a href='/es/Battles/Range.aspx'>Alcance</a> de los <a href='/es/Race/Bugs.aspx'>Levyr</a>. A pesar del alto costo de movimiento,
  tiene un <a href='/es/Battles/Range.aspx'>Alcance</a> de 5 y un buen ataque y defenza. Los <a href='/es/Race/Bugs.aspx'>Levyr</a> son conocidos por la libertad de movimento de  sus
  <a href='/es/UnitIndex.aspx'>Unidades de Combate</a>, y el <a class='heavyseeker' href='/es/Unit/HeavySeeker.aspx'>Mega Buscador</a> no es la excepción . Con <a href='/es/Battles/Movement.aspx#MovDiagonal'>Movimiento Diagonal</a> esta unidad puede tener un <a href='/es/Battles/Range.aspx'>Alcance</a> combinado
  de 6!
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 8</li></ul></td><td><ul><li>300 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>400 <a href='../Intrinsic/Elk.aspx'>Comida</a></li></ul></td><td class='duration'>1 Hora 30 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
