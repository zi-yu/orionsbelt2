...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Escarabajo" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/scarab.png' alt='Escarabajo' />
		Esta unidad es la <a href='/es/Battles/Medium.aspx'>Médio Porte</a> que mas se aproxima de una unidad <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> debido a se gran poder de ataque y de defenza para una <a href='/es/Battles/Medium.aspx'>Médio Porte</a>,
  y debido a su <a href='/es/Battles/Movement.aspx'>Movimiento</a> limitado que es del tipo <a href='/es/Battles/Movement.aspx#MovFront'>Movimiento Frontal</a>. Sin embargo el <a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> es de solo 1, tal como la mayoria de las <a href='/es/UnitIndex.aspx'>Unidades</a> <a href='/es/Battles/Light.aspx'>Pequeño Porte</a>,
  y tiene <a href='/es/Battles/Range.aspx'>Alcance</a> relativamente corto de apenas 2.<p />
  En el fondo la <a class='scarab' href='/es/Unit/Scarab.aspx'>Escarabajo</a> es una unidad difícil de destruir y con un  buen  poder de ataque, pero tienen como limitacion  la dificultad de
  posicionamento y corto <a href='/es/Battles/Range.aspx'>Alcance</a> lo que transforma el  ataque complicado, y aún el echo de no tener ningún tipo de ataque especial.
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 4</li></ul></td><td><ul><li>300 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>250 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li><li>100 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>45 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>40 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
