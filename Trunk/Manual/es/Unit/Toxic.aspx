...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Toxico" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/toxic.png' alt='Toxico' />
		Esta unidade es un potencial peligro contra <a href='/es/UnitIndex.aspx'>Unidades</a> <a href='/es/Battles/Organic.aspx'>Organico</a>, debido a su bonus de ataque. <p />
  Sin embargo, y a pesar  de ser una unidad con <a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> de 1, no es una buena unidad para servir como <a href='/es/Battles/DispensableUnits.aspx'>Carne de Cañon</a>, pués tiene como
  <a href='/es/Battles/Movement.aspx'>Movimiento</a> el  tipo <a href='/es/Battles/Movement.aspx#MovNormal'>Movimiento Normal</a>, lo que la transforma en una unidad un poco complicada de maniobrar apropriadamente.
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Organico</td><td>1000</td><td>0</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 2</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>300 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li></ul></td><td class='duration'>10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
