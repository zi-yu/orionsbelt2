...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		La <a class='kahuna' href='/es/Unit/Kahuna.aspx'>Kahuna</a> es una gran unidad para quebrar las defensas del enemigo. La habilidad de <a href='/es/Battles/Rebound.aspx'>Rebote</a> puede hacer a diferencias en várias situaciones
   ya que obliga al enemigo a proteger aún mejor sus unidades (lo que significa gastar más <a href='/es/Battles/Movement.aspx#MovPoints'>Puntos de Movimiento</a> por turno).
   <p />
   Dependiendo del tipo de terreno, la defensa de la <a class='kahuna' href='/es/Unit/Kahuna.aspx'>Kahuna</a> puede ir de buena a excelente. Su defensa base es de 1300. Cuando lucha contra unidades [Air] gana un bonus 
   adicional de 400 pontos de defensa e, si el terreno es  del tipo Terrestre, gana 400 puntos extras lo que da un total de 2100 (casi lo  mismo que una unidad <a href='/es/Battles/Heavy.aspx'>Gran Porte</a>).
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Terrestre</td><td>0</td><td>400</td><td>0</td></tr><tr><td>Aire</td><td>0</td><td>400</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Puerto Espacial</a> Nivel 5</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Energy.aspx'>Energía</a></li><li>275 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>350 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>188 <a href='../Intrinsic/Argon.aspx'>Argon</a></li></ul></td><td class='duration'>50 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
