...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Pantera" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/panther.png' alt='Pantera' />
		Las <a class='panther' href='/es/Unit/Panther.aspx'>Pantera</a> son una unidad que tiene  como característica principal el ataque <a href='/es/Battles/Rebound.aspx'>Rebote</a>. A pesar de ser  unidades débiles, pueden  ser una
  amenaza a las unidades con poca vida como cualquier unidad <a href='/es/Battles/Light.aspx'>Pequeño Porte</a> o a las próprias <a class='kamikaze' href='/es/Unit/Kamikaze.aspx'>Suicida</a>. <p />En  suficiente cantidad pueden inclusivé
  amenazar una <a class='flag' href='/es/Unit/Flag.aspx'>Bandera</a> mal protegida, por eso cuando estuvieran jugando contra estas unidades acuerdense que son débiles, pero en cantidades
  suficientes pueden causar estragos consideráveis en nuestra <a href='/es/Universe/Fleet.aspx'>Flota</a>.
	</div>
