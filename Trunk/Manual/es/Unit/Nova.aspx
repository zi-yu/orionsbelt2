...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		La <a class='nova' href='/es/Unit/Nova.aspx'>Nova</a> es la  unidad de <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> contra unidades del tipo <a href='/es/Battles/Organic.aspx'>Organico</a>. Tiene un ataque de 2700 que puede aumentar en 4000 cuando ataca <a href='/es/Battles/Organic.aspx'>Organico</a> (total de 6700
   de poder de ataque).
   <p />
   El <a href='/es/Battles/Movement.aspx#MovNormal'>Movimiento Normal</a> y el <a href='/es/Battles/Range.aspx'>Alcance</a> de 5 dá a esta unidad gran control sobre las unidades del <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a> y, en muchos casos, puede atacar desde una distancia donde las unidades
   del enemigo no logran llegar con facilidad.
   <p />
   Tiene  un buen costo ya que sólo depende de recursos comunes. Es una unidad imprescindíble cuando se lucha contra razas con unidades del tipo <a href='/es/Battles/Organic.aspx'>Organico</a> (como los <a href='/es/Race/Bugs.aspx'>Levyr</a>).
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Organico</td><td>4000</td><td>0</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Puerto Espacial</a> Nivel 8</li></ul></td><td><ul><li>400 <a href='../Intrinsic/Energy.aspx'>Energía</a></li><li>375 <a href='../Intrinsic/Serium.aspx'>Serium</a></li><li>500 <a href='../Intrinsic/Mithril.aspx'>Mithril</a></li><li>175 <a href='../Intrinsic/Argon.aspx'>Argon</a></li><li>50 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Hora 10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
