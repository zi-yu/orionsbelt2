...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Probablemente  <a class='anubis' href='/es/Unit/Anubis.aspx'>Anubis</a> es la mejor unidad para utilizar como <a href='/es/Battles/DispensableUnits.aspx'>Carne de Cañon</a>, especialmente contra unidades <a href='/es/Battles/Heavy.aspx'>Gran Porte</a>.
  Esta característica es derivada de vários  factores:
  <ul><li><a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> 1;</li><li><a href='/es/Battles/Movement.aspx'>Movimiento</a> en todas las direcciones;</li><li>Bonus de defensa contra unidades <a href='/es/Battles/Heavy.aspx'>Gran Porte</a></li></ul>
  Sin embargo las <a class='anubis' href='/es/Unit/Anubis.aspx'>Anubis</a> deben temer a las <a class='raptor' href='/es/Unit/Raptor.aspx'>Raptor</a>, debido a que su bonus de ataque contra unidades <a href='/es/Battles/Light.aspx'>Pequeño Porte</a>, y las unidades <a href='/es/Battles/Medium.aspx'>Médio Porte</a> con mayor poder de ataque.
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Gran Porte</td><td>0</td><td>1600</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 3</li></ul></td><td><ul><li>325 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>275 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li></ul></td><td class='duration'>10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
