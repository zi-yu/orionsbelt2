...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		<a class='krill' href='/es/Unit/Krill.aspx'>Krill</a> es la unidad de <a href='/es/Battles/Medium.aspx'>Médio Porte</a> mas común en el ejercito de los <a href='/es/Race/LightHumans.aspx'>Utopianos</a>. Es la primera unidad de <a href='/es/Battles/Medium.aspx'>Médio Porte</a> que queda disponible y le os recursos necesarios 
   para su construcción son fáciles de juntar (sólo depende de recursos básicos).
   <p />
  Tiene buen ataque y defensa,  un excelente movimento (<a href='/es/Battles/Movement.aspx#MovAll'>Movimiento Total</a>) y tiene la habilidad especial de <a href='/es/Battles/StrikeBack.aspx'>Contraataque</a> la cual puede ser muy útil contra  unidades 
  atacantes (excepto aquellas que tengan habilidad <a href='/es/Battles/ParalyseAttack.aspx'>Ataque Paralizador</a>).
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/UnitYard.aspx'>Puerto Espacial</a> Nivel 3</li></ul></td><td><ul><li>375 <a href='../Intrinsic/Energy.aspx'>Energía</a></li><li>450 <a href='../Intrinsic/Serium.aspx'>Serium</a></li></ul></td><td class='duration'>30 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
