...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Lluvia Sombría" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darkrain.png' alt='Lluvia Sombría' />
		Las <a class='darkrain' href='/es/Unit/DarkRain.aspx'>Lluvia Sombría</a> son las unidades base de los <a href='/es/Race/DarkHumans.aspx'>Renegados</a>  y la primera unidad en quedar disponíble para construcción cuando el <a class='dominationyard' href='/es/Facility/DominationYard.aspx'>Hangar de Domínio</a>
  es aún de  nivel 1.<p />
  A pesar de ser una unidad con poca defenza es una  buena unidad de <a href='/es/Battles/DispensableUnits.aspx'>Carne de Cañon</a>, pués se trata de una unidad con <a href='/es/Battles/Movement.aspx#MovAll'>Movimiento Total</a> con <a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> de 1
  y mas alla de esto es una unidad barata y de construcción rápida.<p />
  Se debe aún tener en cuenta el bonus de ataque que tienen contra unidades <a href='/es/Battles/Heavy.aspx'>Gran Porte</a>, que la torna una unidad al  nivel de las <a href='/es/Battles/Medium.aspx'>Médio Porte</a> cuando ataca
  las unidades <a href='/es/Battles/Heavy.aspx'>Gran Porte</a>.
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Gran Porte</td><td>600</td><td>0</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 1</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>175 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li></ul></td><td class='duration'>10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
