...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Viuda Negra" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/blackwidow.png' alt='Viuda Negra' />
		No hay muchas <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> de <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> con <a href='/es/Battles/Movement.aspx#MovAll'>Movimiento Total</a> en el  juego y la <a class='blackwidow' href='/es/Unit/BlackWidow.aspx'>Viuda Negra</a> es una de ellas. Con un costo de movimiento
  de 3, la <a class='blackwidow' href='/es/Unit/BlackWidow.aspx'>Viuda Negra</a> es una unidad super móvil, muy poderosa, y con dos habilidades especiales:
  <a href='/es/Battles/InfestationAttack.aspx'>Ataque Venenoso</a> y <a href='/es/Battles/ParalyseAttack.aspx'>Ataque Paralizador</a>.
  <p />
  La combinación de <a href='/es/Battles/InfestationAttack.aspx'>Ataque Venenoso</a> y <a href='/es/Battles/ParalyseAttack.aspx'>Ataque Paralizador</a> hace que sea praticamente imposible golpear a  esta unidad    si ella atacara primero.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li><a href='/es/Battles/InfestationAttack.aspx'>Ataque Venenoso</a></li><li>[ParalyseAttack]</li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>1000 <a href='../Intrinsic/Elk.aspx'>Comida</a></li><li>450 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>250 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>200 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>2 Horas </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
