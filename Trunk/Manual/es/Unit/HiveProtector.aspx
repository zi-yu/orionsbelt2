...
<asp:Content ContentPlaceHolderID="title" runat="server">
	Unidad Protector de la Colmena
</asp:Content>
...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Protector de la Colmena" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/hiveprotector.png' alt='Protector de la Colmena' />
		El <a class='hiveprotector' href='/es/Unit/HiveProtector.aspx'>Protector de la Colmena</a> es la unidad mas defensiva de los <a href='/es/Race/Bugs.aspx'>Levyr</a>. Tiene algunas semejanzas com las <a class='pretorian' href='/es/Unit/Pretorian.aspx'>Pretoriana</a> de los
  <a href='/es/Race/LightHumans.aspx'>Utopianos</a>, en la medida en que tienen mucha defenza y un ataque mas débil. A pesar de no poseer tanta defenza
  como la <a class='pretorian' href='/es/Unit/Pretorian.aspx'>Pretoriana</a>, tiene mucho mas ataque, lo que la torna una unidad mas versátil. Por otro lado el <a href='/es/Battles/Movement.aspx#MovNormal'>Movimiento Normal</a>
  no es tan útil para defender.
  <p />
  En suma, el <a class='hiveprotector' href='/es/Unit/HiveProtector.aspx'>Protector de la Colmena</a> es una unidad bastante resistente y con un  buen ataque. No olvidar también su   habilidad de <a href='/es/Battles/StrikeBack.aspx'>Contraataque</a>.
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 5</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>200 <a href='../Intrinsic/Elk.aspx'>Comida</a></li><li>175 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li><li>125 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>50 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
