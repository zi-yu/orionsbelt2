...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		La principal vantaja de las <a class='vector' href='/es/Unit/Vector.aspx'>Vector</a> es su <a href='/es/Battles/Range.aspx'>Alcance</a> relativamente largo (4 de <a href='/es/Battles/Range.aspx'>Alcance</a>) sumado con su ataque especial <a href='/es/Battles/Catapult.aspx'>Catapulta</a>.
  Esto significa que cualquier posición hasta una distancia de 4 es imposible de ser protegida del ataque de las <a class='vector' href='/es/Unit/Vector.aspx'>Vector</a>.<p />
  La debilidad de las  Vector reside especialmente en el <a href='/es/Battles/Movement.aspx#MovCost'>Costo de Movimiento</a> de 3 lo que es elevado para una unidade <a href='/es/Battles/Medium.aspx'>Médio Porte</a>. Mas alla de esto también sólo tienen<a href='/es/Battles/Movement.aspx#MovNormal'>Movimiento Normal</a>
  lo que no la transforma en una unidad muy versátil a nivel de movimento y por eso es difícil de sorprender al oponente.
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 6</li></ul></td><td><ul><li>250 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>200 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li><li>300 <a href='../Intrinsic/Uranium.aspx'>Uranio</a></li><li>125 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>100 <a href='../Intrinsic/Radon.aspx'>Radon</a></li></ul></td><td class='duration'>1 Hora 20 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
