...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Toro Oscuro" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/darktaurus.png' alt='Toro Oscuro' />
		Esta unidad es una pequeña fortaleza moviendose por el <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a>, casi indestrutble y con un inmenso poder de ataque.<p />
  Los puntos debiles de <a class='darktaurus' href='/es/Unit/DarkTaurus.aspx'>Toro Oscuro</a> son un <a href='/es/Battles/Range.aspx'>Alcance</a> corto para una unidad <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> y el echo de tener solo <a href='/es/Battles/Movement.aspx#MovFront'>Movimiento Frontal</a>, pero cuando 
  son colocadas en el centro de la batalla es una unidad extremamente útil.<p />
  Además del enorme poder de <a class='darktaurus' href='/es/Unit/DarkTaurus.aspx'>Toro Oscuro</a> tiene dos poderes especiales que amplificam su poder destructivo, el <a href='/es/Battles/Rebound.aspx'>Rebote</a> y el 
  <a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a>, que en extremo pueden provocar la destrucción de <a href='/es/UnitIndex.aspx'>Unidades</a> enemigas en 4 cuadriculas diferentes apenas com un disparo.
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 10</li></ul></td><td><ul><li>750 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>700 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li><li>1125 <a href='../Intrinsic/Uranium.aspx'>Uranio</a></li><li>375 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li><li>125 <a href='../Intrinsic/Astatine.aspx'>Astatine</a></li></ul></td><td class='duration'>1 Hora 30 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
