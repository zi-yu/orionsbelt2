...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Buscador" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/seeker.png' alt='Buscador' />
		El <a class='seeker' href='/es/Unit/Seeker.aspx'>Buscador</a> es una unidad de <a href='/es/Battles/Light.aspx'>Pequeño Porte</a> muy polivalente. Tiene todos los benefícios esperados de una unidad de
  <a href='/es/Battles/Light.aspx'>Pequeño Porte</a>, como rapidez y libertad de movimiento. Sólo tiene 1 de <a href='/es/Battles/Range.aspx'>Alcance</a>, pero tiene un gran bónus contra <a href='/es/UnitIndex.aspx'>Unidades de Combate</a>
  de <a href='/es/Battles/Medium.aspx'>Médio Porte</a>, lo que aumenta considerablemente su utilidad.
  <p />
  En una <a href='/es/Universe/Fleet.aspx'>Flota</a> de <a href='/es/Race/Bugs.aspx'>Levyr</a>, el <a class='seeker' href='/es/Unit/Seeker.aspx'>Buscador</a> es impresindíble. Es la única unidad capaz de servir como <a href='/es/Battles/DispensableUnits.aspx'>Carne de Cañon</a>
  con eficácia y con su bonus contra unidades de <a href='/es/Battles/Medium.aspx'>Médio Porte</a> es una amenaza constante a los adversários.
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Médio Porte</td><td>500</td><td>0</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 1</li></ul></td><td><ul><li>50 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>35 <a href='../Intrinsic/Elk.aspx'>Comida</a></li></ul></td><td class='duration'>10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
