...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Huevo" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/egg.png' alt='Huevo' />
		El <a class='egg' href='/es/Unit/Egg.aspx'>Huevo</a> no puede ser Construido en la <a class='incubator' href='/es/Facility/Incubator.aspx'>Encubadora</a> como las restantes <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> de los <a href='/es/Race/Bugs.aspx'>Levyr</a>.El <a class='egg' href='/es/Unit/Egg.aspx'>Huevo</a>
  es colocado en el <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a> por una <a class='queen' href='/es/Unit/Queen.aspx'>Reina</a>, y  pasados dos turnos nace del la <a class='maggot' href='/es/Unit/Maggot.aspx'>Larva</a>.
	</div>
