...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		Las <a class='kamikaze' href='/es/Unit/Kamikaze.aspx'>Suicida</a> son probablemente las unidades mas traicionera del juego. Su enorme poder de ataque , su rápida y versátil movilidad,
  transforman a esta unidad en una potencial amenaza a cualquier unidad en el <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a>.<p />
  Sin embargo como su nomnre lo indica, las <a class='kamikaze' href='/es/Unit/Kamikaze.aspx'>Suicida</a> son <a href='/es/UnitIndex.aspx'>Unidades</a> para ataques suicídas pués posterior a atacar  quedan desprotegidas contra cualquier
  unidad, pués su defenza es tan insignificante que cualquier tipo de unidad la destruye facilmente un gran conjunto de <a class='kamikaze' href='/es/Unit/Kamikaze.aspx'>Suicida</a>.
  Debido también a su débil  defenza, las <a class='kamikaze' href='/es/Unit/Kamikaze.aspx'>Suicida</a> deben ser muy bien protegidas por otras unidades porque cualquier ataque incluso no directo
  (ej: <a href='/es/Battles/Rebound.aspx'>Rebote</a>, <a href='/es/Battles/TripleAttack.aspx'>Ataque Triple</a>, etc), puede destruir un gran conjunto de <a class='kamikaze' href='/es/Unit/Kamikaze.aspx'>Suicida</a>.
	</div>
	...
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 5</li></ul></td><td><ul><li>225 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>300 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li><li>450 <a href='../Intrinsic/Uranium.aspx'>Uranio</a></li><li>63 <a href='../Intrinsic/Cryptium.aspx'>Cryptium</a></li></ul></td><td class='duration'>1 Hora </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
