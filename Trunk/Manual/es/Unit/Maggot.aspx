...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		La <a class='maggot' href='/es/Unit/Maggot.aspx'>Larva</a> no puede ser construída en la <a class='incubator' href='/es/Facility/Incubator.aspx'>Encubadora</a> como las restantes <a href='/es/UnitIndex.aspx'>Unidades de Combate</a> de los <a href='/es/Race/Bugs.aspx'>Levyr</a>. La <a class='maggot' href='/es/Unit/Maggot.aspx'>Larva</a>
  nace en el  <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a> cuando la <a class='queen' href='/es/Unit/Queen.aspx'>Reina</a> pone un <a class='egg' href='/es/Unit/Egg.aspx'>Huevo</a>. Como unidad, es  bastante interesante, que puede
  ayudar a derrotar al adversário. Sin embargo, es necesario no olvidar  que la <a class='maggot' href='/es/Unit/Maggot.aspx'>Larva</a> será destruída al final
  del combate.
	</div>
