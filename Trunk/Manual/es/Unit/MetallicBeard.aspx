...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Barba de Metal" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/metallicbeard.png' alt='Barba de Metal' />
		<a class='metallicbeard' href='/es/Unit/MetallicBeard.aspx'>Barba de Metal</a> is the supreme commander of the <a href='/es/Race/Mercs.aspx'>Mercs</a> faction. <a class='metallicbeard' href='/es/Unit/MetallicBeard.aspx'>Barba de Metal</a>
  ...
  <p />
  This makes the <a class='metallicbeard' href='/es/Unit/MetallicBeard.aspx'>Barba de Metal</a> a menace on the <a href='/es/Battles/GameBoard.aspx'>Tablero de Juego</a>.
	</div>
