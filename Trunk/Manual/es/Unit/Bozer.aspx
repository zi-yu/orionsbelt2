...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<div class="description">
		...
		El <a class='bozer' href='/es/Unit/Bozer.aspx'>Bozer</a> es una unidad que tiene un enorme bonus de ataque contra unidades de Aire, lo que la transforma destructiva para la mayor parte de las 
  unidades que se atraviesen en su camino.<p />
  Tal como los <a class='darkcrusader' href='/es/Unit/DarkCrusader.aspx'>Cruzador Sombrio</a> solo tienen <a href='/es/Battles/Movement.aspx#MovFront'>Movimiento Frontal</a> lo que las transforma en dificiles  de maniobrar y posicionar adecuadamente para un ataque mas eficiente.<p />
  Otra característica a considerar es el <a href='/es/Battles/StrikeBack.aspx'>Contraataque</a>, por eso quien tenga intensiones de atacar las <a class='bozer' href='/es/Unit/Bozer.aspx'>Bozer</a> es bueno que las destruya todas si no
  el <a href='/es/Battles/StrikeBack.aspx'>Contraataque</a> va a causar estragos.
	</div>
	...
	<h3>Bónus de Unidad</h3><table class='table'><tr><th>Objetivo</th><th>Ataque</th><th>Defensa</th><th>Alcance</th></tr><tr><td>Aire</td><td>4000</td><td>0</td><td>0</td></tr></table>
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/DominationYard.aspx'>Hangar de Domínio</a> Nivel 9</li></ul></td><td><ul><li>800 <a href='../Intrinsic/Gold.aspx'>Oro</a></li><li>775 <a href='../Intrinsic/Titanium.aspx'>Titanio</a></li><li>875 <a href='../Intrinsic/Uranium.aspx'>Uranio</a></li></ul></td><td class='duration'>1 Hora 10 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
