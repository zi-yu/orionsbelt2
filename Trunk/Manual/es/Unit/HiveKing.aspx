...
<asp:Content ContentPlaceHolderID="content" runat="server">
	...
	<h1><asp:Literal Text="Rey de la Colmena" runat="server" /></h1>

	<div class="description">
		<img src='http://resources.orionsbelt.eu/Images/Common/Units/hiveking.png' alt='Rey de la Colmena' />
		El <a class='hiveking' href='/es/Unit/HiveKing.aspx'>Rey de la Colmena</a> es  una unidad muy imponente de los <a href='/es/Race/Bugs.aspx'>Levyr</a>. Con un <a href='/es/Battles/Range.aspx'>Alcance</a> de 4 y costo de movimento de 3,
  El <a class='hiveking' href='/es/Unit/HiveKing.aspx'>Rey de la Colmena</a> es de las unidades de <a href='/es/Battles/Heavy.aspx'>Gran Porte</a> mas móviles. Es cierto que <a href='/es/Battles/Movement.aspx#MovFront'>Movimiento Frontal</a> es penalizador, pero no olvidar
  que el <a class='hiveking' href='/es/Unit/HiveKing.aspx'>Rey de la Colmena</a> tiene ataque y defenza elevados y dos ataques especiales.
  <p />
  El <a class='hiveking' href='/es/Unit/HiveKing.aspx'>Rey de la Colmena</a> tiene <a href='/es/Battles/InfestationAttack.aspx'>Ataque Venenoso</a> y <a href='/es/Battles/RemoveAbilityAttack.aspx'>Remover Habilidad</a>, que pueden ser devastadores para el adversário.
	</div>
	...
	<h3>Habilidades Especiales</h3><table class='table'><tr><th>Tipo</th><th>Habilidades Especiales</th></tr><tr><td>Habilidades Post-Ataque</td><td><ul><li><a href='/es/Battles/InfestationAttack.aspx'>Ataque Venenoso</a></li><li><a href='/es/Battles/RemoveAbilityAttack.aspx'>Remover Habilidad</a></li></ul></td></tr></table>
	
	
	<h2>Información de Construcción</h2>
	<table class='table'><tr><th>Dependencias</th><th>Costo</th><th>Duración</th><th>Cuando Complete</th><th>Desbloquea</th></tr><tr><td><ul><li><a href='../Facility/Incubator.aspx'>Encubadora</a> Nivel 9</li></ul></td><td><ul><li>800 <a href='../Intrinsic/Protol.aspx'>Protol</a></li><li>650 <a href='../Intrinsic/Elk.aspx'>Comida</a></li><li>200 <a href='../Intrinsic/Prismal.aspx'>Prismal</a></li></ul></td><td class='duration'>1 Hora 50 Minutos </td><td><ul><li>Mover las Unidades para la Flota de Defensa</li></ul></td><td><ul></ul></td></tr></table>
