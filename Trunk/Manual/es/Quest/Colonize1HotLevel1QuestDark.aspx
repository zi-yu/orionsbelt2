...
<asp:Content ContentPlaceHolderID="content" runat="server">
  ...
  <a href="../Facility/Extractor.aspx">Extractores</a>.
	...
	<h2>Recompensa</h2>
	<div class="description">
		<ul><li><a href='/es/Commerce/Orions.aspx'>Orions</a> : +50</li><li>Pontuación : +80</li><li><a href='/es/ColonizerQuests.aspx'>Colonizador</a> : +2</li><li><a class='darkrain' href='/es/Unit/DarkRain.aspx'>Lluvia Sombría</a> : +3</li></ul>
	</div>
