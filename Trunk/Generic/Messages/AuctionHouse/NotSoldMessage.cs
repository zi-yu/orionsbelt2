...
namespace OrionsBelt.Generic.Messages {
    ...
    [FactoryKey("NotSoldMessage")]
    public class NotSoldMessage : UniverseMessage
    {

		#region Overriden

		protected override IMessage CreateMessage( int ownerid, params object[] msgParameters ) {
            return new NotSoldMessage(ownerid);
		}
		...
		public NotSoldMessage() {}

        public NotSoldMessage(int ownerId)
			: base(ownerId) {
			log = "Product not sold";
		}
