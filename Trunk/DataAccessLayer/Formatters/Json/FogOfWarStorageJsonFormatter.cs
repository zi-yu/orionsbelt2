...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for FogOfWarStorage
    /// </summary>
    [FactoryKey("FogOfWarStorage-json")]
    public class FogOfWarStorageJsonFormatter : JsonFormatter<FogOfWarStorage> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override FogOfWarStorage CreateEntity()
        {
