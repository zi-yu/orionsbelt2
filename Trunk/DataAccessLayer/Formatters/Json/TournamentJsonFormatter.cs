...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for Tournament
    /// </summary>
    [FactoryKey("Tournament-json")]
    public class TournamentJsonFormatter : JsonFormatter<Tournament> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override Tournament CreateEntity()
        {
