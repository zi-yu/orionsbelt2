...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for ForumThread
    /// </summary>
    [FactoryKey("ForumThread-json")]
    public class ForumThreadJsonFormatter : JsonFormatter<ForumThread> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override ForumThread CreateEntity()
        {
