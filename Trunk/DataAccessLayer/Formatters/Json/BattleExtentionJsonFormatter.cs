...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for BattleExtention
    /// </summary>
    [FactoryKey("BattleExtention-json")]
    public class BattleExtentionJsonFormatter : JsonFormatter<BattleExtention> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override BattleExtention CreateEntity()
        {
