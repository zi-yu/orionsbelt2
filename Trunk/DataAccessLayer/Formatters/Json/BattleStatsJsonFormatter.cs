...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for BattleStats
    /// </summary>
    [FactoryKey("BattleStats-json")]
    public class BattleStatsJsonFormatter : JsonFormatter<BattleStats> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override BattleStats CreateEntity()
        {
