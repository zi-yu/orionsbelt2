...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for SectorStorage
    /// </summary>
    [FactoryKey("SectorStorage-json")]
    public class SectorStorageJsonFormatter : JsonFormatter<SectorStorage> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override SectorStorage CreateEntity()
        {
