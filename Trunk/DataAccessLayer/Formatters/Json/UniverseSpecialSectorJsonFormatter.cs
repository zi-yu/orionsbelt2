...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for UniverseSpecialSector
    /// </summary>
    [FactoryKey("UniverseSpecialSector-json")]
    public class UniverseSpecialSectorJsonFormatter : JsonFormatter<UniverseSpecialSector> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override UniverseSpecialSector CreateEntity()
        {
