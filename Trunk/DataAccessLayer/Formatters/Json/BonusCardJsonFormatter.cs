...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for BonusCard
    /// </summary>
    [FactoryKey("BonusCard-json")]
    public class BonusCardJsonFormatter : JsonFormatter<BonusCard> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override BonusCard CreateEntity()
        {
