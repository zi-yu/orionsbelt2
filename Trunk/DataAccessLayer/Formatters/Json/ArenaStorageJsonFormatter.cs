...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for ArenaStorage
    /// </summary>
    [FactoryKey("ArenaStorage-json")]
    public class ArenaStorageJsonFormatter : JsonFormatter<ArenaStorage> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override ArenaStorage CreateEntity()
        {
