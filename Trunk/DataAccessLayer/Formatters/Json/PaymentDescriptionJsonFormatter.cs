...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for PaymentDescription
    /// </summary>
    [FactoryKey("PaymentDescription-json")]
    public class PaymentDescriptionJsonFormatter : JsonFormatter<PaymentDescription> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override PaymentDescription CreateEntity()
        {
