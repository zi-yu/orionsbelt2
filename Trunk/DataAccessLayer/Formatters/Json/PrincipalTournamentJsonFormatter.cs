...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for PrincipalTournament
    /// </summary>
    [FactoryKey("PrincipalTournament-json")]
    public class PrincipalTournamentJsonFormatter : JsonFormatter<PrincipalTournament> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override PrincipalTournament CreateEntity()
        {
