...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for LogStorage
    /// </summary>
    [FactoryKey("LogStorage-json")]
    public class LogStorageJsonFormatter : JsonFormatter<LogStorage> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override LogStorage CreateEntity()
        {
