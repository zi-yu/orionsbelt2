...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for Promotion
    /// </summary>
    [FactoryKey("Promotion-json")]
    public class PromotionJsonFormatter : JsonFormatter<Promotion> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override Promotion CreateEntity()
        {
