...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for Necessity
    /// </summary>
    [FactoryKey("Necessity-json")]
    public class NecessityJsonFormatter : JsonFormatter<Necessity> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override Necessity CreateEntity()
        {
