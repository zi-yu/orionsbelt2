...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for QuestStorage
    /// </summary>
    [FactoryKey("QuestStorage-json")]
    public class QuestStorageJsonFormatter : JsonFormatter<QuestStorage> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override QuestStorage CreateEntity()
        {
