...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for SpecialEvent
    /// </summary>
    [FactoryKey("SpecialEvent-json")]
    public class SpecialEventJsonFormatter : JsonFormatter<SpecialEvent> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override SpecialEvent CreateEntity()
        {
