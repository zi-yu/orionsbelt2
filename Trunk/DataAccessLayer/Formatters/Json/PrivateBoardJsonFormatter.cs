...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for PrivateBoard
    /// </summary>
    [FactoryKey("PrivateBoard-json")]
    public class PrivateBoardJsonFormatter : JsonFormatter<PrivateBoard> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override PrivateBoard CreateEntity()
        {
