...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for PrincipalStats
    /// </summary>
    [FactoryKey("PrincipalStats-json")]
    public class PrincipalStatsJsonFormatter : JsonFormatter<PrincipalStats> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override PrincipalStats CreateEntity()
        {
