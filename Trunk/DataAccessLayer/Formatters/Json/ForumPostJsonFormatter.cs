...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for ForumPost
    /// </summary>
    [FactoryKey("ForumPost-json")]
    public class ForumPostJsonFormatter : JsonFormatter<ForumPost> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override ForumPost CreateEntity()
        {
