...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for VoteStorage
    /// </summary>
    [FactoryKey("VoteStorage-json")]
    public class VoteStorageJsonFormatter : JsonFormatter<VoteStorage> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override VoteStorage CreateEntity()
        {
