...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for GroupPointsStorage
    /// </summary>
    [FactoryKey("GroupPointsStorage-json")]
    public class GroupPointsStorageJsonFormatter : JsonFormatter<GroupPointsStorage> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override GroupPointsStorage CreateEntity()
        {
