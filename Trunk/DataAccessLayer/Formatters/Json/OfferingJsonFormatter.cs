...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for Offering
    /// </summary>
    [FactoryKey("Offering-json")]
    public class OfferingJsonFormatter : JsonFormatter<Offering> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override Offering CreateEntity()
        {
