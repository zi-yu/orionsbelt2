...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for ForumReadMarking
    /// </summary>
    [FactoryKey("ForumReadMarking-json")]
    public class ForumReadMarkingJsonFormatter : JsonFormatter<ForumReadMarking> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override ForumReadMarking CreateEntity()
        {
