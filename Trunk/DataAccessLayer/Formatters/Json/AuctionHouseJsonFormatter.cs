...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for AuctionHouse
    /// </summary>
    [FactoryKey("AuctionHouse-json")]
    public class AuctionHouseJsonFormatter : JsonFormatter<AuctionHouse> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override AuctionHouse CreateEntity()
        {
