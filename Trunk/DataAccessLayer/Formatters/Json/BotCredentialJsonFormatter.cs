...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for BotCredential
    /// </summary>
    [FactoryKey("BotCredential-json")]
    public class BotCredentialJsonFormatter : JsonFormatter<BotCredential> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override BotCredential CreateEntity()
        {
