...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for PlayerBattleInformation
    /// </summary>
    [FactoryKey("PlayerBattleInformation-json")]
    public class PlayerBattleInformationJsonFormatter : JsonFormatter<PlayerBattleInformation> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override PlayerBattleInformation CreateEntity()
        {
