...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for GlobalStats
    /// </summary>
    [FactoryKey("GlobalStats-json")]
    public class GlobalStatsJsonFormatter : JsonFormatter<GlobalStats> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override GlobalStats CreateEntity()
        {
