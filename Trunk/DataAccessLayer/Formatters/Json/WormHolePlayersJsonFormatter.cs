...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for WormHolePlayers
    /// </summary>
    [FactoryKey("WormHolePlayers-json")]
    public class WormHolePlayersJsonFormatter : JsonFormatter<WormHolePlayers> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override WormHolePlayers CreateEntity()
        {
