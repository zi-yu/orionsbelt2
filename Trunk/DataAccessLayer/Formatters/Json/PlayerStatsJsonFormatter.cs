...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Formatter object for PlayerStats
    /// </summary>
    [FactoryKey("PlayerStats-json")]
    public class PlayerStatsJsonFormatter : JsonFormatter<PlayerStats> {
        ...
        /// </summary>
        /// <returns></returns>
        protected override PlayerStats CreateEntity()
        {
