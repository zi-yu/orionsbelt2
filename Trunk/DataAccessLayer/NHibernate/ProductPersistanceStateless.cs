...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class ProductPersistanceStateless : 
			NHibernatePersistanceStateless<Product>, IProductPersistance {
	
		#region Static Access
		
		internal static ProductPersistanceStateless CreateSession()
		{
			return new ProductPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedProduct) );
		}
				
		internal static ProductPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			ProductPersistanceStateless persistance = new ProductPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedProduct) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static ProductPersistanceStateless globalSession = null;
        internal static ProductPersistanceStateless GlobalSession {
            get {
		...
		internal static ProductPersistanceStateless GetSession()
		{
		...
		internal static ProductPersistanceStateless GetValidatedSession()
        {
            ProductPersistanceStateless persistance = GetSession();
		...
		private ProductPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Product
        {
