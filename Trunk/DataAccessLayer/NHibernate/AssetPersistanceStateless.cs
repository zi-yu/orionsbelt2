...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class AssetPersistanceStateless : 
			NHibernatePersistanceStateless<Asset>, IAssetPersistance {
	
		#region Static Access
		
		internal static AssetPersistanceStateless CreateSession()
		{
			return new AssetPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedAsset) );
		}
				
		internal static AssetPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			AssetPersistanceStateless persistance = new AssetPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedAsset) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static AssetPersistanceStateless globalSession = null;
        internal static AssetPersistanceStateless GlobalSession {
            get {
		...
		internal static AssetPersistanceStateless GetSession()
		{
		...
		internal static AssetPersistanceStateless GetValidatedSession()
        {
            AssetPersistanceStateless persistance = GetSession();
		...
		private AssetPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Asset
        {
