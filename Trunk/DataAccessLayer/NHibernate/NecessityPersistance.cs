...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class NecessityPersistance : 
			NHibernatePersistance<Necessity>, INecessityPersistance {
	
		#region Static Access
		
		internal static NecessityPersistance CreateSession()
		{
			return new NecessityPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedNecessity) );
		}
				
		internal static NecessityPersistance AttachSession( IPersistanceSession owner )
		{
			NecessityPersistance persistance = new NecessityPersistance ( owner.Session as ISession, typeof(SpecializedNecessity) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static NecessityPersistance globalSession = null;
        internal static NecessityPersistance GlobalSession {
            get {
		...
		internal static NecessityPersistance GetSession()
		{
		...
		internal static NecessityPersistance GetValidatedSession()
        {
            NecessityPersistance persistance = GetSession();
		...
		private NecessityPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Necessity
        {
