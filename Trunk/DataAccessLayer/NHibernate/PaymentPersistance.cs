...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PaymentPersistance : 
			NHibernatePersistance<Payment>, IPaymentPersistance {
	
		#region Static Access
		
		internal static PaymentPersistance CreateSession()
		{
			return new PaymentPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedPayment) );
		}
				
		internal static PaymentPersistance AttachSession( IPersistanceSession owner )
		{
			PaymentPersistance persistance = new PaymentPersistance ( owner.Session as ISession, typeof(SpecializedPayment) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PaymentPersistance globalSession = null;
        internal static PaymentPersistance GlobalSession {
            get {
		...
		internal static PaymentPersistance GetSession()
		{
		...
		internal static PaymentPersistance GetValidatedSession()
        {
            PaymentPersistance persistance = GetSession();
		...
		private PaymentPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Payment
        {
