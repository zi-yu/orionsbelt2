...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PendingBotRequestPersistanceStateless : 
			NHibernatePersistanceStateless<PendingBotRequest>, IPendingBotRequestPersistance {
	
		#region Static Access
		
		internal static PendingBotRequestPersistanceStateless CreateSession()
		{
			return new PendingBotRequestPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPendingBotRequest) );
		}
				
		internal static PendingBotRequestPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PendingBotRequestPersistanceStateless persistance = new PendingBotRequestPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPendingBotRequest) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PendingBotRequestPersistanceStateless globalSession = null;
        internal static PendingBotRequestPersistanceStateless GlobalSession {
            get {
		...
		internal static PendingBotRequestPersistanceStateless GetSession()
		{
		...
		internal static PendingBotRequestPersistanceStateless GetValidatedSession()
        {
            PendingBotRequestPersistanceStateless persistance = GetSession();
		...
		private PendingBotRequestPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : PendingBotRequest
        {
