...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class ArenaStoragePersistance : 
			NHibernatePersistance<ArenaStorage>, IArenaStoragePersistance {
	
		#region Static Access
		
		internal static ArenaStoragePersistance CreateSession()
		{
			return new ArenaStoragePersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedArenaStorage) );
		}
				
		internal static ArenaStoragePersistance AttachSession( IPersistanceSession owner )
		{
			ArenaStoragePersistance persistance = new ArenaStoragePersistance ( owner.Session as ISession, typeof(SpecializedArenaStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static ArenaStoragePersistance globalSession = null;
        internal static ArenaStoragePersistance GlobalSession {
            get {
		...
		internal static ArenaStoragePersistance GetSession()
		{
		...
		internal static ArenaStoragePersistance GetValidatedSession()
        {
            ArenaStoragePersistance persistance = GetSession();
		...
		private ArenaStoragePersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : ArenaStorage
        {
