...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PrincipalTournamentPersistanceStateless : 
			NHibernatePersistanceStateless<PrincipalTournament>, IPrincipalTournamentPersistance {
	
		#region Static Access
		
		internal static PrincipalTournamentPersistanceStateless CreateSession()
		{
			return new PrincipalTournamentPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPrincipalTournament) );
		}
				
		internal static PrincipalTournamentPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PrincipalTournamentPersistanceStateless persistance = new PrincipalTournamentPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPrincipalTournament) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PrincipalTournamentPersistanceStateless globalSession = null;
        internal static PrincipalTournamentPersistanceStateless GlobalSession {
            get {
		...
		internal static PrincipalTournamentPersistanceStateless GetSession()
		{
		...
		internal static PrincipalTournamentPersistanceStateless GetValidatedSession()
        {
            PrincipalTournamentPersistanceStateless persistance = GetSession();
		...
		private PrincipalTournamentPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : PrincipalTournament
        {
