...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class DuplicateDetectionPersistance : 
			NHibernatePersistance<DuplicateDetection>, IDuplicateDetectionPersistance {
	
		#region Static Access
		
		internal static DuplicateDetectionPersistance CreateSession()
		{
			return new DuplicateDetectionPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedDuplicateDetection) );
		}
				
		internal static DuplicateDetectionPersistance AttachSession( IPersistanceSession owner )
		{
			DuplicateDetectionPersistance persistance = new DuplicateDetectionPersistance ( owner.Session as ISession, typeof(SpecializedDuplicateDetection) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static DuplicateDetectionPersistance globalSession = null;
        internal static DuplicateDetectionPersistance GlobalSession {
            get {
		...
		internal static DuplicateDetectionPersistance GetSession()
		{
		...
		internal static DuplicateDetectionPersistance GetValidatedSession()
        {
            DuplicateDetectionPersistance persistance = GetSession();
		...
		private DuplicateDetectionPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : DuplicateDetection
        {
