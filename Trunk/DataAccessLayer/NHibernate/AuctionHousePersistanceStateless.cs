...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class AuctionHousePersistanceStateless : 
			NHibernatePersistanceStateless<AuctionHouse>, IAuctionHousePersistance {
	
		#region Static Access
		
		internal static AuctionHousePersistanceStateless CreateSession()
		{
			return new AuctionHousePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedAuctionHouse) );
		}
				
		internal static AuctionHousePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			AuctionHousePersistanceStateless persistance = new AuctionHousePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedAuctionHouse) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static AuctionHousePersistanceStateless globalSession = null;
        internal static AuctionHousePersistanceStateless GlobalSession {
            get {
		...
		internal static AuctionHousePersistanceStateless GetSession()
		{
		...
		internal static AuctionHousePersistanceStateless GetValidatedSession()
        {
            AuctionHousePersistanceStateless persistance = GetSession();
		...
		private AuctionHousePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : AuctionHouse
        {
