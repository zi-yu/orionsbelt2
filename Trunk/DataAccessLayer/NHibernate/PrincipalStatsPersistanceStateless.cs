...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PrincipalStatsPersistanceStateless : 
			NHibernatePersistanceStateless<PrincipalStats>, IPrincipalStatsPersistance {
	
		#region Static Access
		
		internal static PrincipalStatsPersistanceStateless CreateSession()
		{
			return new PrincipalStatsPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPrincipalStats) );
		}
				
		internal static PrincipalStatsPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PrincipalStatsPersistanceStateless persistance = new PrincipalStatsPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPrincipalStats) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PrincipalStatsPersistanceStateless globalSession = null;
        internal static PrincipalStatsPersistanceStateless GlobalSession {
            get {
		...
		internal static PrincipalStatsPersistanceStateless GetSession()
		{
		...
		internal static PrincipalStatsPersistanceStateless GetValidatedSession()
        {
            PrincipalStatsPersistanceStateless persistance = GetSession();
		...
		private PrincipalStatsPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : PrincipalStats
        {
        }
