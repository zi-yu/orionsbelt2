...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PlanetResourceStoragePersistance : 
			NHibernatePersistance<PlanetResourceStorage>, IPlanetResourceStoragePersistance {
	
		#region Static Access
		
		internal static PlanetResourceStoragePersistance CreateSession()
		{
			return new PlanetResourceStoragePersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedPlanetResourceStorage) );
		}
				
		internal static PlanetResourceStoragePersistance AttachSession( IPersistanceSession owner )
		{
			PlanetResourceStoragePersistance persistance = new PlanetResourceStoragePersistance ( owner.Session as ISession, typeof(SpecializedPlanetResourceStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PlanetResourceStoragePersistance globalSession = null;
        internal static PlanetResourceStoragePersistance GlobalSession {
            get {
		...
		internal static PlanetResourceStoragePersistance GetSession()
		{
		...
		internal static PlanetResourceStoragePersistance GetValidatedSession()
        {
            PlanetResourceStoragePersistance persistance = GetSession();
		...
		private PlanetResourceStoragePersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : PlanetResourceStorage
        {
