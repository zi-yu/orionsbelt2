...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class FleetPersistanceStateless : 
			NHibernatePersistanceStateless<Fleet>, IFleetPersistance {
	
		#region Static Access
		
		internal static FleetPersistanceStateless CreateSession()
		{
			return new FleetPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedFleet) );
		}
				
		internal static FleetPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			FleetPersistanceStateless persistance = new FleetPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedFleet) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static FleetPersistanceStateless globalSession = null;
        internal static FleetPersistanceStateless GlobalSession {
            get {
		...
		internal static FleetPersistanceStateless GetSession()
		{
		...
		internal static FleetPersistanceStateless GetValidatedSession()
        {
            FleetPersistanceStateless persistance = GetSession();
		...
		private FleetPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Fleet
        {
