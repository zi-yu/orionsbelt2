...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PromotionPersistance : 
			NHibernatePersistance<Promotion>, IPromotionPersistance {
	
		#region Static Access
		
		internal static PromotionPersistance CreateSession()
		{
			return new PromotionPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedPromotion) );
		}
				
		internal static PromotionPersistance AttachSession( IPersistanceSession owner )
		{
			PromotionPersistance persistance = new PromotionPersistance ( owner.Session as ISession, typeof(SpecializedPromotion) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PromotionPersistance globalSession = null;
        internal static PromotionPersistance GlobalSession {
            get {
		...
		internal static PromotionPersistance GetSession()
		{
		...
		internal static PromotionPersistance GetValidatedSession()
        {
            PromotionPersistance persistance = GetSession();
		...
		private PromotionPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Promotion
        {
