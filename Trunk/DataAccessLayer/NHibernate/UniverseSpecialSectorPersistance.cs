...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class UniverseSpecialSectorPersistance : 
			NHibernatePersistance<UniverseSpecialSector>, IUniverseSpecialSectorPersistance {
	
		#region Static Access
		
		internal static UniverseSpecialSectorPersistance CreateSession()
		{
			return new UniverseSpecialSectorPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedUniverseSpecialSector) );
		}
				
		internal static UniverseSpecialSectorPersistance AttachSession( IPersistanceSession owner )
		{
			UniverseSpecialSectorPersistance persistance = new UniverseSpecialSectorPersistance ( owner.Session as ISession, typeof(SpecializedUniverseSpecialSector) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static UniverseSpecialSectorPersistance globalSession = null;
        internal static UniverseSpecialSectorPersistance GlobalSession {
            get {
		...
		internal static UniverseSpecialSectorPersistance GetSession()
		{
		...
		internal static UniverseSpecialSectorPersistance GetValidatedSession()
        {
            UniverseSpecialSectorPersistance persistance = GetSession();
		...
		private UniverseSpecialSectorPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : UniverseSpecialSector
        {
