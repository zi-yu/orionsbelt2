...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PaymentDescriptionPersistanceStateless : 
			NHibernatePersistanceStateless<PaymentDescription>, IPaymentDescriptionPersistance {
	
		#region Static Access
		
		internal static PaymentDescriptionPersistanceStateless CreateSession()
		{
			return new PaymentDescriptionPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPaymentDescription) );
		}
				
		internal static PaymentDescriptionPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PaymentDescriptionPersistanceStateless persistance = new PaymentDescriptionPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPaymentDescription) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PaymentDescriptionPersistanceStateless globalSession = null;
        internal static PaymentDescriptionPersistanceStateless GlobalSession {
            get {
		...
		internal static PaymentDescriptionPersistanceStateless GetSession()
		{
		...
		internal static PaymentDescriptionPersistanceStateless GetValidatedSession()
        {
            PaymentDescriptionPersistanceStateless persistance = GetSession();
		...
		private PaymentDescriptionPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : PaymentDescription
        {
