...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class BattlePersistanceStateless : 
			NHibernatePersistanceStateless<Battle>, IBattlePersistance {
	
		#region Static Access
		
		internal static BattlePersistanceStateless CreateSession()
		{
			return new BattlePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedBattle) );
		}
				
		internal static BattlePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			BattlePersistanceStateless persistance = new BattlePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedBattle) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static BattlePersistanceStateless globalSession = null;
        internal static BattlePersistanceStateless GlobalSession {
            get {
		...
		internal static BattlePersistanceStateless GetSession()
		{
		...
		internal static BattlePersistanceStateless GetValidatedSession()
        {
            BattlePersistanceStateless persistance = GetSession();
		...
		private BattlePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Battle
        {
