...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class FogOfWarStoragePersistance : 
			NHibernatePersistance<FogOfWarStorage>, IFogOfWarStoragePersistance {
	
		#region Static Access
		
		internal static FogOfWarStoragePersistance CreateSession()
		{
			return new FogOfWarStoragePersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedFogOfWarStorage) );
		}
				
		internal static FogOfWarStoragePersistance AttachSession( IPersistanceSession owner )
		{
			FogOfWarStoragePersistance persistance = new FogOfWarStoragePersistance ( owner.Session as ISession, typeof(SpecializedFogOfWarStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static FogOfWarStoragePersistance globalSession = null;
        internal static FogOfWarStoragePersistance GlobalSession {
            get {
		...
		internal static FogOfWarStoragePersistance GetSession()
		{
		...
		internal static FogOfWarStoragePersistance GetValidatedSession()
        {
            FogOfWarStoragePersistance persistance = GetSession();
		...
		private FogOfWarStoragePersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : FogOfWarStorage
        {
