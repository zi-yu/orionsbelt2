...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class TeamStoragePersistance : 
			NHibernatePersistance<TeamStorage>, ITeamStoragePersistance {
	
		#region Static Access
		
		internal static TeamStoragePersistance CreateSession()
		{
			return new TeamStoragePersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedTeamStorage) );
		}
				
		internal static TeamStoragePersistance AttachSession( IPersistanceSession owner )
		{
			TeamStoragePersistance persistance = new TeamStoragePersistance ( owner.Session as ISession, typeof(SpecializedTeamStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static TeamStoragePersistance globalSession = null;
        internal static TeamStoragePersistance GlobalSession {
            get {
		...
		internal static TeamStoragePersistance GetSession()
		{
		...
		internal static TeamStoragePersistance GetValidatedSession()
        {
            TeamStoragePersistance persistance = GetSession();
		...
		private TeamStoragePersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : TeamStorage
        {
