...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class TournamentPersistance : 
			NHibernatePersistance<Tournament>, ITournamentPersistance {
	
		#region Static Access
		
		internal static TournamentPersistance CreateSession()
		{
			return new TournamentPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedTournament) );
		}
				
		internal static TournamentPersistance AttachSession( IPersistanceSession owner )
		{
			TournamentPersistance persistance = new TournamentPersistance ( owner.Session as ISession, typeof(SpecializedTournament) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static TournamentPersistance globalSession = null;
        internal static TournamentPersistance GlobalSession {
            get {
		...
		internal static TournamentPersistance GetSession()
		{
		...
		internal static TournamentPersistance GetValidatedSession()
        {
            TournamentPersistance persistance = GetSession();
		...
		private TournamentPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Tournament
        {
