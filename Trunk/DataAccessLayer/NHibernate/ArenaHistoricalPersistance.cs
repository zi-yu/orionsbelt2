...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class ArenaHistoricalPersistance : 
			NHibernatePersistance<ArenaHistorical>, IArenaHistoricalPersistance {
	
		#region Static Access
		
		internal static ArenaHistoricalPersistance CreateSession()
		{
			return new ArenaHistoricalPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedArenaHistorical) );
		}
				
		internal static ArenaHistoricalPersistance AttachSession( IPersistanceSession owner )
		{
			ArenaHistoricalPersistance persistance = new ArenaHistoricalPersistance ( owner.Session as ISession, typeof(SpecializedArenaHistorical) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static ArenaHistoricalPersistance globalSession = null;
        internal static ArenaHistoricalPersistance GlobalSession {
            get {
		...
		internal static ArenaHistoricalPersistance GetSession()
		{
		...
		internal static ArenaHistoricalPersistance GetValidatedSession()
        {
            ArenaHistoricalPersistance persistance = GetSession();
		...
		private ArenaHistoricalPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : ArenaHistorical
        {
        }
