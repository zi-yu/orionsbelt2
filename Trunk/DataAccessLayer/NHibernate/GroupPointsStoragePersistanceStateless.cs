...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class GroupPointsStoragePersistanceStateless : 
			NHibernatePersistanceStateless<GroupPointsStorage>, IGroupPointsStoragePersistance {
	
		#region Static Access
		
		internal static GroupPointsStoragePersistanceStateless CreateSession()
		{
			return new GroupPointsStoragePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedGroupPointsStorage) );
		}
				
		internal static GroupPointsStoragePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			GroupPointsStoragePersistanceStateless persistance = new GroupPointsStoragePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedGroupPointsStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static GroupPointsStoragePersistanceStateless globalSession = null;
        internal static GroupPointsStoragePersistanceStateless GlobalSession {
            get {
		...
		internal static GroupPointsStoragePersistanceStateless GetSession()
		{
		...
		internal static GroupPointsStoragePersistanceStateless GetValidatedSession()
        {
            GroupPointsStoragePersistanceStateless persistance = GetSession();
		...
		private GroupPointsStoragePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : GroupPointsStorage
        {
        }
