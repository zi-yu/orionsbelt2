...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class AllianceStoragePersistance : 
			NHibernatePersistance<AllianceStorage>, IAllianceStoragePersistance {
	
		#region Static Access
		
		internal static AllianceStoragePersistance CreateSession()
		{
			return new AllianceStoragePersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedAllianceStorage) );
		}
				
		internal static AllianceStoragePersistance AttachSession( IPersistanceSession owner )
		{
			AllianceStoragePersistance persistance = new AllianceStoragePersistance ( owner.Session as ISession, typeof(SpecializedAllianceStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static AllianceStoragePersistance globalSession = null;
        internal static AllianceStoragePersistance GlobalSession {
            get {
		...
		internal static AllianceStoragePersistance GetSession()
		{
		...
		internal static AllianceStoragePersistance GetValidatedSession()
        {
            AllianceStoragePersistance persistance = GetSession();
		...
		private AllianceStoragePersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : AllianceStorage
        {
