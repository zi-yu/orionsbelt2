...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class ForumTopicPersistanceStateless : 
			NHibernatePersistanceStateless<ForumTopic>, IForumTopicPersistance {
	
		#region Static Access
		
		internal static ForumTopicPersistanceStateless CreateSession()
		{
			return new ForumTopicPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedForumTopic) );
		}
				
		internal static ForumTopicPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			ForumTopicPersistanceStateless persistance = new ForumTopicPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedForumTopic) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static ForumTopicPersistanceStateless globalSession = null;
        internal static ForumTopicPersistanceStateless GlobalSession {
            get {
		...
		internal static ForumTopicPersistanceStateless GetSession()
		{
		...
		internal static ForumTopicPersistanceStateless GetValidatedSession()
        {
            ForumTopicPersistanceStateless persistance = GetSession();
		...
		private ForumTopicPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : ForumTopic
        {
