...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class OfferingPersistance : 
			NHibernatePersistance<Offering>, IOfferingPersistance {
	
		#region Static Access
		
		internal static OfferingPersistance CreateSession()
		{
			return new OfferingPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedOffering) );
		}
				
		internal static OfferingPersistance AttachSession( IPersistanceSession owner )
		{
			OfferingPersistance persistance = new OfferingPersistance ( owner.Session as ISession, typeof(SpecializedOffering) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static OfferingPersistance globalSession = null;
        internal static OfferingPersistance GlobalSession {
            get {
		...
		internal static OfferingPersistance GetSession()
		{
		...
		internal static OfferingPersistance GetValidatedSession()
        {
            OfferingPersistance persistance = GetSession();
		...
		private OfferingPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Offering
        {
