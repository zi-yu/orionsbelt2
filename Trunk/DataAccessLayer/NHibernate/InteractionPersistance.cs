...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class InteractionPersistance : 
			NHibernatePersistance<Interaction>, IInteractionPersistance {
	
		#region Static Access
		
		internal static InteractionPersistance CreateSession()
		{
			return new InteractionPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedInteraction) );
		}
				
		internal static InteractionPersistance AttachSession( IPersistanceSession owner )
		{
			InteractionPersistance persistance = new InteractionPersistance ( owner.Session as ISession, typeof(SpecializedInteraction) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static InteractionPersistance globalSession = null;
        internal static InteractionPersistance GlobalSession {
            get {
		...
		internal static InteractionPersistance GetSession()
		{
		...
		internal static InteractionPersistance GetValidatedSession()
        {
            InteractionPersistance persistance = GetSession();
		...
		private InteractionPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Interaction
        {
