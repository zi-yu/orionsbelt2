...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class MedalPersistance : 
			NHibernatePersistance<Medal>, IMedalPersistance {
	
		#region Static Access
		
		internal static MedalPersistance CreateSession()
		{
			return new MedalPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedMedal) );
		}
				
		internal static MedalPersistance AttachSession( IPersistanceSession owner )
		{
			MedalPersistance persistance = new MedalPersistance ( owner.Session as ISession, typeof(SpecializedMedal) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static MedalPersistance globalSession = null;
        internal static MedalPersistance GlobalSession {
            get {
		...
		internal static MedalPersistance GetSession()
		{
		...
		internal static MedalPersistance GetValidatedSession()
        {
            MedalPersistance persistance = GetSession();
		...
		private MedalPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Medal
        {
