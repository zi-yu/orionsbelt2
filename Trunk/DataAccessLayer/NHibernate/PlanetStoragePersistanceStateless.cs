...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PlanetStoragePersistanceStateless : 
			NHibernatePersistanceStateless<PlanetStorage>, IPlanetStoragePersistance {
	
		#region Static Access
		
		internal static PlanetStoragePersistanceStateless CreateSession()
		{
			return new PlanetStoragePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPlanetStorage) );
		}
				
		internal static PlanetStoragePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PlanetStoragePersistanceStateless persistance = new PlanetStoragePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPlanetStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PlanetStoragePersistanceStateless globalSession = null;
        internal static PlanetStoragePersistanceStateless GlobalSession {
            get {
		...
		internal static PlanetStoragePersistanceStateless GetSession()
		{
		...
		internal static PlanetStoragePersistanceStateless GetValidatedSession()
        {
            PlanetStoragePersistanceStateless persistance = GetSession();
		...
		private PlanetStoragePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : PlanetStorage
        {
