...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PlayerStoragePersistanceStateless : 
			NHibernatePersistanceStateless<PlayerStorage>, IPlayerStoragePersistance {
	
		#region Static Access
		
		internal static PlayerStoragePersistanceStateless CreateSession()
		{
			return new PlayerStoragePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPlayerStorage) );
		}
				
		internal static PlayerStoragePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PlayerStoragePersistanceStateless persistance = new PlayerStoragePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPlayerStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PlayerStoragePersistanceStateless globalSession = null;
        internal static PlayerStoragePersistanceStateless GlobalSession {
            get {
		...
		internal static PlayerStoragePersistanceStateless GetSession()
		{
		...
		internal static PlayerStoragePersistanceStateless GetValidatedSession()
        {
            PlayerStoragePersistanceStateless persistance = GetSession();
		...
		private PlayerStoragePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : PlayerStorage
        {
