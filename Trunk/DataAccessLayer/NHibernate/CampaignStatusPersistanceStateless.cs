...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class CampaignStatusPersistanceStateless : 
			NHibernatePersistanceStateless<CampaignStatus>, ICampaignStatusPersistance {
	
		#region Static Access
		
		internal static CampaignStatusPersistanceStateless CreateSession()
		{
			return new CampaignStatusPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedCampaignStatus) );
		}
				
		internal static CampaignStatusPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			CampaignStatusPersistanceStateless persistance = new CampaignStatusPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedCampaignStatus) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static CampaignStatusPersistanceStateless globalSession = null;
        internal static CampaignStatusPersistanceStateless GlobalSession {
            get {
		...
		internal static CampaignStatusPersistanceStateless GetSession()
		{
		...
		internal static CampaignStatusPersistanceStateless GetValidatedSession()
        {
            CampaignStatusPersistanceStateless persistance = GetSession();
		...
		private CampaignStatusPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : CampaignStatus
        {
        }
