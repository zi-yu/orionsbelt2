...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class InvoicePersistanceStateless : 
			NHibernatePersistanceStateless<Invoice>, IInvoicePersistance {
	
		#region Static Access
		
		internal static InvoicePersistanceStateless CreateSession()
		{
			return new InvoicePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedInvoice) );
		}
				
		internal static InvoicePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			InvoicePersistanceStateless persistance = new InvoicePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedInvoice) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static InvoicePersistanceStateless globalSession = null;
        internal static InvoicePersistanceStateless GlobalSession {
            get {
		...
		internal static InvoicePersistanceStateless GetSession()
		{
		...
		internal static InvoicePersistanceStateless GetValidatedSession()
        {
            InvoicePersistanceStateless persistance = GetSession();
		...
		private InvoicePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Invoice
        {
