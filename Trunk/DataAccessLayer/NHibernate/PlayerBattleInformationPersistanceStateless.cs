...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class PlayerBattleInformationPersistanceStateless : 
			NHibernatePersistanceStateless<PlayerBattleInformation>, IPlayerBattleInformationPersistance {
	
		#region Static Access
		
		internal static PlayerBattleInformationPersistanceStateless CreateSession()
		{
			return new PlayerBattleInformationPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPlayerBattleInformation) );
		}
				
		internal static PlayerBattleInformationPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PlayerBattleInformationPersistanceStateless persistance = new PlayerBattleInformationPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPlayerBattleInformation) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PlayerBattleInformationPersistanceStateless globalSession = null;
        internal static PlayerBattleInformationPersistanceStateless GlobalSession {
            get {
		...
		internal static PlayerBattleInformationPersistanceStateless GetSession()
		{
		...
		internal static PlayerBattleInformationPersistanceStateless GetValidatedSession()
        {
            PlayerBattleInformationPersistanceStateless persistance = GetSession();
		...
		private PlayerBattleInformationPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : PlayerBattleInformation
        {
