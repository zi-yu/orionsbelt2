...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class MessagePersistanceStateless : 
			NHibernatePersistanceStateless<Message>, IMessagePersistance {
	
		#region Static Access
		
		internal static MessagePersistanceStateless CreateSession()
		{
			return new MessagePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedMessage) );
		}
				
		internal static MessagePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			MessagePersistanceStateless persistance = new MessagePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedMessage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static MessagePersistanceStateless globalSession = null;
        internal static MessagePersistanceStateless GlobalSession {
            get {
		...
		internal static MessagePersistanceStateless GetSession()
		{
		...
		internal static MessagePersistanceStateless GetValidatedSession()
        {
            MessagePersistanceStateless persistance = GetSession();
		...
		private MessagePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Message
        {
