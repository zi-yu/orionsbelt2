...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class BonusCardPersistanceStateless : 
			NHibernatePersistanceStateless<BonusCard>, IBonusCardPersistance {
	
		#region Static Access
		
		internal static BonusCardPersistanceStateless CreateSession()
		{
			return new BonusCardPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedBonusCard) );
		}
				
		internal static BonusCardPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			BonusCardPersistanceStateless persistance = new BonusCardPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedBonusCard) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static BonusCardPersistanceStateless globalSession = null;
        internal static BonusCardPersistanceStateless GlobalSession {
            get {
		...
		internal static BonusCardPersistanceStateless GetSession()
		{
		...
		internal static BonusCardPersistanceStateless GetValidatedSession()
        {
            BonusCardPersistanceStateless persistance = GetSession();
		...
		private BonusCardPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : BonusCard
        {
