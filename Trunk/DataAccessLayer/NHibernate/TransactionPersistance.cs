...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class TransactionPersistance : 
			NHibernatePersistance<Transaction>, ITransactionPersistance {
	
		#region Static Access
		
		internal static TransactionPersistance CreateSession()
		{
			return new TransactionPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedTransaction) );
		}
				
		internal static TransactionPersistance AttachSession( IPersistanceSession owner )
		{
			TransactionPersistance persistance = new TransactionPersistance ( owner.Session as ISession, typeof(SpecializedTransaction) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static TransactionPersistance globalSession = null;
        internal static TransactionPersistance GlobalSession {
            get {
		...
		internal static TransactionPersistance GetSession()
		{
		...
		internal static TransactionPersistance GetValidatedSession()
        {
            TransactionPersistance persistance = GetSession();
		...
		private TransactionPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : Transaction
        {
