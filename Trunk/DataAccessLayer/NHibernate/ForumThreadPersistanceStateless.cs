...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class ForumThreadPersistanceStateless : 
			NHibernatePersistanceStateless<ForumThread>, IForumThreadPersistance {
	
		#region Static Access
		
		internal static ForumThreadPersistanceStateless CreateSession()
		{
			return new ForumThreadPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedForumThread) );
		}
				
		internal static ForumThreadPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			ForumThreadPersistanceStateless persistance = new ForumThreadPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedForumThread) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static ForumThreadPersistanceStateless globalSession = null;
        internal static ForumThreadPersistanceStateless GlobalSession {
            get {
		...
		internal static ForumThreadPersistanceStateless GetSession()
		{
		...
		internal static ForumThreadPersistanceStateless GetValidatedSession()
        {
            ForumThreadPersistanceStateless persistance = GetSession();
		...
		private ForumThreadPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : ForumThread
        {
