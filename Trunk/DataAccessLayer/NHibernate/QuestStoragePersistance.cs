...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class QuestStoragePersistance : 
			NHibernatePersistance<QuestStorage>, IQuestStoragePersistance {
	
		#region Static Access
		
		internal static QuestStoragePersistance CreateSession()
		{
			return new QuestStoragePersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedQuestStorage) );
		}
				
		internal static QuestStoragePersistance AttachSession( IPersistanceSession owner )
		{
			QuestStoragePersistance persistance = new QuestStoragePersistance ( owner.Session as ISession, typeof(SpecializedQuestStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static QuestStoragePersistance globalSession = null;
        internal static QuestStoragePersistance GlobalSession {
            get {
		...
		internal static QuestStoragePersistance GetSession()
		{
		...
		internal static QuestStoragePersistance GetValidatedSession()
        {
            QuestStoragePersistance persistance = GetSession();
		...
		private QuestStoragePersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : QuestStorage
        {
