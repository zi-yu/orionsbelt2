...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class LogStoragePersistanceStateless : 
			NHibernatePersistanceStateless<LogStorage>, ILogStoragePersistance {
	
		#region Static Access
		
		internal static LogStoragePersistanceStateless CreateSession()
		{
			return new LogStoragePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedLogStorage) );
		}
				
		internal static LogStoragePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			LogStoragePersistanceStateless persistance = new LogStoragePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedLogStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static LogStoragePersistanceStateless globalSession = null;
        internal static LogStoragePersistanceStateless GlobalSession {
            get {
		...
		internal static LogStoragePersistanceStateless GetSession()
		{
		...
		internal static LogStoragePersistanceStateless GetValidatedSession()
        {
            LogStoragePersistanceStateless persistance = GetSession();
		...
		private LogStoragePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : LogStorage
        {
