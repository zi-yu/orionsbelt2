...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class TaskPersistanceStateless : 
			NHibernatePersistanceStateless<Task>, ITaskPersistance {
	
		#region Static Access
		
		internal static TaskPersistanceStateless CreateSession()
		{
			return new TaskPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedTask) );
		}
				
		internal static TaskPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			TaskPersistanceStateless persistance = new TaskPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedTask) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static TaskPersistanceStateless globalSession = null;
        internal static TaskPersistanceStateless GlobalSession {
            get {
		...
		internal static TaskPersistanceStateless GetSession()
		{
		...
		internal static TaskPersistanceStateless GetValidatedSession()
        {
            TaskPersistanceStateless persistance = GetSession();
		...
		private TaskPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Task
        {
