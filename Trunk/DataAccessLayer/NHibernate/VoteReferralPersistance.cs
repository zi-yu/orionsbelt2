...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class VoteReferralPersistance : 
			NHibernatePersistance<VoteReferral>, IVoteReferralPersistance {
	
		#region Static Access
		
		internal static VoteReferralPersistance CreateSession()
		{
			return new VoteReferralPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedVoteReferral) );
		}
				
		internal static VoteReferralPersistance AttachSession( IPersistanceSession owner )
		{
			VoteReferralPersistance persistance = new VoteReferralPersistance ( owner.Session as ISession, typeof(SpecializedVoteReferral) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static VoteReferralPersistance globalSession = null;
        internal static VoteReferralPersistance GlobalSession {
            get {
		...
		internal static VoteReferralPersistance GetSession()
		{
		...
		internal static VoteReferralPersistance GetValidatedSession()
        {
            VoteReferralPersistance persistance = GetSession();
		...
		private VoteReferralPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : VoteReferral
        {
