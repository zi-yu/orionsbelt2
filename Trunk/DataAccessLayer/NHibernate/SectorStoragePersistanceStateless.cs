...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class SectorStoragePersistanceStateless : 
			NHibernatePersistanceStateless<SectorStorage>, ISectorStoragePersistance {
	
		#region Static Access
		
		internal static SectorStoragePersistanceStateless CreateSession()
		{
			return new SectorStoragePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedSectorStorage) );
		}
				
		internal static SectorStoragePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			SectorStoragePersistanceStateless persistance = new SectorStoragePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedSectorStorage) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static SectorStoragePersistanceStateless globalSession = null;
        internal static SectorStoragePersistanceStateless GlobalSession {
            get {
		...
		internal static SectorStoragePersistanceStateless GetSession()
		{
		...
		internal static SectorStoragePersistanceStateless GetValidatedSession()
        {
            SectorStoragePersistanceStateless persistance = GetSession();
		...
		private SectorStoragePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : SectorStorage
        {
