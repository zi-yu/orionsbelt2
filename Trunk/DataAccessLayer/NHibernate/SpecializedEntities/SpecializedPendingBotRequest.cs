...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Specialized NHibernate class for PendingBotRequest
    /// </summary>
	public class SpecializedPendingBotRequest : PendingBotRequest {
		...
		#region PendingBotRequest Implementation
	
		#endregion PendingBotRequest Implementation
