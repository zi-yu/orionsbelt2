...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Specialized NHibernate class for GlobalStats
    /// </summary>
	public class SpecializedGlobalStats : GlobalStats {
		...
		#region GlobalStats Implementation
	
		#endregion GlobalStats Implementation
