...
namespace OrionsBelt.DataAccessLayer {
	...
	/// <summary>
    /// Specialized NHibernate class for WormHolePlayers
    /// </summary>
	public class SpecializedWormHolePlayers : WormHolePlayers {
		...
		#region WormHolePlayers Implementation
	
		#endregion WormHolePlayers Implementation
