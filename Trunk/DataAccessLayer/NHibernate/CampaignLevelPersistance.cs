...
namespace OrionsBelt.DataAccessLayer {
	...
	internal class CampaignLevelPersistance : 
			NHibernatePersistance<CampaignLevel>, ICampaignLevelPersistance {
	
		#region Static Access
		
		internal static CampaignLevelPersistance CreateSession()
		{
			return new CampaignLevelPersistance ( NHibernateUtilities.OpenSession, typeof(SpecializedCampaignLevel) );
		}
				
		internal static CampaignLevelPersistance AttachSession( IPersistanceSession owner )
		{
			CampaignLevelPersistance persistance = new CampaignLevelPersistance ( owner.Session as ISession, typeof(SpecializedCampaignLevel) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static CampaignLevelPersistance globalSession = null;
        internal static CampaignLevelPersistance GlobalSession {
            get {
		...
		internal static CampaignLevelPersistance GetSession()
		{
		...
		internal static CampaignLevelPersistance GetValidatedSession()
        {
            CampaignLevelPersistance persistance = GetSession();
		...
		private CampaignLevelPersistance ( ISession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistance<T> owner ) where T : CampaignLevel
        {
