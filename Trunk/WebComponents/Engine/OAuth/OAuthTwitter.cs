...
namespace OrionsBelt.WebComponents {
    ...
    public class OAuthTwitter : OAuthBase {
        ...
        public string GetAuthorizationLink()
        {
            ...
            if (response.Length > 0) {
                ...
                if (qs["oauth_token"] != null) {
                    ...
                    ret += string.Format("&oauth_callback=http://{0}/Auth/TwitterCallback.ashx", HttpContext.Current.Request.Url.Authority);
                }
            }
            return ret;
        }
        ...
        public string WebRequest(Method method, string url, string postData)
        {
            ...
            webRequest.UserAgent  = HttpContext.Current.Request.Url.Authority;
