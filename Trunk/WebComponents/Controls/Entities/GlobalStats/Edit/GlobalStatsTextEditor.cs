...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Text of the GlobalStats entity
    /// </summary>
	public class GlobalStatsTextEditor : 
					StringEditor<GlobalStats>, INamingContainer {
		...
		protected override string GetCaption( GlobalStats entity )
		{
			return entity.Text;
		}
		...
		public override void Update( GlobalStats entity )
		{
			if( !Secret ) {
				...
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Text = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_text", ID); }
		}
