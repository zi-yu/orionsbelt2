...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Fleet's Arena
    /// </summary>
	public class FleetArena : BaseFieldControl<Fleet>, INamingContainer {
		...
		{
			list.Where = "e.FleetNHibernate.Id = " + entity.Id;
