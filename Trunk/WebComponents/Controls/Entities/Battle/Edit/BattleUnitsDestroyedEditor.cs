...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the UnitsDestroyed of the Battle entity
    /// </summary>
	public class BattleUnitsDestroyedEditor : 
					StringEditor<Battle>, INamingContainer {
		...
		protected override string GetCaption( Battle entity )
		{
			return entity.UnitsDestroyed;
		}
		...
		{
			if( !Secret ) {
				entity.UnitsDestroyed = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.UnitsDestroyed = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_unitsDestroyed", ID); }
		}
