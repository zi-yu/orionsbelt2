...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CurrentBot of the Battle entity
    /// </summary>
	public class BattleCurrentBotEditor : 
		...
		public override void Update( Battle entity )
		{
			...
			entity.CurrentBot = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_currentBot", ID); }
		}
