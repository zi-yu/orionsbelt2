...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a collection of Battle 
    /// </summary>
	public class BattleList : BaseList<Battle> {
	
		#region Abstract Members
		
		/// <summary>
        /// Gets the Battle collection
        /// </summary>
        /// <returns>The collection</returns>
		protected override IList<Battle> GetCollection()
		{
		...
		#region BaseList<Battle> Implementation
		...
		#endregion BaseList<Battle> Implementation
