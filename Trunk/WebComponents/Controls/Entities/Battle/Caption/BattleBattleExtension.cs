...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Battle's BattleExtension
    /// </summary>
	public class BattleBattleExtension : BaseFieldControl<Battle>, INamingContainer {
	
		#region BaseFieldControl<Battle> Implementation
		
		private BattleExtentionPagedList list = new BattleExtentionPagedList ();
