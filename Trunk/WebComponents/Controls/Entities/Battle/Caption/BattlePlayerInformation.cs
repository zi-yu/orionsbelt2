...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Battle's PlayerInformation
    /// </summary>
	public class BattlePlayerInformation : BaseFieldControl<Battle>, INamingContainer {
	
		#region BaseFieldControl<Battle> Implementation
		
		private PlayerBattleInformationPagedList list = new PlayerBattleInformationPagedList ();
		...
		{
			list.Where = "e.BattleNHibernate.Id = " + entity.Id;
