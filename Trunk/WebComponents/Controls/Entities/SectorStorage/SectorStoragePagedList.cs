...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a paged collection of SectorStorage 
    /// </summary>
	public class SectorStoragePagedList : BasePagedList<SectorStorage> {
		
		#region BasePagedList<SectorStorage> Implementation
		
		/// <summary>
        /// The current persistance object
        /// </summary>
		protected override IPersistance<SectorStorage> Persistance {
			get { 
				return OrionsBelt.DataAccessLayer.Persistance.Instance.GetSectorStoragePersistance ();
			}
		}
		...
		#endregion BasePagedList<SectorStorage> Implementation
