...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the AdditionalInformation of the SectorStorage entity
    /// </summary>
	public class SectorStorageAdditionalInformationEditor : 
					StringEditor<SectorStorage>, INamingContainer {
		...
		protected override string GetCaption( SectorStorage entity )
		{
			return entity.AdditionalInformation;
		}
		...
		{
			if( !Secret ) {
				entity.AdditionalInformation = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.AdditionalInformation = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_additionalInformation", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,1000}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 1000);
		}
