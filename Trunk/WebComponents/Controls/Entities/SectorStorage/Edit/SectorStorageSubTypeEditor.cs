...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the SubType of the SectorStorage entity
    /// </summary>
	public class SectorStorageSubTypeEditor : 
		...
		{
			if( !Secret ) {
				entity.SubType = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.SubType = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_subType", ID); }
		}
