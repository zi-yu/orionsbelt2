...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the SpecialSectores of the SectorStorage entity
    /// </summary>
	public class SectorStorageSpecialSectoresEditor : 
			UniverseSpecialSectorItem, IEntityFieldEditor<SectorStorage>, INamingContainer {
