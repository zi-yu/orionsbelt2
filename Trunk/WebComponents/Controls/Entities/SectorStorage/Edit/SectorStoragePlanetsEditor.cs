...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Planets of the SectorStorage entity
    /// </summary>
	public class SectorStoragePlanetsEditor : 
			PlanetStorageItem, IEntityFieldEditor<SectorStorage>, INamingContainer {
