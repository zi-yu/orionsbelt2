...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class AuctionHouseBids : BaseFieldControl<AuctionHouse>, INamingContainer {
	
		#region BaseFieldControl<AuctionHouse> Implementation
		
		private BidHistoricalPagedList list = new BidHistoricalPagedList ();
		...
		{
			list.Where = "e.ResourceNHibernate.Id = " + entity.Id;
