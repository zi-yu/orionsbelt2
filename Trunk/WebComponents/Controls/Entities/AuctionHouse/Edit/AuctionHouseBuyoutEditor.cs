...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Buyout of the AuctionHouse entity
    /// </summary>
	public class AuctionHouseBuyoutEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_buyout", ID); }
		}
