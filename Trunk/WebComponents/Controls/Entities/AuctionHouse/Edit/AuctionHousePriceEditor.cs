...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Price of the AuctionHouse entity
    /// </summary>
	public class AuctionHousePriceEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_price", ID); }
		}
