...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Timeout of the AuctionHouse entity
    /// </summary>
	public class AuctionHouseTimeoutEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_timeout", ID); }
		}
