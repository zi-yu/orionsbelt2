...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the BuyedInTick of the AuctionHouse entity
    /// </summary>
	public class AuctionHouseBuyedInTickEditor : 
		...
		public override void Update( AuctionHouse entity )
		{
			...
			entity.BuyedInTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_buyedInTick", ID); }
		}
