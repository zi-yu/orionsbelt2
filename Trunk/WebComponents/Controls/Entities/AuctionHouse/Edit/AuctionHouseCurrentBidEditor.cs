...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CurrentBid of the AuctionHouse entity
    /// </summary>
	public class AuctionHouseCurrentBidEditor : 
		...
		public override void Update( AuctionHouse entity )
		{
			...
			entity.CurrentBid = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_currentBid", ID); }
		}
