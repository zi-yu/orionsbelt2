...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class MarketProducts : BaseFieldControl<Market>, INamingContainer {
	
		#region BaseFieldControl<Market> Implementation
		
		private ProductPagedList list = new ProductPagedList ();
		...
		{
			list.Where = "e.MarketNHibernate.Id = " + entity.Id;
