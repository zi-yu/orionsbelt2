...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ConquestTick of the ArenaStorage entity
    /// </summary>
	public class ArenaStorageConquestTickEditor : 
		...
		public override void Update( ArenaStorage entity )
		{
			...
			entity.ConquestTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_conquestTick", ID); }
		}
