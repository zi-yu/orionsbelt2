...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Coordinate of the ArenaStorage entity
    /// </summary>
	public class ArenaStorageCoordinateEditor : 
		...
		{
			if( !Secret ) {
				entity.Coordinate = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Coordinate = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_coordinate", ID); }
		}
