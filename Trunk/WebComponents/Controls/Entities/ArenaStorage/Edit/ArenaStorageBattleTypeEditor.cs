...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the BattleType of the ArenaStorage entity
    /// </summary>
	public class ArenaStorageBattleTypeEditor : 
					StringEditor<ArenaStorage>, INamingContainer {
		...
		protected override string GetCaption( ArenaStorage entity )
		{
			return entity.BattleType;
		}
		...
		{
			if( !Secret ) {
				entity.BattleType = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.BattleType = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_battleType", ID); }
		}
