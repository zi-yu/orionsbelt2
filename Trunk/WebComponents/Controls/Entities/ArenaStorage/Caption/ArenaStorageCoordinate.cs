...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a ArenaStorage's Coordinate
    /// </summary>
	public class ArenaStorageCoordinate : BaseFieldControl<ArenaStorage>, INamingContainer {
		...
		{
			writer.Write( entity.Coordinate );
		}
