...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class ArenaStorageHistorical : BaseFieldControl<ArenaStorage>, INamingContainer {
	
		#region BaseFieldControl<ArenaStorage> Implementation
		
		private ArenaHistoricalPagedList list = new ArenaHistoricalPagedList ();
		...
		{
			list.Where = "e.ArenaNHibernate.Id = " + entity.Id;
