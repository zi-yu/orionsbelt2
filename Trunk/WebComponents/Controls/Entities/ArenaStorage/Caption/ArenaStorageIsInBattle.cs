...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a ArenaStorage's IsInBattle
    /// </summary>
	public class ArenaStorageIsInBattle : BaseFieldControl<ArenaStorage>, INamingContainer {
		...
		{
			writer.Write( entity.IsInBattle );
		}
