...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ExtraInfo of the DuplicateDetection entity
    /// </summary>
	public class DuplicateDetectionExtraInfoEditor : 
					StringEditor<DuplicateDetection>, INamingContainer {
		...
		protected override string GetCaption( DuplicateDetection entity )
		{
			return entity.ExtraInfo;
		}
		...
		{
			if( !Secret ) {
				entity.ExtraInfo = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.ExtraInfo = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_extraInfo", ID); }
		}
