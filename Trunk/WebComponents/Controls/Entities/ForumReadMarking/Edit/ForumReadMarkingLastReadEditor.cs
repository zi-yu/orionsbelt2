...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastRead of the ForumReadMarking entity
    /// </summary>
	public class ForumReadMarkingLastReadEditor : 
		...
		{
			entity.LastRead = new DateTime (Convert.ToInt32(year.SelectedValue),
