...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables ForumReadMarking search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a ForumReadMarkingPagedList
    /// </remarks>
	public class ForumReadMarkingSearch : Control {
	
		#region Control Fields
		
		protected TextBox id = new TextBox();
		protected DropDownList operatorsForId = new DropDownList();
		protected TextBox lastRead = new TextBox();
		protected DropDownList operatorsForLastRead = new DropDownList();
		...
		/// <summary>
        /// Search box for ForumReadMarking's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for ForumReadMarking's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ForumReadMarking's LastRead property
        /// </summary>
		public TextBox LastRead {
			get { return lastRead; }
			set { lastRead = value; }
		}
		
		/// <summary>
        /// Combo box for ForumReadMarking's LastRead operators
        /// </summary>
		public DropDownList OperatorsForLastRead {
			get { return operatorsForLastRead; }
			set { operatorsForLastRead = value; }
		}
		
		/// <summary>
        /// Search box for ForumReadMarking's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for ForumReadMarking's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ForumReadMarking's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for ForumReadMarking's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ForumReadMarking's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for ForumReadMarking's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty( LastRead.Text ) ) {
					writer.Write( "{2} e.LastRead {0} '{1}' ",
							operatorsForLastRead.SelectedValue, 
							LastRead.Text, first ? "" : ","
						);
					first = false;
				}
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<ForumReadMarking>.GetWhereKey("ForumReadMarking")] = writer.ToString();
				}
			}
		}
		...
		protected override void CreateChildControls()
        {
			...
			LastRead.ID = "searchLastRead";
			Controls.Add( new LiteralControl("<tr>") );
			Controls.Add( new LiteralControl("<td><b>LastRead</b></td><td>") );
			Controls.Add( AddOperators( OperatorsForLastRead ) );
			Controls.Add( new LiteralControl("</td><td>") );
			Controls.Add( LastRead );
			Controls.Add( new LiteralControl("</td><tr>") );
