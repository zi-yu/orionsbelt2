...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the WinScore of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationWinScoreEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_winScore", ID); }
		}
