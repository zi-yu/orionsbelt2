...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CreatedDate of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationCreatedDateEditor : 
				DateTimeEditor<PlayerBattleInformation>, INamingContainer {
		...
		protected override DateTime GetDateTime( PlayerBattleInformation entity )
		{
