...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Timeouts of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationTimeoutsEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_timeouts", ID); }
		}
