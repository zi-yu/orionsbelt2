...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the VictoryPercentage of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationVictoryPercentageEditor : 
		...
		{
			return entity.VictoryPercentage;
		}
		...
		public override void Update( PlayerBattleInformation entity )
		{
			...
			entity.VictoryPercentage = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_victoryPercentage", ID); }
		}
