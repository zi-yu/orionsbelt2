...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the DominationPoints of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationDominationPointsEditor : 
		...
		{
			return entity.DominationPoints;
		}
		...
		public override void Update( PlayerBattleInformation entity )
		{
			...
			entity.DominationPoints = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_dominationPoints", ID); }
		}
