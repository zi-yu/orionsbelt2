...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TeamNumber of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationTeamNumberEditor : 
		...
		public override void Update( PlayerBattleInformation entity )
		{
			...
			entity.TeamNumber = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_teamNumber", ID); }
		}
