...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LoseScore of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationLoseScoreEditor : 
		...
		public override void Update( PlayerBattleInformation entity )
		{
			...
			entity.LoseScore = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_loseScore", ID); }
		}
