...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the UltimateUnit of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationUltimateUnitEditor : 
		...
		{
			if( !Secret ) {
				entity.UltimateUnit = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.UltimateUnit = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_ultimateUnit", ID); }
		}
