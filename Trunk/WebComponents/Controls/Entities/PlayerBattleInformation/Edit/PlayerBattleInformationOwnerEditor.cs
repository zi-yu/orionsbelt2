...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Owner of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationOwnerEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_owner", ID); }
		}
