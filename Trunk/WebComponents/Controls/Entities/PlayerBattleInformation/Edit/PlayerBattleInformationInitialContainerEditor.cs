...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the InitialContainer of the PlayerBattleInformation entity
    /// </summary>
	public class PlayerBattleInformationInitialContainerEditor : 
					StringEditor<PlayerBattleInformation>, INamingContainer {
		...
		protected override string GetCaption( PlayerBattleInformation entity )
		{
			return entity.InitialContainer;
		}
		...
		{
			if( !Secret ) {
				entity.InitialContainer = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.InitialContainer = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_initialContainer", ID); }
		}
