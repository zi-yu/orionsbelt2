...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a collection of PlayerBattleInformation 
    /// </summary>
	public class PlayerBattleInformationList : BaseList<PlayerBattleInformation> {
	
		#region Abstract Members
		
		/// <summary>
        /// Gets the PlayerBattleInformation collection
        /// </summary>
        /// <returns>The collection</returns>
		protected override IList<PlayerBattleInformation> GetCollection()
		{
		...
		#region BaseList<PlayerBattleInformation> Implementation
		...
		#endregion BaseList<PlayerBattleInformation> Implementation
