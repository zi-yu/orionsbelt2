...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ExceptionInformation of the LogStorage entity
    /// </summary>
	public class LogStorageExceptionInformationEditor : 
		...
		{
			return entity.ExceptionInformation;
		}
		...
		{
			if( !Secret ) {
				entity.ExceptionInformation = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.ExceptionInformation = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_exceptionInformation", ID); }
		}
