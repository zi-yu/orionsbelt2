...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Username1 of the LogStorage entity
    /// </summary>
	public class LogStorageUsername1Editor : 
		...
		{
			if( !Secret ) {
				entity.Username1 = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Username1 = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_username1", ID); }
		}
