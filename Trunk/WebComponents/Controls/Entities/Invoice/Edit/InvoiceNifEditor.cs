...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Nif of the Invoice entity
    /// </summary>
	public class InvoiceNifEditor : 
		...
		public override void Update( Invoice entity )
		{
			if( !Secret ) {
				...
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Nif = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_nif", ID); }
		}
