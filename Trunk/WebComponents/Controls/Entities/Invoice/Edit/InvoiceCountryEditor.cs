...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Country of the Invoice entity
    /// </summary>
	public class InvoiceCountryEditor : 
		...
		{
			if( !Secret ) {
				entity.Country = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Country = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_country", ID); }
		}
