...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Name of the Product entity
    /// </summary>
	public class ProductNameEditor : 
					StringEditor<Product>, INamingContainer {
		...
		protected override string GetCaption( Product entity )
		{
			return entity.Name;
		}
