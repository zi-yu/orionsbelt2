...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Owner of the ForumPost entity
    /// </summary>
	public class ForumPostOwnerEditor : 
			PlayerStorageItem, IEntityFieldEditor<ForumPost>, INamingContainer {
