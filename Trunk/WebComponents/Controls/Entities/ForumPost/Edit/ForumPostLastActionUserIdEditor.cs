...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastActionUserId of the ForumPost entity
    /// </summary>
	public class ForumPostLastActionUserIdEditor : 
				IntEditor<ForumPost>, INamingContainer {
        ...
        /// </summary>
        /// <param name="entity">The ForumPost</param>
        /// <returns>The value</returns>
		protected override int GetNumber( ForumPost entity )
		{
