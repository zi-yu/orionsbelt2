...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Text of the ForumPost entity
    /// </summary>
	public class ForumPostTextEditor : 
					StringEditor<ForumPost>, INamingContainer {
		...
		protected override string GetCaption( ForumPost entity )
		{
			return entity.Text;
		}
