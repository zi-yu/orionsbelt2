...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ForumRoles of the ForumTopic entity
    /// </summary>
	public class ForumTopicForumRolesEditor : 
		...
		{
			if( !Secret ) {
				entity.ForumRoles = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.ForumRoles = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_forumRoles", ID); }
		}
