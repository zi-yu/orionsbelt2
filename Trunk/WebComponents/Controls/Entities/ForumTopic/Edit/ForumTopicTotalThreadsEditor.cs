...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TotalThreads of the ForumTopic entity
    /// </summary>
	public class ForumTopicTotalThreadsEditor : 
		...
		public override void Update( ForumTopic entity )
		{
			...
			entity.TotalThreads = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_totalThreads", ID); }
		}
