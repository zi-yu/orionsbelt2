...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Description of the ForumTopic entity
    /// </summary>
	public class ForumTopicDescriptionEditor : 
					StringEditor<ForumTopic>, INamingContainer {
		...
		protected override string GetCaption( ForumTopic entity )
		{
