...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastActionUserId of the Task entity
    /// </summary>
	public class TaskLastActionUserIdEditor : 
				IntEditor<Task>, INamingContainer {
        ...
        /// </summary>
        /// <param name="entity">The Task</param>
        /// <returns>The value</returns>
		protected override int GetNumber( Task entity )
		{
