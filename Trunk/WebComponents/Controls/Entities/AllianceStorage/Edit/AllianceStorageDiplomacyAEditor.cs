...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the DiplomacyA of the AllianceStorage entity
    /// </summary>
	public class AllianceStorageDiplomacyAEditor : 
		...
		{
			// OneToMany
			System.Collections.Generic.IList<AllianceDiplomacy> list = entity.DiplomacyA;
			list.Add(Current);
		}
