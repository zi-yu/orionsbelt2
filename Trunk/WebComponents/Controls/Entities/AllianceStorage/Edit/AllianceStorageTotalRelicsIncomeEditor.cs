...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TotalRelicsIncome of the AllianceStorage entity
    /// </summary>
	public class AllianceStorageTotalRelicsIncomeEditor : 
		...
		{
			return entity.TotalRelicsIncome;
		}
		...
		public override void Update( AllianceStorage entity )
		{
			...
			entity.TotalRelicsIncome = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_totalRelicsIncome", ID); }
		}
