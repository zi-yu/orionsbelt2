...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TotalRelics of the AllianceStorage entity
    /// </summary>
	public class AllianceStorageTotalRelicsEditor : 
		...
		public override void Update( AllianceStorage entity )
		{
			...
			entity.TotalRelics = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_totalRelics", ID); }
		}
