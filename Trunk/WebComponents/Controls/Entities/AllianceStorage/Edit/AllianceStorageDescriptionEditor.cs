...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Description of the AllianceStorage entity
    /// </summary>
	public class AllianceStorageDescriptionEditor : 
					StringEditor<AllianceStorage>, INamingContainer {
		...
		protected override string GetCaption( AllianceStorage entity )
		{
