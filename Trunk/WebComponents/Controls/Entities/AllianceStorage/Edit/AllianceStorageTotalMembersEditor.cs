...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TotalMembers of the AllianceStorage entity
    /// </summary>
	public class AllianceStorageTotalMembersEditor : 
		...
		public override void Update( AllianceStorage entity )
		{
			...
			entity.TotalMembers = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_totalMembers", ID); }
		}
