...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a paged collection of AllianceStorage 
    /// </summary>
	public class AllianceStoragePagedList : BasePagedList<AllianceStorage> {
		
		#region BasePagedList<AllianceStorage> Implementation
		
		/// <summary>
        /// The current persistance object
        /// </summary>
		protected override IPersistance<AllianceStorage> Persistance {
			get { 
				return OrionsBelt.DataAccessLayer.Persistance.Instance.GetAllianceStoragePersistance ();
			}
		}
		...
		#endregion BasePagedList<AllianceStorage> Implementation
