...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a AllianceStorage's Score
    /// </summary>
	public class AllianceStorageScore : BaseFieldControl<AllianceStorage>, INamingContainer {
