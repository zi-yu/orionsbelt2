...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a AllianceStorage's Sector
    /// </summary>
	public class AllianceStorageSector : BaseFieldControl<AllianceStorage>, INamingContainer {
	
		#region BaseFieldControl<AllianceStorage> Implementation
		
		private SectorStoragePagedList list = new SectorStoragePagedList ();
		...
		{
			list.Where = "e.AllianceNHibernate.Id = " + entity.Id;
