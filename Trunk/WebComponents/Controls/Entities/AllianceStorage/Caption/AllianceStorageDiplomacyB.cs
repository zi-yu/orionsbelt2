...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a AllianceStorage's DiplomacyB
    /// </summary>
	public class AllianceStorageDiplomacyB : BaseFieldControl<AllianceStorage>, INamingContainer {
	
		#region BaseFieldControl<AllianceStorage> Implementation
		
		private AllianceDiplomacyPagedList list = new AllianceDiplomacyPagedList ();
		...
		{
			list.Where = "e.AllianceBNHibernate.Id = " + entity.Id;
