...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables Asset search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a AssetPagedList
    /// </remarks>
	public class AssetSearch : Control {
		...
		/// <summary>
        /// Search box for Asset's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for Asset's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Asset's Type property
        /// </summary>
		public TextBox Type {
			get { return type; }
			set { type = value; }
		...
		/// <summary>
        /// Combo box for Asset's Type operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Asset's Description property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Asset's Description operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Asset's Coordinate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Asset's Coordinate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Asset's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Asset's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Asset's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Asset's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Asset's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Asset's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<Asset>.GetWhereKey("Asset")] = writer.ToString();
				}
			}
		}
