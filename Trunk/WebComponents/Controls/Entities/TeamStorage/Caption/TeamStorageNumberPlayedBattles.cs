...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a TeamStorage's NumberPlayedBattles
    /// </summary>
	public class TeamStorageNumberPlayedBattles : BaseFieldControl<TeamStorage>, INamingContainer {
		...
		{
			writer.Write( entity.NumberPlayedBattles );
		}
