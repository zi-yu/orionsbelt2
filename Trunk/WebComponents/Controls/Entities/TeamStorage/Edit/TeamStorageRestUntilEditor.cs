...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the RestUntil of the TeamStorage entity
    /// </summary>
	public class TeamStorageRestUntilEditor : 
		...
		public override void Update( TeamStorage entity )
		{
			...
			entity.RestUntil = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_restUntil", ID); }
		}
