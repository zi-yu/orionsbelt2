...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Name of the TeamStorage entity
    /// </summary>
	public class TeamStorageNameEditor : 
					StringEditor<TeamStorage>, INamingContainer {
		...
		protected override string GetCaption( TeamStorage entity )
		{
			return entity.Name;
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,450}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 450);
		}
