...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the EloRanking of the TeamStorage entity
    /// </summary>
	public class TeamStorageEloRankingEditor : 
		...
		public override void Update( TeamStorage entity )
		{
			...
			entity.EloRanking = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_eloRanking", ID); }
		}
