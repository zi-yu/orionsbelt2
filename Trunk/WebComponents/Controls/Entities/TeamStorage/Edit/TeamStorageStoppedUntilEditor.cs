...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the StoppedUntil of the TeamStorage entity
    /// </summary>
	public class TeamStorageStoppedUntilEditor : 
		...
		public override void Update( TeamStorage entity )
		{
			...
			entity.StoppedUntil = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_stoppedUntil", ID); }
		}
