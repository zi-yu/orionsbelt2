...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LadderPosition of the TeamStorage entity
    /// </summary>
	public class TeamStorageLadderPositionEditor : 
		...
		public override void Update( TeamStorage entity )
		{
			...
			entity.LadderPosition = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_ladderPosition", ID); }
		}
