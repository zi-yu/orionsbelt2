...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a collection of TeamStorage 
    /// </summary>
	public class TeamStorageList : BaseList<TeamStorage> {
	
		#region Abstract Members
		
		/// <summary>
        /// Gets the TeamStorage collection
        /// </summary>
        /// <returns>The collection</returns>
		protected override IList<TeamStorage> GetCollection()
		{
		...
		#region BaseList<TeamStorage> Implementation
		...
		#endregion BaseList<TeamStorage> Implementation
