...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PromotionType of the Promotion entity
    /// </summary>
	public class PromotionPromotionTypeEditor : 
		...
		{
			if( !Secret ) {
				entity.PromotionType = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.PromotionType = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_promotionType", ID); }
		}
