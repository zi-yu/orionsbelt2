...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the RangeBegin of the Promotion entity
    /// </summary>
	public class PromotionRangeBeginEditor : 
		...
		public override void Update( Promotion entity )
		{
			...
			entity.RangeBegin = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_rangeBegin", ID); }
		}
