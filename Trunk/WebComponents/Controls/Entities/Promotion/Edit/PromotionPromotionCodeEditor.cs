...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PromotionCode of the Promotion entity
    /// </summary>
	public class PromotionPromotionCodeEditor : 
		...
		public override void Update( Promotion entity )
		{
			...
			entity.PromotionCode = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_promotionCode", ID); }
		}
