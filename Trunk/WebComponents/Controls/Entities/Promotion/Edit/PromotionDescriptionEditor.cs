...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Description of the Promotion entity
    /// </summary>
	public class PromotionDescriptionEditor : 
					StringEditor<Promotion>, INamingContainer {
		...
		protected override string GetCaption( Promotion entity )
		{
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,500}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 500);
		}
