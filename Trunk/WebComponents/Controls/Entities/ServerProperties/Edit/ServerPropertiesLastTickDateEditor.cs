...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastTickDate of the ServerProperties entity
    /// </summary>
	public class ServerPropertiesLastTickDateEditor : 
		...
		{
			entity.LastTickDate = new DateTime (Convert.ToInt32(year.SelectedValue),
