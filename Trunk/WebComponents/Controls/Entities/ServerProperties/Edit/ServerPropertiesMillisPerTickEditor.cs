...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the MillisPerTick of the ServerProperties entity
    /// </summary>
	public class ServerPropertiesMillisPerTickEditor : 
		...
		public override void Update( ServerProperties entity )
		{
			...
			entity.MillisPerTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_millisPerTick", ID); }
		}
