...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CurrentTick of the ServerProperties entity
    /// </summary>
	public class ServerPropertiesCurrentTickEditor : 
		...
		public override void Update( ServerProperties entity )
		{
			...
			entity.CurrentTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_currentTick", ID); }
		}
