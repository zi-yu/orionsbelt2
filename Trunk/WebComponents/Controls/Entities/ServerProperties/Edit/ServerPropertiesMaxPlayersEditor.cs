...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the MaxPlayers of the ServerProperties entity
    /// </summary>
	public class ServerPropertiesMaxPlayersEditor : 
		...
		public override void Update( ServerProperties entity )
		{
			...
			entity.MaxPlayers = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_maxPlayers", ID); }
		}
