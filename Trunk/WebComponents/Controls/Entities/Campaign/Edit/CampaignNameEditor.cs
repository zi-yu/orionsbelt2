...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Name of the Campaign entity
    /// </summary>
	public class CampaignNameEditor : 
					StringEditor<Campaign>, INamingContainer {
		...
		protected override string GetCaption( Campaign entity )
		{
			return entity.Name;
		}
