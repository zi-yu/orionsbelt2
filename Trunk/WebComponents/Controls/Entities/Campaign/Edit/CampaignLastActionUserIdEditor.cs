...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastActionUserId of the Campaign entity
    /// </summary>
	public class CampaignLastActionUserIdEditor : 
				IntEditor<Campaign>, INamingContainer {
        ...
        /// </summary>
        /// <param name="entity">The Campaign</param>
        /// <returns>The value</returns>
		protected override int GetNumber( Campaign entity )
		{
