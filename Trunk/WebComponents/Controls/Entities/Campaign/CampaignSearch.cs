...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables Campaign search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a CampaignPagedList
    /// </remarks>
	public class CampaignSearch : Control {
		...
		/// <summary>
        /// Search box for Campaign's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for Campaign's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Campaign's Name property
        /// </summary>
		public TextBox Name {
			get { return name; }
			set { name = value; }
		...
		/// <summary>
        /// Combo box for Campaign's Name operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Campaign's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Campaign's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Campaign's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Campaign's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Campaign's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Campaign's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<Campaign>.GetWhereKey("Campaign")] = writer.ToString();
				}
			}
		}
