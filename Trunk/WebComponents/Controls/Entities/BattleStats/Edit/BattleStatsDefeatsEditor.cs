...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Defeats of the BattleStats entity
    /// </summary>
	public class BattleStatsDefeatsEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_defeats", ID); }
		}
