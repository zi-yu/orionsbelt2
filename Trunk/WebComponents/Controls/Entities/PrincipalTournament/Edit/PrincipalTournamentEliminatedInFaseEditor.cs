...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the EliminatedInFase of the PrincipalTournament entity
    /// </summary>
	public class PrincipalTournamentEliminatedInFaseEditor : 
					StringEditor<PrincipalTournament>, INamingContainer {
		...
		protected override string GetCaption( PrincipalTournament entity )
		{
			return entity.EliminatedInFase;
		}
		...
		{
			if( !Secret ) {
				entity.EliminatedInFase = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.EliminatedInFase = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_eliminatedInFase", ID); }
		}
