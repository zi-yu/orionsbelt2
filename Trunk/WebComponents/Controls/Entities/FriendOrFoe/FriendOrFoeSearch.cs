...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables FriendOrFoe search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a FriendOrFoePagedList
    /// </remarks>
	public class FriendOrFoeSearch : Control {
	
		#region Control Fields
		
		protected TextBox id = new TextBox();
		protected DropDownList operatorsForId = new DropDownList();
		protected TextBox isFriend = new TextBox();
		protected DropDownList operatorsForIsFriend = new DropDownList();
		...
		/// <summary>
        /// Search box for FriendOrFoe's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for FriendOrFoe's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for FriendOrFoe's IsFriend property
        /// </summary>
		public TextBox IsFriend {
			get { return isFriend; }
			set { isFriend = value; }
		}
		
		/// <summary>
        /// Combo box for FriendOrFoe's IsFriend operators
        /// </summary>
		public DropDownList OperatorsForIsFriend {
			get { return operatorsForIsFriend; }
			set { operatorsForIsFriend = value; }
		}
		
		/// <summary>
        /// Search box for FriendOrFoe's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for FriendOrFoe's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for FriendOrFoe's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for FriendOrFoe's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for FriendOrFoe's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for FriendOrFoe's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty( IsFriend.Text ) ) {
					writer.Write( "{2} e.IsFriend {0} '{1}' ",
							operatorsForIsFriend.SelectedValue, 
							IsFriend.Text, first ? "" : ","
						);
					first = false;
				}
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<FriendOrFoe>.GetWhereKey("FriendOrFoe")] = writer.ToString();
				}
			}
		}
		...
		protected override void CreateChildControls()
        {
			...
			IsFriend.ID = "searchIsFriend";
			Controls.Add( new LiteralControl("<tr>") );
			Controls.Add( new LiteralControl("<td><b>IsFriend</b></td><td>") );
			Controls.Add( AddOperators( OperatorsForIsFriend ) );
			Controls.Add( new LiteralControl("</td><td>") );
			Controls.Add( IsFriend );
			Controls.Add( new LiteralControl("</td><tr>") );
