...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class FriendOrFoeTarget : BaseFieldControl<FriendOrFoe>, INamingContainer {
		...
		protected override void Render( HtmlTextWriter writer, FriendOrFoe entity, int renderCount, bool flipFlop )
		{
            ...
            if (!IncludeUrl) {
				string caption = entity.Target.ToString();
                writer.Write( caption );
                return;
            }
			string urlToShow = urlText != string.Empty ? urlText : entity.Target.ToString();
