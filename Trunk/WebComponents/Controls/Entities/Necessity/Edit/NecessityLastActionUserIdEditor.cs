...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastActionUserId of the Necessity entity
    /// </summary>
	public class NecessityLastActionUserIdEditor : 
				IntEditor<Necessity>, INamingContainer {
        ...
        /// </summary>
        /// <param name="entity">The Necessity</param>
        /// <returns>The value</returns>
		protected override int GetNumber( Necessity entity )
		{
