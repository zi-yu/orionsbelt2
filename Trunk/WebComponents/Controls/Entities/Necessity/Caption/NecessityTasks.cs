...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class NecessityTasks : BaseFieldControl<Necessity>, INamingContainer {
	
		#region BaseFieldControl<Necessity> Implementation
		
		private TaskPagedList list = new TaskPagedList ();
		...
		{
			list.Where = "e.NecessityNHibernate.Id = " + entity.Id;
