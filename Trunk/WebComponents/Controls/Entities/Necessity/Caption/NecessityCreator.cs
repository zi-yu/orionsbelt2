...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class NecessityCreator : BaseFieldControl<Necessity>, INamingContainer {
		...
		protected override void Render( HtmlTextWriter writer, Necessity entity, int renderCount, bool flipFlop )
		{
            ...
            if (!IncludeUrl) {
				string caption = entity.Creator.ToString();
                writer.Write( caption );
                return;
            }
			string urlToShow = urlText != string.Empty ? urlText : entity.Creator.ToString();
