...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Response of the Payment entity
    /// </summary>
	public class PaymentResponseEditor : 
		...
		{
			if( !Secret ) {
				entity.Response = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Response = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_response", ID); }
		}
