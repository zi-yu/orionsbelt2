...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class OfferingDonor : BaseFieldControl<Offering>, INamingContainer {
		...
		{
			if ( entity.Donor == null ) {
                return;
            }
            if (!IncludeUrl) {
				string caption = entity.Donor.ToString();
                writer.Write( caption );
                return;
            }
			string urlToShow = urlText != string.Empty ? urlText : entity.Donor.ToString();
