...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Offering's Receiver
    /// </summary>
	public class OfferingReceiver : BaseFieldControl<Offering>, INamingContainer {
		...
		protected override void Render( HtmlTextWriter writer, Offering entity, int renderCount, bool flipFlop )
		{
            ...
            if (!IncludeUrl) {
				string caption = entity.Receiver.ToString();
                writer.Write( caption );
                return;
            }
			string urlToShow = urlText != string.Empty ? urlText : entity.Receiver.ToString();
