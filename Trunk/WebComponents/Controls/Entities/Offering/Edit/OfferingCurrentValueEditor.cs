...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CurrentValue of the Offering entity
    /// </summary>
	public class OfferingCurrentValueEditor : 
		...
		public override void Update( Offering entity )
		{
			...
			entity.CurrentValue = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_currentValue", ID); }
		}
