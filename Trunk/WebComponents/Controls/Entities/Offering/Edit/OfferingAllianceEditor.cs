...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Alliance of the Offering entity
    /// </summary>
	public class OfferingAllianceEditor : 
			AllianceStorageItem, IEntityFieldEditor<Offering>, INamingContainer {
