...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CreatedDate of the BonusCard entity
    /// </summary>
	public class BonusCardCreatedDateEditor : 
				DateTimeEditor<BonusCard>, INamingContainer {
		...
		protected override DateTime GetDateTime( BonusCard entity )
		{
