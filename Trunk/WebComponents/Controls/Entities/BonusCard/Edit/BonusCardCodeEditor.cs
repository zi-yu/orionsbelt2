...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Code of the BonusCard entity
    /// </summary>
	public class BonusCardCodeEditor : 
					StringEditor<BonusCard>, INamingContainer {
		...
		protected override string GetCaption( BonusCard entity )
		{
			return entity.Code;
		}
