...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a BonusCard's UsedBy
    /// </summary>
	public class BonusCardUsedBy : BaseFieldControl<BonusCard>, INamingContainer {
		...
		protected override void Render( HtmlTextWriter writer, BonusCard entity, int renderCount, bool flipFlop )
		{
            ...
            if (!IncludeUrl) {
				string caption = entity.UsedBy.ToString();
                writer.Write( caption );
                return;
            }
			string urlToShow = urlText != string.Empty ? urlText : entity.UsedBy.ToString();
