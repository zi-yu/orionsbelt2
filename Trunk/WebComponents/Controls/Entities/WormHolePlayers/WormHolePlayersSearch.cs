...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables WormHolePlayers search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a WormHolePlayersPagedList
    /// </remarks>
	public class WormHolePlayersSearch : Control {
	
		#region Control Fields
		
		protected TextBox id = new TextBox();
		protected DropDownList operatorsForId = new DropDownList();
		protected TextBox playerCount = new TextBox();
		protected DropDownList operatorsForPlayerCount = new DropDownList();
		...
		/// <summary>
        /// Search box for WormHolePlayers's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for WormHolePlayers's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for WormHolePlayers's PlayerCount property
        /// </summary>
		public TextBox PlayerCount {
			get { return playerCount; }
			set { playerCount = value; }
		}
		
		/// <summary>
        /// Combo box for WormHolePlayers's PlayerCount operators
        /// </summary>
		public DropDownList OperatorsForPlayerCount {
			get { return operatorsForPlayerCount; }
			set { operatorsForPlayerCount = value; }
		}
		
		/// <summary>
        /// Search box for WormHolePlayers's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for WormHolePlayers's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for WormHolePlayers's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for WormHolePlayers's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for WormHolePlayers's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for WormHolePlayers's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty( PlayerCount.Text ) ) {
					writer.Write( "{2} e.PlayerCount {0} '{1}' ",
							operatorsForPlayerCount.SelectedValue, 
							PlayerCount.Text, first ? "" : ","
						);
					first = false;
				}
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<WormHolePlayers>.GetWhereKey("WormHolePlayers")] = writer.ToString();
				}
			}
		}
		...
		protected override void CreateChildControls()
        {
			...
			PlayerCount.ID = "searchPlayerCount";
			Controls.Add( new LiteralControl("<tr>") );
			Controls.Add( new LiteralControl("<td><b>PlayerCount</b></td><td>") );
			Controls.Add( AddOperators( OperatorsForPlayerCount ) );
			Controls.Add( new LiteralControl("</td><td>") );
