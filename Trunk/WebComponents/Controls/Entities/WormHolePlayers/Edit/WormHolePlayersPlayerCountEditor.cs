...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PlayerCount of the WormHolePlayers entity
    /// </summary>
	public class WormHolePlayersPlayerCountEditor : 
		...
		public override void Update( WormHolePlayers entity )
		{
			...
			entity.PlayerCount = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_playerCount", ID); }
		}
