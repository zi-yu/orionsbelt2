...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Name of the ExceptionInfo entity
    /// </summary>
	public class ExceptionInfoNameEditor : 
		...
		protected virtual void AddValidators()
		{
			...
			//req.ErrorMessage = string.Format(Resources.RequiredFieldValidatorToken, Resources.ExceptionInfoNameToken);
