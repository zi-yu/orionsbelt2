...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PrincipalStats's BattleStats
    /// </summary>
	public class PrincipalStatsBattleStats : BaseFieldControl<PrincipalStats>, INamingContainer {
	
		#region BaseFieldControl<PrincipalStats> Implementation
		
		private BattleStatsPagedList list = new BattleStatsPagedList ();
		...
		{
			list.Where = "e.StatsNHibernate.Id = " + entity.Id;
