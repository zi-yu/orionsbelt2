...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the MinElo of the PrincipalStats entity
    /// </summary>
	public class PrincipalStatsMinEloEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_minElo", ID); }
		}
