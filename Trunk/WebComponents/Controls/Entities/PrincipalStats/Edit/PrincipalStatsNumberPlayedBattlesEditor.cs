...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the NumberPlayedBattles of the PrincipalStats entity
    /// </summary>
	public class PrincipalStatsNumberPlayedBattlesEditor : 
		...
		{
			return entity.NumberPlayedBattles;
		}
		...
		public override void Update( PrincipalStats entity )
		{
			...
			entity.NumberPlayedBattles = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_numberPlayedBattles", ID); }
		}
