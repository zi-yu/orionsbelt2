...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the MaxElo of the PrincipalStats entity
    /// </summary>
	public class PrincipalStatsMaxEloEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_maxElo", ID); }
		}
