...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class BidHistoricalMadeBy : BaseFieldControl<BidHistorical>, INamingContainer {
		...
		{
			if ( entity.MadeBy == null ) {
                return;
            }
            if (!IncludeUrl) {
				string caption = entity.MadeBy.ToString();
                writer.Write( caption );
                return;
            }
			string urlToShow = urlText != string.Empty ? urlText : entity.MadeBy.ToString();
