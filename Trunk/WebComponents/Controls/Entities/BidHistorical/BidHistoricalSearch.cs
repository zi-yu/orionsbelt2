...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables BidHistorical search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a BidHistoricalPagedList
    /// </remarks>
	public class BidHistoricalSearch : Control {
		...
		protected DropDownList operatorsForValue = new DropDownList();
		...
		/// <summary>
        /// Search box for BidHistorical's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for BidHistorical's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BidHistorical's Value property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BidHistorical's Value operators
        /// </summary>
		public DropDownList OperatorsForValue {
			get { return operatorsForValue; }
			set { operatorsForValue = value; }
		}
		
		/// <summary>
        /// Search box for BidHistorical's Date property
        /// </summary>
		public TextBox Date {
			get { return date; }
			set { date = value; }
		...
		/// <summary>
        /// Combo box for BidHistorical's Date operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BidHistorical's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BidHistorical's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BidHistorical's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BidHistorical's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BidHistorical's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BidHistorical's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty( Value.Text ) ) {
					writer.Write( "{2} e.Value {0} '{1}' ",
							operatorsForValue.SelectedValue, 
							Value.Text, first ? "" : ","
						);
					first = false;
				}
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<BidHistorical>.GetWhereKey("BidHistorical")] = writer.ToString();
				}
			}
		}
		...
		protected override void CreateChildControls()
        {
			...
			Controls.Add( new LiteralControl("<tr>") );
			Controls.Add( new LiteralControl("<td><b>Value</b></td><td>") );
			Controls.Add( AddOperators( OperatorsForValue ) );
			Controls.Add( new LiteralControl("</td><td>") );
			Controls.Add( Value );
			Controls.Add( new LiteralControl("</td><tr>") );
			Date.ID = "searchDate";
