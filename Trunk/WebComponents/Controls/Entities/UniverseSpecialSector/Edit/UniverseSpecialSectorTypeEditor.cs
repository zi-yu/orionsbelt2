...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Type of the UniverseSpecialSector entity
    /// </summary>
	public class UniverseSpecialSectorTypeEditor : 
					StringEditor<UniverseSpecialSector>, INamingContainer {
		...
		protected override string GetCaption( UniverseSpecialSector entity )
		{
			return entity.Type;
		}
