...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Player of the TimedActionStorage entity
    /// </summary>
	public class TimedActionStoragePlayerEditor : 
			PlayerStorageItem, IEntityFieldEditor<TimedActionStorage>, INamingContainer {
		...
		{
			return "TimedActionStoragePlayer";
		}
