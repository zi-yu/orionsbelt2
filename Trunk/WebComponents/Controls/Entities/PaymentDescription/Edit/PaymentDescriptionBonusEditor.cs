...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Bonus of the PaymentDescription entity
    /// </summary>
	public class PaymentDescriptionBonusEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_bonus", ID); }
		}
