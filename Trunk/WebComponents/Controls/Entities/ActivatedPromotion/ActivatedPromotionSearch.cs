...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables ActivatedPromotion search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a ActivatedPromotionPagedList
    /// </remarks>
	public class ActivatedPromotionSearch : Control {
		...
		/// <summary>
        /// Search box for ActivatedPromotion's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for ActivatedPromotion's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ActivatedPromotion's Used property
        /// </summary>
		public TextBox Used {
			get { return used; }
			set { used = value; }
		...
		/// <summary>
        /// Combo box for ActivatedPromotion's Used operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ActivatedPromotion's Code property
        /// </summary>
		public TextBox Code {
			get { return code; }
			set { code = value; }
		...
		/// <summary>
        /// Combo box for ActivatedPromotion's Code operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ActivatedPromotion's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for ActivatedPromotion's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ActivatedPromotion's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for ActivatedPromotion's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for ActivatedPromotion's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for ActivatedPromotion's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<ActivatedPromotion>.GetWhereKey("ActivatedPromotion")] = writer.ToString();
				}
			}
		}
