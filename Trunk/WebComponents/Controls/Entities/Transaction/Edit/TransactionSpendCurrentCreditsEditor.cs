...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the SpendCurrentCredits of the Transaction entity
    /// </summary>
	public class TransactionSpendCurrentCreditsEditor : 
		...
		{
			return entity.SpendCurrentCredits;
		}
		...
		public override void Update( Transaction entity )
		{
			...
			entity.SpendCurrentCredits = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_spendCurrentCredits", ID); }
		}
