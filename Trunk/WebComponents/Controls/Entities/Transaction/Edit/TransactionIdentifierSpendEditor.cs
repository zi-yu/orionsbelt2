...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the IdentifierSpend of the Transaction entity
    /// </summary>
	public class TransactionIdentifierSpendEditor : 
		...
		public override void Update( Transaction entity )
		{
			...
			entity.IdentifierSpend = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_identifierSpend", ID); }
		}
