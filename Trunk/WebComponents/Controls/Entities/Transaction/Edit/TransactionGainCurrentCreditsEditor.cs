...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the GainCurrentCredits of the Transaction entity
    /// </summary>
	public class TransactionGainCurrentCreditsEditor : 
		...
		{
			return entity.GainCurrentCredits;
		}
		...
		public override void Update( Transaction entity )
		{
			...
			entity.GainCurrentCredits = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_gainCurrentCredits", ID); }
		}
