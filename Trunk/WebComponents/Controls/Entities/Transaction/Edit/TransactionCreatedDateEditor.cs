...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CreatedDate of the Transaction entity
    /// </summary>
	public class TransactionCreatedDateEditor : 
				DateTimeEditor<Transaction>, INamingContainer {
		...
		protected override DateTime GetDateTime( Transaction entity )
		{
