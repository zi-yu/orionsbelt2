...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PrincipalIdSpend of the Transaction entity
    /// </summary>
	public class TransactionPrincipalIdSpendEditor : 
		...
		{
			return entity.PrincipalIdSpend;
		}
		...
		public override void Update( Transaction entity )
		{
			...
			entity.PrincipalIdSpend = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_principalIdSpend", ID); }
		}
