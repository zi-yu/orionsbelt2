...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CreditsGain of the Transaction entity
    /// </summary>
	public class TransactionCreditsGainEditor : 
		...
		public override void Update( Transaction entity )
		{
			...
			entity.CreditsGain = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_creditsGain", ID); }
		}
