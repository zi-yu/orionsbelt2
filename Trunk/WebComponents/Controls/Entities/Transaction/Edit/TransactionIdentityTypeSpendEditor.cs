...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the IdentityTypeSpend of the Transaction entity
    /// </summary>
	public class TransactionIdentityTypeSpendEditor : 
		...
		{
			return entity.IdentityTypeSpend;
		}
		...
		{
			if( !Secret ) {
				entity.IdentityTypeSpend = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.IdentityTypeSpend = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_identityTypeSpend", ID); }
		}
