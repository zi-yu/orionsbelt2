...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the IdentityTypeGain of the Transaction entity
    /// </summary>
	public class TransactionIdentityTypeGainEditor : 
		...
		{
			return entity.IdentityTypeGain;
		}
		...
		{
			if( !Secret ) {
				entity.IdentityTypeGain = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.IdentityTypeGain = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_identityTypeGain", ID); }
		}
