...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the CreditsSpend of the Transaction entity
    /// </summary>
	public class TransactionCreditsSpendEditor : 
		...
		public override void Update( Transaction entity )
		{
			...
			entity.CreditsSpend = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_creditsSpend", ID); }
		}
