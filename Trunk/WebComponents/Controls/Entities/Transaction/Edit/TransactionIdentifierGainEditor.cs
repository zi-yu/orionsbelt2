...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the IdentifierGain of the Transaction entity
    /// </summary>
	public class TransactionIdentifierGainEditor : 
		...
		public override void Update( Transaction entity )
		{
			...
			entity.IdentifierGain = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_identifierGain", ID); }
		}
