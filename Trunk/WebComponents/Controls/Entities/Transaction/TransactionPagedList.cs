...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a paged collection of Transaction 
    /// </summary>
	public class TransactionPagedList : BasePagedList<Transaction> {
		
		#region BasePagedList<Transaction> Implementation
		
		/// <summary>
        /// The current persistance object
        /// </summary>
		protected override IPersistance<Transaction> Persistance {
			get { 
				return OrionsBelt.DataAccessLayer.Persistance.Instance.GetTransactionPersistance ();
			}
		}
		...
		#endregion BasePagedList<Transaction> Implementation
