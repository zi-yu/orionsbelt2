...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Transaction's Invoice
    /// </summary>
	public class TransactionInvoice : BaseFieldControl<Transaction>, INamingContainer {
	
		#region BaseFieldControl<Transaction> Implementation
		
		private InvoicePagedList list = new InvoicePagedList ();
		...
		{
			list.Where = "e.TransactionNHibernate.Id = " + entity.Id;
