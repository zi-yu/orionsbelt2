...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ResponseExtension of the Interaction entity
    /// </summary>
	public class InteractionResponseExtensionEditor : 
		...
		{
			return entity.ResponseExtension;
		}
		...
		{
			if( !Secret ) {
				entity.ResponseExtension = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.ResponseExtension = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_responseExtension", ID); }
		}
