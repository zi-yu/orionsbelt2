...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TargetAditionalData of the Interaction entity
    /// </summary>
	public class InteractionTargetAditionalDataEditor : 
					StringEditor<Interaction>, INamingContainer {
		...
		protected override string GetCaption( Interaction entity )
		{
			return entity.TargetAditionalData;
		}
		...
		{
			if( !Secret ) {
				entity.TargetAditionalData = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.TargetAditionalData = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_targetAditionalData", ID); }
		}
