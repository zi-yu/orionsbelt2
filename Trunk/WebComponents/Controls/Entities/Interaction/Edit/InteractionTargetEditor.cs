...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Target of the Interaction entity
    /// </summary>
	public class InteractionTargetEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_target", ID); }
		}
