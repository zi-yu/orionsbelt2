...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the InteractionContext of the Interaction entity
    /// </summary>
	public class InteractionInteractionContextEditor : 
		...
		{
			return entity.InteractionContext;
		}
		...
		{
			if( !Secret ) {
				entity.InteractionContext = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.InteractionContext = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_interactionContext", ID); }
		}
