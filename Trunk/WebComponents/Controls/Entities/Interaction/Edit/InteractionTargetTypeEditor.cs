...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TargetType of the Interaction entity
    /// </summary>
	public class InteractionTargetTypeEditor : 
		...
		{
			if( !Secret ) {
				entity.TargetType = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.TargetType = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_targetType", ID); }
		}
