...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the SourceType of the Interaction entity
    /// </summary>
	public class InteractionSourceTypeEditor : 
		...
		{
			if( !Secret ) {
				entity.SourceType = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.SourceType = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_sourceType", ID); }
		}
