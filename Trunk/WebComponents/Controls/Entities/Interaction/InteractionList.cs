...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a collection of Interaction 
    /// </summary>
	public class InteractionList : BaseList<Interaction> {
	
		#region Abstract Members
		
		/// <summary>
        /// Gets the Interaction collection
        /// </summary>
        /// <returns>The collection</returns>
		protected override IList<Interaction> GetCollection()
		{
		...
		#region BaseList<Interaction> Implementation
		...
		#endregion BaseList<Interaction> Implementation
