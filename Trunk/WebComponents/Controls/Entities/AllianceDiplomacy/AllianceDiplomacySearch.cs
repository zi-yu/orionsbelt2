...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables AllianceDiplomacy search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a AllianceDiplomacyPagedList
    /// </remarks>
	public class AllianceDiplomacySearch : Control {
		...
		/// <summary>
        /// Search box for AllianceDiplomacy's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for AllianceDiplomacy's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for AllianceDiplomacy's Level property
        /// </summary>
		...
		/// <summary>
        /// Combo box for AllianceDiplomacy's Level operators
        /// </summary>
		...
		/// <summary>
        /// Search box for AllianceDiplomacy's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for AllianceDiplomacy's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for AllianceDiplomacy's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for AllianceDiplomacy's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for AllianceDiplomacy's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for AllianceDiplomacy's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<AllianceDiplomacy>.GetWhereKey("AllianceDiplomacy")] = writer.ToString();
				}
			}
		}
