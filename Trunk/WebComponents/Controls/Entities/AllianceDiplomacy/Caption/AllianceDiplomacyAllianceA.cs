...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class AllianceDiplomacyAllianceA : BaseFieldControl<AllianceDiplomacy>, INamingContainer {
		...
		{
			if ( entity.AllianceA == null ) {
                return;
            }
            if (!IncludeUrl) {
				string caption = entity.AllianceA.ToString();
                writer.Write( caption );
                return;
            }
			string urlToShow = urlText != string.Empty ? urlText : entity.AllianceA.ToString();
