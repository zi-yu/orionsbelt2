...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TickDeadline of the Message entity
    /// </summary>
	public class MessageTickDeadlineEditor : 
		...
		public override void Update( Message entity )
		{
			...
			entity.TickDeadline = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_tickDeadline", ID); }
		}
