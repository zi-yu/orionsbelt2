...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the QuestIntProgress of the QuestStorage entity
    /// </summary>
	public class QuestStorageQuestIntProgressEditor : 
		...
		{
			return entity.QuestIntProgress;
		}
		...
		{
			if( !Secret ) {
				entity.QuestIntProgress = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.QuestIntProgress = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_questIntProgress", ID); }
		}
