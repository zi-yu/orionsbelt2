...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the QuestIntConfig of the QuestStorage entity
    /// </summary>
	public class QuestStorageQuestIntConfigEditor : 
		...
		{
			if( !Secret ) {
				entity.QuestIntConfig = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.QuestIntConfig = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_questIntConfig", ID); }
		}
