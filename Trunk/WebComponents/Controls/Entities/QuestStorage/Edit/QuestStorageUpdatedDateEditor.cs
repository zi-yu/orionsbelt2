...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the UpdatedDate of the QuestStorage entity
    /// </summary>
	public class QuestStorageUpdatedDateEditor : 
				DateTimeEditor<QuestStorage>, INamingContainer {
		...
		protected override DateTime GetDateTime( QuestStorage entity )
		{
