...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the DeadlineTick of the QuestStorage entity
    /// </summary>
	public class QuestStorageDeadlineTickEditor : 
		...
		public override void Update( QuestStorage entity )
		{
			...
			entity.DeadlineTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_deadlineTick", ID); }
		}
