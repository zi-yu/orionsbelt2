...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the QuestStringProgress of the QuestStorage entity
    /// </summary>
	public class QuestStorageQuestStringProgressEditor : 
					StringEditor<QuestStorage>, INamingContainer {
		...
		protected override string GetCaption( QuestStorage entity )
		{
			return entity.QuestStringProgress;
		}
		...
		{
			if( !Secret ) {
				entity.QuestStringProgress = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.QuestStringProgress = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_questStringProgress", ID); }
		}
