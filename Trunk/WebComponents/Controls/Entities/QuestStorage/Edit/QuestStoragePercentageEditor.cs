...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Percentage of the QuestStorage entity
    /// </summary>
	public class QuestStoragePercentageEditor : 
				DoubleEditor<QuestStorage>, INamingContainer {
		...
		protected override double GetNumber( QuestStorage entity )
		{
		...
		public override void Update( QuestStorage entity )
		{
			...
			entity.Percentage = double.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_DoubleEditor_{0}_percentage", ID); }
		}
