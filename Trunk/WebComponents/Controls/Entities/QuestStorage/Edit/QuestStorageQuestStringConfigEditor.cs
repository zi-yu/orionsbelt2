...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the QuestStringConfig of the QuestStorage entity
    /// </summary>
	public class QuestStorageQuestStringConfigEditor : 
		...
		{
			return entity.QuestStringConfig;
		}
		...
		{
			if( !Secret ) {
				entity.QuestStringConfig = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.QuestStringConfig = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_questStringConfig", ID); }
		}
