...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a QuestStorage's Reward
    /// </summary>
	public class QuestStorageReward : BaseFieldControl<QuestStorage>, INamingContainer {
