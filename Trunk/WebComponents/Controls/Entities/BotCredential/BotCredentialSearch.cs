...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables BotCredential search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a BotCredentialPagedList
    /// </remarks>
	public class BotCredentialSearch : Control {
		...
		protected TextBox server = new TextBox();
		protected DropDownList operatorsForServer = new DropDownList();
		protected TextBox verificationCode = new TextBox();
		protected DropDownList operatorsForVerificationCode = new DropDownList();
		...
		/// <summary>
        /// Search box for BotCredential's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for BotCredential's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BotCredential's Name property
        /// </summary>
		public TextBox Name {
			get { return name; }
			set { name = value; }
		...
		/// <summary>
        /// Combo box for BotCredential's Name operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BotCredential's Server property
        /// </summary>
		public TextBox Server {
			get { return server; }
			set { server = value; }
		}
		
		/// <summary>
        /// Combo box for BotCredential's Server operators
        /// </summary>
		public DropDownList OperatorsForServer {
			get { return operatorsForServer; }
			set { operatorsForServer = value; }
		}
		
		/// <summary>
        /// Search box for BotCredential's VerificationCode property
        /// </summary>
		public TextBox VerificationCode {
			get { return verificationCode; }
			set { verificationCode = value; }
		}
		
		/// <summary>
        /// Combo box for BotCredential's VerificationCode operators
        /// </summary>
		public DropDownList OperatorsForVerificationCode {
			get { return operatorsForVerificationCode; }
			set { operatorsForVerificationCode = value; }
		}
		
		/// <summary>
        /// Search box for BotCredential's BotId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BotCredential's BotId operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BotCredential's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BotCredential's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BotCredential's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BotCredential's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for BotCredential's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for BotCredential's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty( Server.Text ) ) {
					writer.Write( "{2} e.Server {0} '{1}' ",
							operatorsForServer.SelectedValue, 
							Server.Text, first ? "" : ","
						);
					first = false;
				}
				if( !string.IsNullOrEmpty( VerificationCode.Text ) ) {
					writer.Write( "{2} e.VerificationCode {0} '{1}' ",
							operatorsForVerificationCode.SelectedValue, 
							VerificationCode.Text, first ? "" : ","
						);
					first = false;
				}
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<BotCredential>.GetWhereKey("BotCredential")] = writer.ToString();
				}
			}
		}
		...
		protected override void CreateChildControls()
        {
			...
			Controls.Add( Name );
			Controls.Add( new LiteralControl("</td><tr>") );
			Server.ID = "searchServer";
			Controls.Add( new LiteralControl("<tr>") );
			Controls.Add( new LiteralControl("<td><b>Server</b></td><td>") );
			Controls.Add( AddOperators( OperatorsForServer ) );
			Controls.Add( new LiteralControl("</td><td>") );
			Controls.Add( Server );
			Controls.Add( new LiteralControl("</td><tr>") );
			VerificationCode.ID = "searchVerificationCode";
			Controls.Add( new LiteralControl("<tr>") );
			Controls.Add( new LiteralControl("<td><b>VerificationCode</b></td><td>") );
			Controls.Add( AddOperators( OperatorsForVerificationCode ) );
			Controls.Add( new LiteralControl("</td><td>") );
