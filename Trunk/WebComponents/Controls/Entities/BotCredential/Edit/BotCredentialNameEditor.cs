...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Name of the BotCredential entity
    /// </summary>
	public class BotCredentialNameEditor : 
		...
		public override void Update( BotCredential entity )
		{
			if( !Secret ) {
				...
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Name = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_name", ID); }
		}
