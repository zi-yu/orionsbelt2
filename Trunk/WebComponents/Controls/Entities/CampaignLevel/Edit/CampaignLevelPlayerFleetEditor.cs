...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PlayerFleet of the CampaignLevel entity
    /// </summary>
	public class CampaignLevelPlayerFleetEditor : 
					StringEditor<CampaignLevel>, INamingContainer {
		...
		protected override string GetCaption( CampaignLevel entity )
		{
			return entity.PlayerFleet;
		}
		...
		{
			if( !Secret ) {
				entity.PlayerFleet = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.PlayerFleet = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_playerFleet", ID); }
		}
