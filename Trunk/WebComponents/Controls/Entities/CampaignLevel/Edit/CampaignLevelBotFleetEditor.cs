...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the BotFleet of the CampaignLevel entity
    /// </summary>
	public class CampaignLevelBotFleetEditor : 
		...
		{
			if( !Secret ) {
				entity.BotFleet = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.BotFleet = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_botFleet", ID); }
		}
