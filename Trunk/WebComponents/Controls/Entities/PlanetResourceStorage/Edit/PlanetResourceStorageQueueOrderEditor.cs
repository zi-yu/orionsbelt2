...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the QueueOrder of the PlanetResourceStorage entity
    /// </summary>
	public class PlanetResourceStorageQueueOrderEditor : 
		...
		public override void Update( PlanetResourceStorage entity )
		{
			...
			entity.QueueOrder = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_queueOrder", ID); }
		}
