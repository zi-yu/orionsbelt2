...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlanetResourceStorage's Type
    /// </summary>
	public class PlanetResourceStorageType : BaseFieldControl<PlanetResourceStorage>, INamingContainer {
