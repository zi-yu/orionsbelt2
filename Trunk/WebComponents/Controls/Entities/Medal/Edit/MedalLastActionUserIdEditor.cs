...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastActionUserId of the Medal entity
    /// </summary>
	public class MedalLastActionUserIdEditor : 
				IntEditor<Medal>, INamingContainer {
        ...
        /// </summary>
        /// <param name="entity">The Medal</param>
        /// <returns>The value</returns>
		protected override int GetNumber( Medal entity )
		{
