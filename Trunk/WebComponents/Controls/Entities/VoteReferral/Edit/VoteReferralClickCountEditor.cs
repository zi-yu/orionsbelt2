...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ClickCount of the VoteReferral entity
    /// </summary>
	public class VoteReferralClickCountEditor : 
		...
		public override void Update( VoteReferral entity )
		{
			...
			entity.ClickCount = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_clickCount", ID); }
		}
