...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a ForumThread's ReadMarkings
    /// </summary>
	public class ForumThreadReadMarkings : BaseFieldControl<ForumThread>, INamingContainer {
		...
		{
			list.Where = "e.ThreadNHibernate.Id = " + entity.Id;
