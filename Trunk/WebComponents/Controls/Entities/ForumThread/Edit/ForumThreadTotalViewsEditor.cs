...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TotalViews of the ForumThread entity
    /// </summary>
	public class ForumThreadTotalViewsEditor : 
		...
		public override void Update( ForumThread entity )
		{
			...
			entity.TotalViews = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_totalViews", ID); }
		}
