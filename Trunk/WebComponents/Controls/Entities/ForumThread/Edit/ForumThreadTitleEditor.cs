...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Title of the ForumThread entity
    /// </summary>
	public class ForumThreadTitleEditor : 
					StringEditor<ForumThread>, INamingContainer {
		...
		protected override string GetCaption( ForumThread entity )
		{
			return entity.Title;
		}
		...
		public override void Update( ForumThread entity )
		{
			if( !Secret ) {
				...
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Title = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_title", ID); }
		}
