...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TotalReplies of the ForumThread entity
    /// </summary>
	public class ForumThreadTotalRepliesEditor : 
		...
		public override void Update( ForumThread entity )
		{
			...
			entity.TotalReplies = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_totalReplies", ID); }
		}
