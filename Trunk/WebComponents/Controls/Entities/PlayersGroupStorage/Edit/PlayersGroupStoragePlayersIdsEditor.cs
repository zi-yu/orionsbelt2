...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PlayersIds of the PlayersGroupStorage entity
    /// </summary>
	public class PlayersGroupStoragePlayersIdsEditor : 
					StringEditor<PlayersGroupStorage>, INamingContainer {
		...
		protected override string GetCaption( PlayersGroupStorage entity )
		{
			return entity.PlayersIds;
		}
		...
		{
			if( !Secret ) {
				entity.PlayersIds = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.PlayersIds = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_playersIds", ID); }
		}
