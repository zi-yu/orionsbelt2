...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlanetStorage's Resources
    /// </summary>
	public class PlanetStorageResources : BaseFieldControl<PlanetStorage>, INamingContainer {
	
		#region BaseFieldControl<PlanetStorage> Implementation
		
		private PlanetResourceStoragePagedList list = new PlanetResourceStoragePagedList ();
		...
		{
			list.Where = "e.PlanetNHibernate.Id = " + entity.Id;
