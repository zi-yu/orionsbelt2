...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a paged collection of PlanetStorage 
    /// </summary>
	public class PlanetStoragePagedList : BasePagedList<PlanetStorage> {
		
		#region BasePagedList<PlanetStorage> Implementation
		
		/// <summary>
        /// The current persistance object
        /// </summary>
		protected override IPersistance<PlanetStorage> Persistance {
			get { 
				return OrionsBelt.DataAccessLayer.Persistance.Instance.GetPlanetStoragePersistance ();
			}
		}
		...
		#endregion BasePagedList<PlanetStorage> Implementation
