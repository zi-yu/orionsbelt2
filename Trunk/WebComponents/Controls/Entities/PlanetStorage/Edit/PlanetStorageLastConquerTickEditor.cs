...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastConquerTick of the PlanetStorage entity
    /// </summary>
	public class PlanetStorageLastConquerTickEditor : 
		...
		public override void Update( PlanetStorage entity )
		{
			...
			entity.LastConquerTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_lastConquerTick", ID); }
		}
