...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the FacilityLevel of the PlanetStorage entity
    /// </summary>
	public class PlanetStorageFacilityLevelEditor : 
		...
		public override void Update( PlanetStorage entity )
		{
			...
			entity.FacilityLevel = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_facilityLevel", ID); }
		}
