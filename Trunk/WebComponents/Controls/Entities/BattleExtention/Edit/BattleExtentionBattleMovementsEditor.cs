...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the BattleMovements of the BattleExtention entity
    /// </summary>
	public class BattleExtentionBattleMovementsEditor : 
		...
		{
			if( !Secret ) {
				entity.BattleMovements = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.BattleMovements = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_battleMovements", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,64000}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 64000);
		}
