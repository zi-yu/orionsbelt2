...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Id of the BattleExtention entity
    /// </summary>
	public class BattleExtentionIdEditor : 
				IntEditor<BattleExtention>, INamingContainer {
        ...
        /// </summary>
        /// <param name="entity">The BattleExtention</param>
        /// <returns>The value</returns>
		protected override int GetNumber( BattleExtention entity )
		{
			return entity.Id;
		}

		/// <summary>
        /// Renders an BattleExtention
        /// </summary>
