...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the BattleFinalStates of the BattleExtention entity
    /// </summary>
	public class BattleExtentionBattleFinalStatesEditor : 
					StringEditor<BattleExtention>, INamingContainer {
		...
		protected override string GetCaption( BattleExtention entity )
		{
			return entity.BattleFinalStates;
		}
		...
		{
			if( !Secret ) {
				entity.BattleFinalStates = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.BattleFinalStates = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_battleFinalStates", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,6000}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 6000);
		}
