...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a collection of Tournament 
    /// </summary>
	public class TournamentList : BaseList<Tournament> {
	
		#region Abstract Members
		
		/// <summary>
        /// Gets the Tournament collection
        /// </summary>
        /// <returns>The collection</returns>
		protected override IList<Tournament> GetCollection()
		{
		...
		#region BaseList<Tournament> Implementation
		...
		#endregion BaseList<Tournament> Implementation
