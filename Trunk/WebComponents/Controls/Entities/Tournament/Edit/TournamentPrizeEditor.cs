...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Prize of the Tournament entity
    /// </summary>
	public class TournamentPrizeEditor : 
		...
		{
			if( !Secret ) {
				entity.Prize = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Prize = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_prize", ID); }
		}
