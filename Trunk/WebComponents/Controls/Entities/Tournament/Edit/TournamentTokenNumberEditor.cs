...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TokenNumber of the Tournament entity
    /// </summary>
	public class TournamentTokenNumberEditor : 
		...
		public override void Update( Tournament entity )
		{
			...
			entity.TokenNumber = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_tokenNumber", ID); }
		}
