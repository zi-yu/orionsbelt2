...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TurnTime of the Tournament entity
    /// </summary>
	public class TournamentTurnTimeEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_turnTime", ID); }
		}
