...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the NPlayersToPlayoff of the Tournament entity
    /// </summary>
	public class TournamentNPlayersToPlayoffEditor : 
		...
		{
			return entity.NPlayersToPlayoff;
		}
		...
		public override void Update( Tournament entity )
		{
			...
			entity.NPlayersToPlayoff = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_nPlayersToPlayoff", ID); }
		}
