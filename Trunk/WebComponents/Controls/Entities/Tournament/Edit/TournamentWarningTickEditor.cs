...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the WarningTick of the Tournament entity
    /// </summary>
	public class TournamentWarningTickEditor : 
		...
		public override void Update( Tournament entity )
		{
			...
			entity.WarningTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_warningTick", ID); }
		}
