...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TournamentType of the Tournament entity
    /// </summary>
	public class TournamentTournamentTypeEditor : 
		...
		{
			if( !Secret ) {
				entity.TournamentType = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.TournamentType = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_tournamentType", ID); }
		}
