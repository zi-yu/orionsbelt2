...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the SubscriptionTime of the Tournament entity
    /// </summary>
	public class TournamentSubscriptionTimeEditor : 
		...
		{
			return entity.SubscriptionTime;
		}
		...
		public override void Update( Tournament entity )
		{
			...
			entity.SubscriptionTime = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_subscriptionTime", ID); }
		}
