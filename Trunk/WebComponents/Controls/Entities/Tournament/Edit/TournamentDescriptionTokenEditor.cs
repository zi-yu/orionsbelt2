...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the DescriptionToken of the Tournament entity
    /// </summary>
	public class TournamentDescriptionTokenEditor : 
					StringEditor<Tournament>, INamingContainer {
		...
		protected override string GetCaption( Tournament entity )
		{
			return entity.DescriptionToken;
		}
		...
		{
			if( !Secret ) {
				entity.DescriptionToken = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.DescriptionToken = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_descriptionToken", ID); }
		}
