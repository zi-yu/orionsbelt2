...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the MinPlayers of the Tournament entity
    /// </summary>
	public class TournamentMinPlayersEditor : 
		...
		public override void Update( Tournament entity )
		{
			...
			entity.MinPlayers = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_minPlayers", ID); }
		}
