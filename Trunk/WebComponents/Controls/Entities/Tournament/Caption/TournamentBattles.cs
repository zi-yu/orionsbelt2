...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Tournament's Battles
    /// </summary>
	public class TournamentBattles : BaseFieldControl<Tournament>, INamingContainer {
	
		#region BaseFieldControl<Tournament> Implementation
		
		private BattlePagedList list = new BattlePagedList ();
		...
		{
			list.Where = "e.TournamentNHibernate.Id = " + entity.Id;
