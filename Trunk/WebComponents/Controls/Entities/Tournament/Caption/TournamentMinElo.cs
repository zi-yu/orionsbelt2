...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Tournament's MinElo
    /// </summary>
	public class TournamentMinElo : BaseFieldControl<Tournament>, INamingContainer {
