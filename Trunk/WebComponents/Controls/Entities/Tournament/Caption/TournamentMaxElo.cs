...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Tournament's MaxElo
    /// </summary>
	public class TournamentMaxElo : BaseFieldControl<Tournament>, INamingContainer {
