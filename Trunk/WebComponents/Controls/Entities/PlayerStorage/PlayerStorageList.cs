...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a collection of PlayerStorage 
    /// </summary>
	public class PlayerStorageList : BaseList<PlayerStorage> {
	
		#region Abstract Members
		
		/// <summary>
        /// Gets the PlayerStorage collection
        /// </summary>
        /// <returns>The collection</returns>
		protected override IList<PlayerStorage> GetCollection()
		{
		...
		#region BaseList<PlayerStorage> Implementation
		...
		#endregion BaseList<PlayerStorage> Implementation
