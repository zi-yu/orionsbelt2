...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class PlayerStorageDiscoveredUniverse : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private FogOfWarStoragePagedList list = new FogOfWarStoragePagedList ();
