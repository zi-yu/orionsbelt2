...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's SpecialSectores
    /// </summary>
	public class PlayerStorageSpecialSectores : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private UniverseSpecialSectorPagedList list = new UniverseSpecialSectorPagedList ();
		...
		{
			list.Where = "e.OwnerNHibernate.Id = " + entity.Id;
