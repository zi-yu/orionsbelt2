...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's ReadMarkings
    /// </summary>
	public class PlayerStorageReadMarkings : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private ForumReadMarkingPagedList list = new ForumReadMarkingPagedList ();
