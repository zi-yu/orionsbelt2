...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's Arena
    /// </summary>
	public class PlayerStorageArena : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private ArenaStoragePagedList list = new ArenaStoragePagedList ();
