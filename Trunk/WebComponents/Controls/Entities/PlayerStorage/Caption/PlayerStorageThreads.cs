...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's Threads
    /// </summary>
	public class PlayerStorageThreads : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private ForumThreadPagedList list = new ForumThreadPagedList ();
