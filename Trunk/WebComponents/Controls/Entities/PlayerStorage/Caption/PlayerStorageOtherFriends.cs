...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's OtherFriends
    /// </summary>
	public class PlayerStorageOtherFriends : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private FriendOrFoePagedList list = new FriendOrFoePagedList ();
		...
		{
			list.Where = "e.TargetNHibernate.Id = " + entity.Id;
