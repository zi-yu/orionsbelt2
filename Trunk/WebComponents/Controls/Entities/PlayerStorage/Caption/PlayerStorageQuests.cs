...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's Quests
    /// </summary>
	public class PlayerStorageQuests : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private QuestStoragePagedList list = new QuestStoragePagedList ();
