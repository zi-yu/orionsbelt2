...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's Planets
    /// </summary>
	public class PlayerStoragePlanets : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private PlanetStoragePagedList list = new PlanetStoragePagedList ();
