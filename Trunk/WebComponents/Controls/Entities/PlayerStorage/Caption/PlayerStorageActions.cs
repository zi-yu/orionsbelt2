...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class PlayerStorageActions : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private TimedActionStoragePagedList list = new TimedActionStoragePagedList ();
