...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's Resources
    /// </summary>
	public class PlayerStorageResources : BaseFieldControl<PlayerStorage>, INamingContainer {
		...
		{
			list.Where = "e.PlayerNHibernate.Id = " + entity.Id;
