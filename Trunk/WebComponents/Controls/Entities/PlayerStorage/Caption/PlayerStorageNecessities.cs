...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's Necessities
    /// </summary>
	public class PlayerStorageNecessities : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private NecessityPagedList list = new NecessityPagedList ();
		...
		{
			list.Where = "e.CreatorNHibernate.Id = " + entity.Id;
