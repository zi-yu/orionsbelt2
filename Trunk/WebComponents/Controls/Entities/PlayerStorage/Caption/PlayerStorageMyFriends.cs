...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStorage's MyFriends
    /// </summary>
	public class PlayerStorageMyFriends : BaseFieldControl<PlayerStorage>, INamingContainer {
		...
		{
			list.Where = "e.SourceNHibernate.Id = " + entity.Id;
