...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class PlayerStorageMessages : BaseFieldControl<PlayerStorage>, INamingContainer {
	
		#region BaseFieldControl<PlayerStorage> Implementation
		
		private PrivateBoardPagedList list = new PrivateBoardPagedList ();
		...
		{
			list.Where = "e.SenderNHibernate.Id = " + entity.Id;
