...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the GeneralId of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageGeneralIdEditor : 
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.GeneralId = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_generalId", ID); }
		}
