...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the OtherFriends of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageOtherFriendsEditor : 
		...
		{
			// OneToMany
			System.Collections.Generic.IList<FriendOrFoe> list = entity.OtherFriends;
			list.Add(Current);
		}
