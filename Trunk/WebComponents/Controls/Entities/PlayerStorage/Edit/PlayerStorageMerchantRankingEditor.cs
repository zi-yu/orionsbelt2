...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the MerchantRanking of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageMerchantRankingEditor : 
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.MerchantRanking = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_merchantRanking", ID); }
		}
