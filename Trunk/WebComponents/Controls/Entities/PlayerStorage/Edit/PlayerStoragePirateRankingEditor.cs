...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PirateRanking of the PlayerStorage entity
    /// </summary>
	public class PlayerStoragePirateRankingEditor : 
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.PirateRanking = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_pirateRanking", ID); }
		}
