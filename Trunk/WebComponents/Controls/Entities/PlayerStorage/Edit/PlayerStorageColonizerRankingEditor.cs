...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ColonizerRanking of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageColonizerRankingEditor : 
		...
		{
			return entity.ColonizerRanking;
		}
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.ColonizerRanking = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_colonizerRanking", ID); }
		}
