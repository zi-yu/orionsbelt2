...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the HomePlanetId of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageHomePlanetIdEditor : 
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.HomePlanetId = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_homePlanetId", ID); }
		}
