...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the GladiatorRanking of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageGladiatorRankingEditor : 
		...
		{
			return entity.GladiatorRanking;
		}
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.GladiatorRanking = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_gladiatorRanking", ID); }
		}
