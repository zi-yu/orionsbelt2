...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the UltimateWeaponLevel of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageUltimateWeaponLevelEditor : 
		...
		{
			return entity.UltimateWeaponLevel;
		}
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.UltimateWeaponLevel = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_ultimateWeaponLevel", ID); }
		}
