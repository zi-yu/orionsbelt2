...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the PlanetLevel of the PlayerStorage entity
    /// </summary>
	public class PlayerStoragePlanetLevelEditor : 
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.PlanetLevel = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_planetLevel", ID); }
		}
