...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ActivatedInTick of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageActivatedInTickEditor : 
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.ActivatedInTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_activatedInTick", ID); }
		}
