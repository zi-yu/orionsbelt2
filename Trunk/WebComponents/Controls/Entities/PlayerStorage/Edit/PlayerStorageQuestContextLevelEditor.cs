...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the QuestContextLevel of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageQuestContextLevelEditor : 
		...
		{
			return entity.QuestContextLevel;
		}
		...
		{
			if( !Secret ) {
				entity.QuestContextLevel = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.QuestContextLevel = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_questContextLevel", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,2000}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 2000);
		}
