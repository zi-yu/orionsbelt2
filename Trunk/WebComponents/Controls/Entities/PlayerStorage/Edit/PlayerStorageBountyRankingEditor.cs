...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the BountyRanking of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageBountyRankingEditor : 
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.BountyRanking = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_bountyRanking", ID); }
		}
