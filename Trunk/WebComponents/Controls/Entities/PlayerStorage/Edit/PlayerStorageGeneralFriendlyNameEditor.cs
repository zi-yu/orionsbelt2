...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the GeneralFriendlyName of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageGeneralFriendlyNameEditor : 
		...
		{
			return entity.GeneralFriendlyName;
		}
		...
		{
			if( !Secret ) {
				entity.GeneralFriendlyName = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.GeneralFriendlyName = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_generalFriendlyName", ID); }
		}
