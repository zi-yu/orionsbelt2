...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the IntrinsicLimits of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageIntrinsicLimitsEditor : 
		...
		{
			if( !Secret ) {
				entity.IntrinsicLimits = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.IntrinsicLimits = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_intrinsicLimits", ID); }
		}
