...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the IntrinsicQuantities of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageIntrinsicQuantitiesEditor : 
					StringEditor<PlayerStorage>, INamingContainer {
		...
		protected override string GetCaption( PlayerStorage entity )
		{
			return entity.IntrinsicQuantities;
		}
		...
		{
			if( !Secret ) {
				entity.IntrinsicQuantities = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.IntrinsicQuantities = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_intrinsicQuantities", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,2048}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 2048);
		}
