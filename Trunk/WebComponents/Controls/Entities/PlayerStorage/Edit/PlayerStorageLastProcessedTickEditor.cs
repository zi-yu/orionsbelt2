...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the LastProcessedTick of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageLastProcessedTickEditor : 
		...
		{
			return entity.LastProcessedTick;
		}
		...
		public override void Update( PlayerStorage entity )
		{
			...
			entity.LastProcessedTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_lastProcessedTick", ID); }
		}
