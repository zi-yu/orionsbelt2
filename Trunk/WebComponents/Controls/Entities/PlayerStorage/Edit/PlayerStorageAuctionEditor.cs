...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Auction of the PlayerStorage entity
    /// </summary>
	public class PlayerStorageAuctionEditor : 
			AuctionHouseItem, IEntityFieldEditor<PlayerStorage>, INamingContainer {
		...
		{
			// OneToMany
			System.Collections.Generic.IList<AuctionHouse> list = entity.Auction;
			list.Add(Current);
		}
