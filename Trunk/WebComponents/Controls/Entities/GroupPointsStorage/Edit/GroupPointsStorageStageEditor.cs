...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Stage of the GroupPointsStorage entity
    /// </summary>
	public class GroupPointsStorageStageEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_stage", ID); }
		}
