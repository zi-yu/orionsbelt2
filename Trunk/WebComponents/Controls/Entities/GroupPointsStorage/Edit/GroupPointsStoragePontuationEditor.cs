...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Pontuation of the GroupPointsStorage entity
    /// </summary>
	public class GroupPointsStoragePontuationEditor : 
		...
		public override void Update( GroupPointsStorage entity )
		{
			...
			entity.Pontuation = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_pontuation", ID); }
		}
