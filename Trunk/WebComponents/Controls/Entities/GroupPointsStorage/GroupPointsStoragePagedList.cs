...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Control that can render a paged collection of GroupPointsStorage 
    /// </summary>
	public class GroupPointsStoragePagedList : BasePagedList<GroupPointsStorage> {
		
		#region BasePagedList<GroupPointsStorage> Implementation
		
		/// <summary>
        /// The current persistance object
        /// </summary>
		protected override IPersistance<GroupPointsStorage> Persistance {
			get { 
				return OrionsBelt.DataAccessLayer.Persistance.Instance.GetGroupPointsStoragePersistance ();
			}
		}
		...
		#endregion BasePagedList<GroupPointsStorage> Implementation
