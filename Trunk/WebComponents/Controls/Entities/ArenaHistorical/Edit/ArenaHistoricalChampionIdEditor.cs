...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ChampionId of the ArenaHistorical entity
    /// </summary>
	public class ArenaHistoricalChampionIdEditor : 
		...
		public override void Update( ArenaHistorical entity )
		{
			...
			entity.ChampionId = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_championId", ID); }
		}
