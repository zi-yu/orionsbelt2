...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ChallengerId of the ArenaHistorical entity
    /// </summary>
	public class ArenaHistoricalChallengerIdEditor : 
		...
		public override void Update( ArenaHistorical entity )
		{
			...
			entity.ChallengerId = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_challengerId", ID); }
		}
