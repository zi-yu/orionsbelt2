...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the NumberPirateQuest of the PlayerStats entity
    /// </summary>
	public class PlayerStatsNumberPirateQuestEditor : 
		...
		{
			return entity.NumberPirateQuest;
		}
		...
		public override void Update( PlayerStats entity )
		{
			...
			entity.NumberPirateQuest = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_numberPirateQuest", ID); }
		}
