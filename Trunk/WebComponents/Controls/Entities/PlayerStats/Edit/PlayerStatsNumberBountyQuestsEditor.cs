...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the NumberBountyQuests of the PlayerStats entity
    /// </summary>
	public class PlayerStatsNumberBountyQuestsEditor : 
		...
		{
			return entity.NumberBountyQuests;
		}
		...
		public override void Update( PlayerStats entity )
		{
			...
			entity.NumberBountyQuests = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_numberBountyQuests", ID); }
		}
