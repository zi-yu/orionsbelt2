...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a PlayerStats's BattleStats
    /// </summary>
	public class PlayerStatsBattleStats : BaseFieldControl<PlayerStats>, INamingContainer {
		...
		{
			list.Where = "e.PlayerStatsNHibernate.Id = " + entity.Id;
