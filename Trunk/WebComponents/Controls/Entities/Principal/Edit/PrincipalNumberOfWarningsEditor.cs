...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the NumberOfWarnings of the Principal entity
    /// </summary>
	public class PrincipalNumberOfWarningsEditor : 
		...
		{
			return entity.NumberOfWarnings;
		}
		...
		public override void Update( Principal entity )
		{
			...
			entity.NumberOfWarnings = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_numberOfWarnings", ID); }
		}
