...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Ip of the Principal entity
    /// </summary>
	public class PrincipalIpEditor : 
		...
		public override void Update( Principal entity )
		{
			if( !Secret ) {
				...
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Ip = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_ip", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,15}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 15);
		}
