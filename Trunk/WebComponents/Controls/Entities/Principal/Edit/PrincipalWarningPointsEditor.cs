...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the WarningPoints of the Principal entity
    /// </summary>
	public class PrincipalWarningPointsEditor : 
		...
		public override void Update( Principal entity )
		{
			...
			entity.WarningPoints = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_warningPoints", ID); }
		}
