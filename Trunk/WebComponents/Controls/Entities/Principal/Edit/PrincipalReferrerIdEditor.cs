...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ReferrerId of the Principal entity
    /// </summary>
	public class PrincipalReferrerIdEditor : 
		...
		public override void Update( Principal entity )
		{
			...
			entity.ReferrerId = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_referrerId", ID); }
		}
