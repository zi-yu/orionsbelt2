...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the TutorialState of the Principal entity
    /// </summary>
	public class PrincipalTutorialStateEditor : 
		...
		public override void Update( Principal entity )
		{
			...
			entity.TutorialState = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_tutorialState", ID); }
		}
