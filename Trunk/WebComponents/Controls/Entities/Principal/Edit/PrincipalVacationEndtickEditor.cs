...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the VacationEndtick of the Principal entity
    /// </summary>
	public class PrincipalVacationEndtickEditor : 
		...
		public override void Update( Principal entity )
		{
			...
			entity.VacationEndtick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_vacationEndtick", ID); }
		}
