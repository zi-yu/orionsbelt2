...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the RawRoles of the Principal entity
    /// </summary>
	public class PrincipalRawRolesEditor : 
		...
		{
			if( !Secret ) {
				entity.RawRoles = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.RawRoles = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_rawRoles", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,250}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 250);
		}
