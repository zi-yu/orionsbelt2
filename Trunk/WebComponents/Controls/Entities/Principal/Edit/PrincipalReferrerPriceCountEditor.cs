...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the ReferrerPriceCount of the Principal entity
    /// </summary>
	public class PrincipalReferrerPriceCountEditor : 
		...
		{
			return entity.ReferrerPriceCount;
		}
		...
		public override void Update( Principal entity )
		{
			...
			entity.ReferrerPriceCount = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_referrerPriceCount", ID); }
		}
