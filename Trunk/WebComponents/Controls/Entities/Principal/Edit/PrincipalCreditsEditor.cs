...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Credits of the Principal entity
    /// </summary>
	public class PrincipalCreditsEditor : 
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_credits", ID); }
		}
