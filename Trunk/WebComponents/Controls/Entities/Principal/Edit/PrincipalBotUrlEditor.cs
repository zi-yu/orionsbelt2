...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the BotUrl of the Principal entity
    /// </summary>
	public class PrincipalBotUrlEditor : 
		...
		{
			if( !Secret ) {
				entity.BotUrl = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.BotUrl = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_botUrl", ID); }
		}
		...
		protected virtual void AddValidators()
		{
            ...
            maxSize.ValidationExpression = "(.|\\s){1,5000}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 5000);
		}
