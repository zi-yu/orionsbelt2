...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Promotions of the Principal entity
    /// </summary>
	public class PrincipalPromotionsEditor : 
			PromotionItem, IEntityFieldEditor<Principal>, INamingContainer {
		...
		{
			// OneToMany
			System.Collections.Generic.IList<Promotion> list = entity.Promotions;
			list.Add(Current);
		}
