...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the VacationStartTick of the Principal entity
    /// </summary>
	public class PrincipalVacationStartTickEditor : 
		...
		{
			return entity.VacationStartTick;
		}
		...
		public override void Update( Principal entity )
		{
			...
			entity.VacationStartTick = int.Parse(val);
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_IntEditor_{0}_vacationStartTick", ID); }
		}
