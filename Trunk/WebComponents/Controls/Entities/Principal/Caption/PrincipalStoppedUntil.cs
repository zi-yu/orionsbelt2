...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Principal's StoppedUntil
    /// </summary>
	public class PrincipalStoppedUntil : BaseFieldControl<Principal>, INamingContainer {
		...
		{
			writer.Write( entity.StoppedUntil );
		}
