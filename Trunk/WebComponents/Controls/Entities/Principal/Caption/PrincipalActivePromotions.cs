...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class PrincipalActivePromotions : BaseFieldControl<Principal>, INamingContainer {
	
		#region BaseFieldControl<Principal> Implementation
		
		private ActivatedPromotionPagedList list = new ActivatedPromotionPagedList ();
