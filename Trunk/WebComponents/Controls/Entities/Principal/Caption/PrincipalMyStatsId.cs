...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Principal's MyStatsId
    /// </summary>
	public class PrincipalMyStatsId : BaseFieldControl<Principal>, INamingContainer {
