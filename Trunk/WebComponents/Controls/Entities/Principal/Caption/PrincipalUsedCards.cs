...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// </summary>
	public class PrincipalUsedCards : BaseFieldControl<Principal>, INamingContainer {
	
		#region BaseFieldControl<Principal> Implementation
		
		private BonusCardPagedList list = new BonusCardPagedList ();
		...
		{
			list.Where = "e.UsedByNHibernate.Id = " + entity.Id;
