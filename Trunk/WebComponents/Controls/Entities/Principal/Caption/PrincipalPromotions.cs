...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Principal's Promotions
    /// </summary>
	public class PrincipalPromotions : BaseFieldControl<Principal>, INamingContainer {
	
		#region BaseFieldControl<Principal> Implementation
		
		private PromotionPagedList list = new PromotionPagedList ();
