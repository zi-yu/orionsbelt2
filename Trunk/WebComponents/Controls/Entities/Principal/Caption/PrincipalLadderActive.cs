...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Principal's LadderActive
    /// </summary>
	public class PrincipalLadderActive : BaseFieldControl<Principal>, INamingContainer {
		...
		{
			writer.Write( entity.LadderActive );
		}
