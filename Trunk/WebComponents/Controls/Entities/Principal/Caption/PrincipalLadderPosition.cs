...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Principal's LadderPosition
    /// </summary>
	public class PrincipalLadderPosition : BaseFieldControl<Principal>, INamingContainer {
		...
		{
			writer.Write( entity.LadderPosition );
		}
