...
namespace OrionsBelt.WebComponents.Controls {
    ...
    /// <summary>
    /// Renders in XHTML the content of a Principal's Tournaments
    /// </summary>
	public class PrincipalTournaments : BaseFieldControl<Principal>, INamingContainer {
	
		#region BaseFieldControl<Principal> Implementation
		
		private PrincipalTournamentPagedList list = new PrincipalTournamentPagedList ();
		...
		{
			list.Where = "e.PrincipalNHibernate.Id = " + entity.Id;
