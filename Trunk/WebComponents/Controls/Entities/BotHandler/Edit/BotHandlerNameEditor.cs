...
namespace OrionsBelt.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Name of the BotHandler entity
    /// </summary>
	public class BotHandlerNameEditor : 
					StringEditor<BotHandler>, INamingContainer {
		...
		protected override string GetCaption( BotHandler entity )
		{
			return entity.Name;
		}
