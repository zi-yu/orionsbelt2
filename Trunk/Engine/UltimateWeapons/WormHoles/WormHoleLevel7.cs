...
namespace OrionsBelt.Engine {
	...
	[FactoryKey("WormHoleLevel7")]
	public class WormHoleLevel7 : WormHoleCreatorBase {

		#region Fields

		private static readonly WormHoleLevel7 instance = new WormHoleLevel7();
        ...
        public WormHoleLevel7() {
            intrinsicResources = 1400;
            rareResources = 350;
        }
