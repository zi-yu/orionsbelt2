...
namespace OrionsBelt.Engine.Actions {
    ...
    /// </summary>
    public class PeriodicIncome : AutoRepeteAction  {

        #region Ctor

        public PeriodicIncome()
        {
            Interval = 1;
        }
        ...
        {
            ResourceUtils.ProcessModifiers(PlayerUtils.Current);
        }
        ...
        private static ITimedAction instance = new PeriodicIncome();
