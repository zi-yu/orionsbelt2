...
namespace OrionsBelt.Engine.Quests {
    ...
    /// </summary>
    public class Colonize5HotLevel10Quest : HotPlanetsQuest {
        ...
        public override Dictionary<IResourceInfo, int> IntrinsicRewards {
            get {
                ...
                dic.Add(Astatine.Resource, 1400);
                dic.Add(Radon.Resource, 2000);
                dic.Add(Cryptium.Resource, 1800);
                dic.Add(Prismal.Resource, 1600);
                dic.Add(Argon.Resource, 1200);
                return dic;
            }
        }
