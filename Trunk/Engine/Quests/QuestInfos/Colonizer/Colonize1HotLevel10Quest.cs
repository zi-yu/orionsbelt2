...
namespace OrionsBelt.Engine.Quests {
    ...
    /// </summary>
    public class Colonize1HotLevel10Quest : HotPlanetsQuest {
        ...
        public override Dictionary<IResourceInfo, int> IntrinsicRewards {
            get {
                ...
                dic.Add(Astatine.Resource, 2200);
                dic.Add(Radon.Resource, 1600);
                dic.Add(Cryptium.Resource, 1400);
                dic.Add(Prismal.Resource, 1900);
