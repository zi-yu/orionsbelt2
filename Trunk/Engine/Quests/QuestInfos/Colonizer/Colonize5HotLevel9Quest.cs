...
namespace OrionsBelt.Engine.Quests {
    ...
    /// </summary>
    public class Colonize5HotLevel9Quest : HotPlanetsQuest {
        ...
        public override Dictionary<IResourceInfo, int> IntrinsicRewards {
            get {
                ...
                dic.Add(Astatine.Resource, 1200);
                dic.Add(Radon.Resource, 800);
                dic.Add(Cryptium.Resource, 900);
                dic.Add(Prismal.Resource, 1500);
                dic.Add(Argon.Resource, 900);
                return dic;
            }
        }
