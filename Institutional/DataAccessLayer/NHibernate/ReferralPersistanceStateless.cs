...
namespace Institutional.DataAccessLayer {
	...
	internal class ReferralPersistanceStateless : 
			NHibernatePersistanceStateless<Referral>, IReferralPersistance {
	
		#region Static Access
		
		internal static ReferralPersistanceStateless CreateSession()
		{
			return new ReferralPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedReferral) );
		}
				
		internal static ReferralPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			ReferralPersistanceStateless persistance = new ReferralPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedReferral) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static ReferralPersistanceStateless globalSession = null;
        internal static ReferralPersistanceStateless GlobalSession {
            get {
		...
		internal static ReferralPersistanceStateless GetSession()
		{
		...
		internal static ReferralPersistanceStateless GetValidatedSession()
        {
            ReferralPersistanceStateless persistance = GetSession();
		...
		private ReferralPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Referral
        {
