...
namespace Institutional.DataAccessLayer {
	...
	internal class MediaArticlePersistanceStateless : 
			NHibernatePersistanceStateless<MediaArticle>, IMediaArticlePersistance {
	
		#region Static Access
		
		internal static MediaArticlePersistanceStateless CreateSession()
		{
			return new MediaArticlePersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedMediaArticle) );
		}
				
		internal static MediaArticlePersistanceStateless AttachSession( IPersistanceSession owner )
		{
			MediaArticlePersistanceStateless persistance = new MediaArticlePersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedMediaArticle) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static MediaArticlePersistanceStateless globalSession = null;
        internal static MediaArticlePersistanceStateless GlobalSession {
            get {
		...
		internal static MediaArticlePersistanceStateless GetSession()
		{
		...
		internal static MediaArticlePersistanceStateless GetValidatedSession()
        {
            MediaArticlePersistanceStateless persistance = GetSession();
		...
		private MediaArticlePersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : MediaArticle
        {
