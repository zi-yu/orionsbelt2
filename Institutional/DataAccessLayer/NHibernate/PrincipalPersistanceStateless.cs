...
namespace Institutional.DataAccessLayer {
	...
	internal class PrincipalPersistanceStateless : 
			NHibernatePersistanceStateless<Principal>, IPrincipalPersistance {
	
		#region Static Access
		
		internal static PrincipalPersistanceStateless CreateSession()
		{
			return new PrincipalPersistanceStateless ( NHibernateUtilities.OpenStatelessSession, typeof(SpecializedPrincipal) );
		}
				
		internal static PrincipalPersistanceStateless AttachSession( IPersistanceSession owner )
		{
			PrincipalPersistanceStateless persistance = new PrincipalPersistanceStateless ( owner.Session as IStatelessSession, typeof(SpecializedPrincipal) );
			persistance.Attached = owner;
			return persistance;
		}
		
		private static PrincipalPersistanceStateless globalSession = null;
        internal static PrincipalPersistanceStateless GlobalSession {
            get {
		...
		internal static PrincipalPersistanceStateless GetSession()
		{
		...
		internal static PrincipalPersistanceStateless GetValidatedSession()
        {
            PrincipalPersistanceStateless persistance = GetSession();
		...
		private PrincipalPersistanceStateless ( IStatelessSession currSession, Type type ) 
        ...
        public static void AddValidation<T>( NHibernatePersistanceStateless<T> owner ) where T : Principal
        {
