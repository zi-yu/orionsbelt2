...
namespace Institutional.DataAccessLayer {
	...
	/// <summary>
    /// Specialized NHibernate class for MediaArticle
    /// </summary>
	public class SpecializedMediaArticle : MediaArticle {
		...
		#region MediaArticle Implementation
	
		#endregion MediaArticle Implementation
