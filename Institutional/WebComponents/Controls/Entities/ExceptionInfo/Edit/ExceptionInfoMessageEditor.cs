...
namespace Institutional.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Message of the ExceptionInfo entity
    /// </summary>
	public class ExceptionInfoMessageEditor : 
		...
		public override void Update( ExceptionInfo entity )
		{
			if( !Secret ) {
				...
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Message = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_message", ID); }
		}
		...
		protected virtual void AddValidators()
		{
			...
			//req.ErrorMessage = string.Format(Resources.RequiredFieldValidatorToken, Resources.ExceptionInfoMessageToken);
