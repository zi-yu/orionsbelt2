...
namespace Institutional.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Locale of the Principal entity
    /// </summary>
	public class PrincipalLocaleEditor : 
		...
		{
			if( !Secret ) {
				entity.Locale = text.Text;
			}else{
				if( !string.IsNullOrEmpty(text.Text) ) {
					entity.Locale = FormsAuthentication.HashPasswordForStoringInConfigFile( text.Text, "sha1" );
				}
			}
		}
		...
		protected override string TargetName { 
			get { return string.Format("Mid_StringEditor_{0}_locale", ID); }
		}
		...
		protected virtual void AddValidators()
		{
			...
			//req.ErrorMessage = string.Format(Resources.RequiredFieldValidatorToken, Resources.PrincipalLocaleToken);
            ...
            maxSize.ValidationExpression = "(.|\\s){1,6}";
            //maxSize.ErrorMessage = string.Format(Resources.LengthValidatorToken, 6);
		}
