...
namespace Institutional.WebComponents.Controls {
	...
	/// <summary>
    /// Edits the Name of the Principal entity
    /// </summary>
	public class PrincipalNameEditor : 
		...
		protected virtual void AddValidators()
		{
			...
			//req.ErrorMessage = string.Format(Resources.RequiredFieldValidatorToken, Resources.PrincipalNameToken);
			...
			if (GetParent().Source == SourceType.New) {
				...
				Controls.Add(unique);
				//unique.ErrorMessage = string.Format(Resources.UniquenessValidatorToken, Resources.PrincipalNameToken);
				...
				unique.ServerValidate += delegate(object source, ServerValidateEventArgs args) {
						...
						args.IsValid = persistance.SelectByName (text.Text).Count == 0;
					};
			}
		}
