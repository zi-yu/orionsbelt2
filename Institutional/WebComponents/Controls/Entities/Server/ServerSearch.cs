...
namespace Institutional.WebComponents.Controls {
	...
	/// <summary>
    /// Control that enables Server search
    /// </summary>
	/// <remarks>
    /// This control specifies gives input to a ServerPagedList
    /// </remarks>
	public class ServerSearch : Control {
		...
		/// <summary>
        /// Search box for Server's Id property
        /// </summary>
		public TextBox Id {
			get { return id; }
			set { id = value; }
		...
		/// <summary>
        /// Combo box for Server's Id operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Server's Name property
        /// </summary>
		public TextBox Name {
			get { return name; }
			set { name = value; }
		...
		/// <summary>
        /// Combo box for Server's Name operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Server's Url property
        /// </summary>
		public TextBox Url {
			get { return url; }
			set { url = value; }
		...
		/// <summary>
        /// Combo box for Server's Url operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Server's CreatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Server's CreatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Server's UpdatedDate property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Server's UpdatedDate operators
        /// </summary>
		...
		/// <summary>
        /// Search box for Server's LastActionUserId property
        /// </summary>
		...
		/// <summary>
        /// Combo box for Server's LastActionUserId operators
        /// </summary>
		...
		protected override void OnLoad( EventArgs args )
		{
			...
			if( Page.IsPostBack ) {
				...
				if( !string.IsNullOrEmpty(search) ) {
					HttpContext.Current.Items[BasePagedList<Server>.GetWhereKey("Server")] = writer.ToString();
				}
			}
		}
