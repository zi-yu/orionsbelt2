...
[assembly: AssemblyTitle("Institutional.Config application")]
[assembly: AssemblyCopyright("(c) 2006 ZI-YU.com")]
[assembly: AssemblyDescription("Config aplication for the Institutional project")]

namespace Institutional.Config {
	
	public partial class InstitutionalConfig : Options {
        ...
        private void GeneratePreCompiledLanguage(string path, EntryList entries)
        {
            ...
            args["namespace"] = string.Format("{0}.WebUserInterface", "Institutional");
            args["webComponents"] = string.Format("{0}.WebComponents", "Institutional");;
        ...
        {
            Dictionary<string, object> args = new Dictionary<string,object>();
            args["namespace"] = string.Format( "{0}.WebComponents", "Institutional");
            args["date"] = DateTime.Now;
            args["commandLine"] = Environment.CommandLine;
            args["entries"] = entries;
		...
		public static void Main( string[] args ) {
			...
			InstitutionalConfig options = new InstitutionalConfig();
            if( args.Length == 0 ) {
